private static List<object> GetChapter9()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐμβὰς", Transliteration = "embas", Gloss = "getting into", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "getting into a boat"
                },
                new Word { Greek = "διεπέρασεν", Transliteration = "dieperasen", Gloss = "he crossed over", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "And getting into a boat he crossed over and came to his own city."
        },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "βεβλημένον", Transliteration = "beblēmenon", Gloss = "lying", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "lying on a bed"
                        }
                    },
                    Translation = "a paralytic lying on a bed"
                }
            },
            Translation = "And behold, they were bringing to him a paralytic lying on a bed."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "Jesus, seeing their faith"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "Take heart, child; your sins are forgiven."
                }
            },
            Translation = "And Jesus, seeing their faith, said to the paralytic: Take heart, child; your sins are forgiven."
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "Καὶ", Transliteration = "Kai", Gloss = "And", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἰδού", Transliteration = "idou", Gloss = "behold", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "interj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "βλασφημεῖ", Transliteration = "blasphemei", Gloss = "blasphemes", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "This man blasphemes."
                }
            },
            Translation = "And behold, some of the scribes said to themselves: This man blasphemes."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἰδὼν", Transliteration = "idōn", Gloss = "knowing", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                    ...
                    Translation = "Jesus, knowing their thoughts"
                },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐνθυμεῖσθε", Transliteration = "enthymeisthe", Gloss = "do you think", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "πονηρὰ", Transliteration = "ponēra", Gloss = "evil things", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "Why do you think evil in your hearts?"
                }
            },
            Translation = "And Jesus, knowing their thoughts, said: Why do you think evil in your hearts?"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "τί", Transliteration = "ti", Gloss = "which", GrammarCodes = new List<string> { "PRON", "NOM", "N", "S" }, PartOfSpeech = "interj" },
                ...
                new Phrase
                {
                    ...
                    Translation = "to say: Your sins are forgiven"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "Rise and walk"
                        }
                    },
                    Translation = "to say: Rise and walk"
                }
            },
            Translation = "For which is easier, to say: Your sins are forgiven, or to say: Rise and walk?"
        },
        ...
        new Phrase
        {
            ...
            Translation = "But so that you may know that the Son of Man has authority on earth to forgive sins—"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐγερθεὶς", Transliteration = "egertheis", Gloss = "Rise", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἆρόν", Transliteration = "aron", Gloss = "take up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "σου", Transliteration = "sou", Gloss = "your", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    ...
                    Translation = "Rise, take up your bed and go to your house."
                }
            },
            Translation = "—then he said to the paralytic: Rise, take up your bed and go to your house."
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "And", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐγερθεὶς", Transliteration = "egertheis", Gloss = "rising", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "And rising, he went away to his house."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But when the crowds saw it"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὸν", Transliteration = "ton", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "δόντα", Transliteration = "donta", Gloss = "who gave", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "ἐξουσίαν", Transliteration = "exousian", Gloss = "authority", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                        new Word { Greek = "τοιαύτην", Transliteration = "toiautēn", Gloss = "such", GrammarCodes = new List<string> { "PRON", "ACC", "F", "S" }, PartOfSpeech = "adv" }
                                    },
                                    Translation = "such authority"
                                },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            ...
                            Translation = "who gave such authority to men"
                        }
                    },
                    Translation = "God, who had given such authority to men"
                }
            },
            Translation = "When the crowds saw it, they were afraid, and they glorified God, who had given such authority to men."
        }
    };
}
...
- Verse 6: PURPOSE_CLAUSE (ἵνα... εἰδῆτε)
- Verse 6: DEP_CLAUSE (ὅτι...)
- Verse 8: Attributive PTCP (τὸν δόντα...)
*/

    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "πεποιθὼς", Transliteration = "pepoithōs", Gloss = "having confidence", GrammarCodes = new List<string> { "V", "PERF", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μενῶ", Transliteration = "menō", Gloss = "I will remain", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "παραμενῶ", Transliteration = "paramenō", Gloss = "I will continue", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "προκοπὴν", Transliteration = "prokopēn", Gloss = "progress", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                    ...
                                    Translation = "your progress and joy of the faith"
                                }
                            },
                            Translation = "for your progress and joy of the faith"
                        }
                    },
                    Translation = "that I will remain and continue with you all for your progress and joy of the faith"
                }
            },
            Translation = "And being convinced of this, I know that I will remain and continue with you all for your progress and joy of the faith."
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καύχημα", Transliteration = "kauchēma", Gloss = "boasting", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "ἐμῆς", Transliteration = "emēs", Gloss = "my", GrammarCodes = new List<string> { "ADJ", "GEN", "F", "S" }, PartOfSpeech = "s" },
                                new Word { Greek = "παρουσίας", Transliteration = "parousias", Gloss = "coming", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "my coming"
                        }
                    },
                    Translation = "through my coming"
                },
            ...
            Translation = "so that your boasting may abound in Christ Jesus in me through my coming again to you."
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "of the gospel of Christ"
                },
                new Word { Greek = "πολιτεύεσθε", Transliteration = "politeuesthe", Gloss = "conduct yourselves", GrammarCodes = new List<string> { "V", "PRES", "MID", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "στήκετε", Transliteration = "stēkete", Gloss = "you are standing firm", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Phrase
                                        {
                                            ...
                                            Translation = "with one soul"
                                        },
                                        new Word { Greek = "συναθλοῦντες", Transliteration = "synathlountes", Gloss = "contending together", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                                        new Phrase
                                        {
                                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "IND_OBJ" },
                                            Content = new List<object>

        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "This is the Christ"
                }
            },
            Translation = "Others were saying, 'This is the Christ.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "Does the Christ come out of Galilee?"
                }
            },
            Translation = "But some were saying, 'For the Christ does not come out of Galilee, does he?'"
        },
        // Verse 42
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "σπέρματος", Transliteration = "spermatos", Gloss = "offspring", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" },
                            ...
                            Translation = "from the offspring of David"
                        },
                    ...
                    Translation = "that from the offspring of David and from Bethlehem, the village where David was, the Christ comes?"
                }
            },
            Translation = "Has not the Scripture said that the Christ comes from the offspring of David, and from Bethlehem, the village where David was?"
        },
        // Verse 43
        new Phrase
        {
            ...
            Translation = "So there was a division among the people because of him."
        },
        // Verse 44
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἤθελον", Transliteration = "ēthelon", Gloss = "were wanting", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "Some of them wanted to seize him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "but no one laid hands on him."
        },
        // Verse 45
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "οἱ", Transliteration = "hoi", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "P" }, PartOfSpeech = "art" },
                        new Word { Greek = "ὑπηρέται", Transliteration = "hypēretai", Gloss = "officers", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "n" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the chief priests and Pharisees"
                        }
                    },
                    Translation = "to the chief priests and Pharisees"
                }
            },
            Translation = "The officers then came to the chief priests and Pharisees,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐκεῖνοι", Transliteration = "ekeinoi", Gloss = "they", GrammarCodes = new List<string> { "PRON", "NOM", "M", "P" }, PartOfSpeech = "pronoun" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἠγάγετε", Transliteration = "ēgagete", Gloss = "did you bring", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pronoun" }
                    },
                    Translation = "Why did you not bring him?"
                }
            },
            Translation = "and they said to them, 'Why did you not bring him?'"
        },
        // Verse 46
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "Never spoke in this way a man"
                }
            },
            Translation = "The officers answered, 'No man ever spoke like this!'"
        },
        // Verse 47
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πεπλάνησθε", Transliteration = "peplanēsthe", Gloss = "have been led astray", GrammarCodes = new List<string> { "V", "PERF", "PASS", "IND", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "Have you also been led astray?"
                }
            },
            Translation = "The Pharisees answered them, 'Have you also been led astray?'"
        },
        // Verse 48
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "τις", Transliteration = "tis", Gloss = "any", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "pronoun" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "Have any of the rulers or Pharisees believed in him?"
        }
    };
}
...
- John 7:42: APPOS (τῆς κώμης as appositive to Βηθλέεμ)
- John 7:42: REL_CLAUSE (ὅπου ἦν Δαυὶδ)
- John 7:42: CAUSAL_CLAUSE (introduced by ὅτι following εἶπεν)
- John 7:48: Interrogative particle μή (expects a negative answer)
*/

            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἥκω", Transliteration = "hēkō", Gloss = "I have come", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "θέλημά", Transliteration = "thelēma", Gloss = "will", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                            ...
                            Translation = "to do your will"
                        }
                    },
                    Translation = "Behold, I have come to do your will"
                },
                new Word { Greek = "ἀναιρεῖ", Transliteration = "anairei", Gloss = "he takes away", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "στήσῃ", Transliteration = "stēsē", Gloss = "he may establish", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "that he may establish the second"
                }
            },
            Translation = "Then he said, \"Behold, I have come to do your will.\" He takes away the first in order to establish the second."
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἡγιασμένοι", Transliteration = "hēgiasmenoi", Gloss = "having been sanctified", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἐσμὲν", Transliteration = "esmen", Gloss = "we are", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "we have been sanctified"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "προσφορᾶς", Transliteration = "prosphoras", Gloss = "offering", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    ...
                                    Translation = "of the body of Jesus Christ"
                                }
                            },
                            Translation = "the offering of the body of Jesus Christ"
                        }
                    },
                    Translation = "through the offering of the body of Jesus Christ"
                },
                new Word { Greek = "ἐφάπαξ", Transliteration = "ephapax", Gloss = "once for all", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
            },
            Translation = "And by that will we have been sanctified through the offering of the body of Jesus Christ once for all."
        },
        // Verse 11
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "every priest"
                },
                new Word { Greek = "ἕστηκεν", Transliteration = "estēken", Gloss = "stands", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "λειτουργῶν", Transliteration = "leitourgōn", Gloss = "ministering", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "ministering"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "προσφέρων", Transliteration = "prospheron", Gloss = "offering", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "πολλάκις", Transliteration = "pollakis", Gloss = "repeatedly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "αὐτὰς", Transliteration = "autas", Gloss = "same", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "P" }, PartOfSpeech = "prep" },
                                new Word { Greek = "θυσίας", Transliteration = "thysias", Gloss = "sacrifices", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "the same sacrifices"
                        }
                    },
                    Translation = "offering repeatedly the same sacrifices"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "αἵτινες", Transliteration = "haitines", Gloss = "which", GrammarCodes = new List<string> { "PRON", "NOM", "F", "P" }, PartOfSpeech = "pron" },
                        new Word { Greek = "οὐδέποτε", Transliteration = "oudepote", Gloss = "never", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "δύνανται", Transliteration = "dynantai", Gloss = "are able", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "INF_PHRASE" },
                            Content = new List<object>
                            {
                                new Word { Greek = "περιελεῖν", Transliteration = "perielein", Gloss = "to take away", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                                new Word { Greek = "ἁμαρτίας", Transliteration = "hamartias", Gloss = "sins", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "to take away sins"
                        }
                    },
                    Translation = "which can never take away sins"
                }
            },
            Translation = "And every priest stands daily at his service, offering repeatedly the same sacrifices, which can never take away sins."
        },
        // Verse 12
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Translation = "one sacrifice for sins"
                        },
                        new Word { Greek = "προσενέγκας", Transliteration = "prosenengkas", Gloss = "having offered", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "having offered one sacrifice for sins"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "διηνεκὲς", Transliteration = "diēnekes", Gloss = "forever", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "forever"
                },
            ...
            Translation = "But when this priest had offered for all time a single sacrifice for sins, he sat down at the right hand of God."
        },
        // Verse 13
        new Phrase
        {
            ...
            {
                new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "S" }, PartOfSpeech = "art" },
                new Word { Greek = "λοιπὸν", Transliteration = "loipon", Gloss = "furthermore", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἐκδεχόμενος", Transliteration = "ekdechomenos", Gloss = "waiting", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τεθῶσιν", Transliteration = "tethōsin", Gloss = "should be placed", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὑποπόδιον", Transliteration = "hypopodion", Gloss = "a footstool", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                            ...
                            Translation = "a footstool for his feet"
                        }
                    },
                    Translation = "until his enemies should be made a footstool for his feet"
                }
            },
            Translation = "waiting from that time until his enemies should be made a footstool for his feet."
        },
        // Verse 14
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "μιᾷ", Transliteration = "mia", Gloss = "by one", GrammarCodes = new List<string> { "ADJ", "DAT", "F", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "προσφορᾷ", Transliteration = "prosphora", Gloss = "offering", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "for by a single offering"
                },
                new Word { Greek = "τετελείωκεν", Transliteration = "teteleiōken", Gloss = "he has perfected", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἁγιαζομένους", Transliteration = "hagiazomenous", Gloss = "being sanctified", GrammarCodes = new List<string> { "V", "PRES", "PASS", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "those who are being sanctified"
                }
            },
            Translation = "For by a single offering he has perfected for all time those who are being sanctified."
        },
        // Verse 15
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "εἰρηκέναι", Transliteration = "eirēkenai", Gloss = "having said", GrammarCodes = new List<string> { "V", "PERF", "ACT", "INF" }, PartOfSpeech = "v" }
                    },
                    Translation = "for after saying"
                }
            },
            Translation = "And the Holy Spirit also bears witness to us; for after saying,"
        },
        // Verse 16
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "This is the covenant"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "REL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "διαθήσομαι", Transliteration = "diathēsomai", Gloss = "I will make", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "αὐτοὺς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "3P", "M", "P" }, PartOfSpeech = "prep" }
                            },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἐκείνας", Transliteration = "ekeinas", Gloss = "those", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "P" }, PartOfSpeech = "adv" }
                            },
                            Translation = "after those days"
                        }
                    },
                    Translation = "that I will make with them after those days"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "διδοὺς", Transliteration = "didous", Gloss = "putting", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                new Word { Greek = "νόμους", Transliteration = "nomous", Gloss = "laws", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" },
                    ...
                    Translation = "I will put my laws on their hearts"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "their mind"
                        }
                    },
                    Translation = "and on their mind"
                },
                new Word { Greek = "ἐπιγράψω", Transliteration = "epigrapsō", Gloss = "I will write", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτούς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "3P", "M", "P" }, PartOfSpeech = "prep" }
            },
            Translation = "\"This is the covenant that I will make with them after those days, declares the Lord: I will put my laws on their hearts, and write them on their minds.\""
        }
    };
}
...
- PERIPH: Verse 10 (ἡγιασμένοι ἐσμὲν)
- GEN_OBJ: Verse 10 (προσφορᾶς τοῦ σώματος)
- DAT_INSTR: Verse 14 (μιᾷ προσφορᾷ)
- GEN_DESC: Verse 13 (ὑποπόδιον τῶν ποδῶν)
*/

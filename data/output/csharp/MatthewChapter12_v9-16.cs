private static List<object> GetChapter12()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "having departed from there"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "into their synagogue"
                }
            },
            Translation = "And departing from there, He went into their synagogue."
        },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ξηράν", Transliteration = "xēran", Gloss = "withered", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "a withered hand"
                        }
                    },
                    Translation = "having a withered hand"
                }
            },
            Translation = "And behold, there was a man having a withered hand."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "θεραπεῦσαι", Transliteration = "therapeusai", Gloss = "to heal", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" }
                                    },
                                    Translation = "to heal"
                                }
                            },
                            Translation = "Is it lawful to heal on the Sabbath?"
                        }
                    },
                    Translation = "saying, 'Is it lawful to heal on the Sabbath?'"
                },
                new Phrase
                {
                    ...
                    Translation = "so that they might accuse Him"
                }
            },
            Translation = "And they asked Him, saying, 'Is it lawful to heal on the Sabbath?' so that they might accuse Him."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἔσται", Transliteration = "will be", Gloss = "shall there be", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "Which man among you"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἕξει", Transliteration = "hexei", Gloss = "shall have", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                new Word { Greek = "πρόβατον", Transliteration = "probaton", Gloss = "sheep", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "ἓν", Transliteration = "hen", Gloss = "one", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "one sheep"
                        }
                    },
                    Translation = "who has one sheep"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐμπέσῃ", Transliteration = "empesē", Gloss = "it should fall", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "εἰς", Transliteration = "eis", Gloss = "into", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                                new Word { Greek = "βόθυνον", Transliteration = "bothynon", Gloss = "a pit", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "into a pit"
                        }
                    },
                    Translation = "and if this one falls into a pit on the Sabbath"
                },
                new Word { Greek = "οὐχὶ", Transliteration = "ouchi", Gloss = "will [he] not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "κρατήσει", Transliteration = "kratēsei", Gloss = "take hold of", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸ", Transliteration = "auto", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐγερεῖ", Transliteration = "egerei", Gloss = "lift [it] out", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "What man is there among you who has one sheep, and if it falls into a pit on the Sabbath, will he not take hold of it and lift it out?"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "πόσῳ", Transliteration = "posō", Gloss = "by how much", GrammarCodes = new List<string> { "ADJ", "DAT", "N", "S" }, PartOfSpeech = "q" },
                new Word { Greek = "οὖν", Transliteration = "oun", Gloss = "therefore", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "διαφέρει", Transliteration = "diapherei", Gloss = "is better", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "προβάτου", Transliteration = "probatou", Gloss = "than a sheep", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" }
            },
            Translation = "How much more then is a man of more value than a sheep!"
        },
        new Phrase
        {
            ...
            Translation = "So then it is lawful to do good on the Sabbath."
        },
        ...
        new Phrase
        {
            ...
            Translation = "Then He said to the man,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                // (continues verse 13)
                new Word { Greek = "ἔκτεινόν", Transliteration = "ekteinon", Gloss = "stretch out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "'Stretch out your hand.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ὑγιὴς", Transliteration = "hygiēs", Gloss = "healthy", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "S" }, PartOfSpeech = "adj" },
            ...
            Translation = "and it was restored, healthy as the other."
        },
        ...
        new Phrase
        {
            ...
            Translation = "But the Pharisees went out and took counsel against Him, how they might destroy Him."
        },
        ...
        new Phrase
        {
            ...
            Translation = "But Jesus, knowing this, withdrew from there."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "And many crowds followed Him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "and He healed them all,"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐπετίμησεν", Transliteration = "epetimēsen", Gloss = "he warned", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "and He warned them that they should not make Him known."
        }
    };
}
/*
Constructions identified:
- Idiomatic "took counsel": συμβούλιον ἔλαβον (v14)
- Purpose clauses with ἵνα / ὅπως: v10, v14, v16
- Conditional construction: ἐὰν ἐμπέσῃ (v11)
- Relative clause: ὃς ἕξει (v11)
- Result clause with ὥστε: v12
*/

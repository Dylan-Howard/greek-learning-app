    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐγένετο", Transliteration = "egeneto", Gloss = "came into being", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "All things were made through him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γέγονεν", Transliteration = "gegonen", Gloss = "has been made", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "that has been made"
                }
            },
            Translation = "and without him was not any thing made that was made."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the light of men"
                }
            },
            Translation = "and the life was the light of men."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "φαίνει", Transliteration = "phainei", Gloss = "shines", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "The light shines in the darkness,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "κατέλαβεν", Transliteration = "katelaben", Gloss = "overcame", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and the darkness has not overcome it."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἀπεσταλμένος", Transliteration = "apestalmenos", Gloss = "having been sent", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "sent"
                        }
                    },
                    Translation = "a man sent"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    Translation = "whose name was John"
                }
            },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μαρτυρίαν", Transliteration = "martyrian", Gloss = "witness", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "for a witness"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μαρτυρήσῃ", Transliteration = "martyrēsē", Gloss = "he might bear witness", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "about the light"
                        }
                    },
                    Translation = "to bear witness about the light"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πιστεύσωσιν", Transliteration = "pisteusōsin", Gloss = "might believe", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "that all might believe through him"
                }
            },
            Translation = "He came as a witness, to bear witness about the light, that all might believe through him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐκεῖνος", Transliteration = "ekeinos", Gloss = "that [man]", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "pron" }
                    },
                    Translation = "He"
                },
                new Phrase
            ...
            Translation = "He was not the light,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "but [came] to bear witness about the light"
                }
            },
            Translation = "but came to bear witness about the light."
        }
...
- Verse 1: PRED (θεὸς) - Anarthrous predicate nominative.
- Verse 3: REL_CLAUSE (ὃ γέγονεν) - Relative clause modifying ἕν.
- Verse 4: GEN_DESC (τῶν ἀνθρώπων) - Descriptive/Possessive genitive.
- Verse 6: PTCP (ἀπεσταλμένος) - Perfect passive participle.
- Verse 7: PURPOSE_CLAUSE (ἵνα μαρτυρήσῃ...) - Hina + subjunctive for purpose.
- Verse 7: PURPOSE_CLAUSE (ἵνα πάντες πιστεύσωσιν...) - Hina + subjunctive for purpose.
- Verse 8: PURPOSE_CLAUSE (ἵνα μαρτυρήσῃ...) - Elliptical purpose clause.
*/

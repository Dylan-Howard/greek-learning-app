    ...
    return new List<object>
    {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἔσχεν", Transliteration = "eschen", Gloss = "he had", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἐπείνασεν", Transliteration = "epeinasen", Gloss = "was hungry", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Translation = "he and those with him"
                        }
                    },
                    Translation = "when he had need and was hungry, he and those with him"
                }
            },
            Translation = "Have you never read what David did when he had need and was hungry, he and those with him?"
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Ἀβιαθὰρ", Transliteration = "Abiathar", Gloss = "Abiathar", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "ἀρχιερέως", Transliteration = "archiereōs", Gloss = "the high priest", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "in the time of Abiathar the high priest"
                }
            },
            Translation = "how he entered into the house of God in the time of Abiathar the high priest,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "προθέσεως", Transliteration = "protheseōs", Gloss = "presentation", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                            },
                ...
                new Word { Greek = "ἔφαγεν", Transliteration = "ephagen", Gloss = "ate", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and ate the bread of the presence,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "except for the priests"
                }
            },
            Translation = "which it is not lawful to eat except for the priests,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "being with him"
                        }
                    },
                    Translation = "to those who were with him"
                }
            },
            Translation = "and he gave also to those who were with him."
        },
        // Verse 27
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐγένετο", Transliteration = "egeneto", Gloss = "was made", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "The Sabbath was made for man,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "for the Sabbath"
                }
            },
            Translation = "and not man for the Sabbath."
        },
        // Verse 28
        new Phrase
        {
...
- TEMP_CLAUSE: Mark 2:25 (ὅτε ...)
- RESULT_CLAUSE: Mark 2:28 (ὥστε ...)
- REL_CLAUSE: Mark 2:26 (οὓς ...)
- SUBSTANTIVAL_PTCP: Mark 2:26 (τοῖς ... οὖσιν)
- APP_IN_PREP_PHRASE: Mark 2:26 (ἐπὶ Ἀβιαθὰρ ἀρχιερέως)
*/

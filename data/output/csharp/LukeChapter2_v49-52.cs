            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐζητεῖτέ", Transliteration = "ezēteite", Gloss = "were you looking for", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "με", Transliteration = "me", Gloss = "me", GrammarCodes = new List<string> { "PRON", "ACC", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "Why is it that you were looking for me?"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ᾔδειτε", Transliteration = "ēdeite", Gloss = "did you know", GrammarCodes = new List<string> { "V", "PLPF", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                new Word { Greek = "τοῖς", Transliteration = "tois", Gloss = "the [things]", GrammarCodes = new List<string> { "ART", "DAT", "N", "P

    ...
    return new List<object>
    {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐπισυντρέχει", Transliteration = "episyntrechei", Gloss = "runs together", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                    ...
                    Translation = "that a crowd was running together"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to it", GrammarCodes = new List<string> { "PRON", "DAT", "N", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "saying to it"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἄλαλον", Transliteration = "alalon", Gloss = "mute", GrammarCodes = new List<string> { "ADJ", "VOC", "N", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "κωφὸν", Transliteration = "kōphon", Gloss = "deaf", GrammarCodes = new List<string> { "ADJ", "VOC", "N", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "πνεῦμα", Transliteration = "pneuma", Gloss = "spirit", GrammarCodes = new List<string> { "N", "VOC", "N", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "You mute and deaf spirit"
                        },
                        new Word { Greek = "ἐγὼ", Transliteration = "egō", Gloss = "I", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἐπιτάσσω", Transliteration = "epitassō", Gloss = "command", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "σοι", Transliteration = "soi", Gloss = "you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἔξεlθε", Transliteration = "exelthe", Gloss = "come out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                        ...
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "μηκέτι", Transliteration = "mēketi", Gloss = "never again", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "εἰσέλθῃς", Transliteration = "eiselthēs", Gloss = "enter", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "I command you, come out of him and never enter him again"
                }
            },
            Translation = "And when Jesus saw that a crowd came running together, he rebuked the unclean spirit, saying to it, 'You mute and deaf spirit, I command you, come out of him and never enter him again.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "σπαράξας", Transliteration = "sparaxas", Gloss = "having convulsed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐγένετο", Transliteration = "egeneto", Gloss = "he became", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὡσεὶ", Transliteration = "hōsei", Gloss = "as if", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "conj" },
                new Word { Greek = "νεκρός", Transliteration = "nekros", Gloss = "dead", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "ἀπέθανεν", Transliteration = "apethanen", Gloss = "he is dead", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "that he is dead"
                        }
                    },
                    Translation = "so that many said, 'He is dead.'"
                }
            },
            Translation = "And after crying out and convulsing him terribly, it came out, and the boy was like a corpse, so that most of them said, 'He is dead.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "κρατήσας", Transliteration = "kratēsas", Gloss = "having taken", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "having taken his hand"
                },
            ...
            Translation = "But Jesus took him by the hand and lifted him up, and he arose."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "εἰσελθόντος", Transliteration = "eiselthontos", Gloss = "having entered", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "him", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" }
                    },
                ...
                new Word { Greek = "ἐπηρώτων", Transliteration = "epērōtōn", Gloss = "were asking", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "Why", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἡμεῖς", Transliteration = "hēmeis", Gloss = "we", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "P" }, PartOfSpeech = "prep" },
                        new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "PRT" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἠδυνήθημεν", Transliteration = "ēdynēthēmen", Gloss = "were able", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "1P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἐκβαλεῖν", Transliteration = "ekbalein", Gloss = "to cast out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτό", Transliteration = "auto", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "Why could we not cast it out?"
                }
            },
            Translation = "And when he had entered the house, his disciples asked him privately, 'Why could we not cast it out?'"
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γένος", Transliteration = "genos", Gloss = "kind", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "οὐδενὶ", Transliteration = "oudeni", Gloss = "nothing", GrammarCodes = new List<string> { "ADJ", "DAT", "N", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "by nothing"
                },
                new Word { Greek = "δύναται", Transliteration = "dynatai", Gloss = "can", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἐξελθεῖν", Transliteration = "exelthein", Gloss = "come out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PRT" }, PartOfSpeech = "prep" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "except by prayer"
                }
            },
            Translation = "And he said to them, 'This kind cannot be driven out by anything but prayer.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "παρεπορεύοντο", Transliteration = "pareporeuonto", Gloss = "they were passing", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "that anyone should know"
                }
            },
            Translation = "They went on from there and passed through Galilee. And he did not want anyone to know,"
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "παραδίδοται", Transliteration = "paradidotai", Gloss = "is being delivered", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "into the hands of men"
                        },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἀποκτανθεὶς", Transliteration = "apoktantheis", Gloss = "having been killed", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "after being killed"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "that the Son of Man is going to be delivered into the hands of men, and they will kill him. And when he is killed, after three days he will rise."
                }
            },
            Translation = "for he was teaching his disciples, saying to them, 'The Son of Man is going to be delivered into the hands of men, and they will kill him. And when he is killed, after three days he will rise.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἠγνόουν", Transliteration = "ēgnooun", Gloss = "did not understand", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ῥῆμα", Transliteration = "rhēma", Gloss = "saying", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                    },
                ...
                new Word { Greek = "ἐπερωτῆσαι", Transliteration = "eperōtēsai", Gloss = "to ask", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" }
            },
            Translation = "But they did not understand the saying, and were afraid to ask him."
        }
    };
}
...
- GEN_ABS: Verse 28 (εἰσελθόντος αὐτοῦ)
- PURPOSE_CLAUSE: Verse 30 (ἵνα τις γνοῖ)
- RESULT_CLAUSE: Verse 26 (ὥστε ... λέγειν)
- CAUSAL_CLAUSE: Verse 25 (ὅτι ἐπισυντρέχει ὄχλος), Verse 28 (ὅτι ἡμεῖς οὐκ ἠδυνήθημεν)
- COND_CLAUSE: Verse 29 (εἰ μὴ ἐν προσευχῇ)
*/

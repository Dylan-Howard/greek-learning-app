    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ὠφελεῖται", Transliteration = "ōpheleitai", Gloss = "is profited", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "κερδήσας", Transliteration = "kerdēsas", Gloss = "having gained", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "having gained the whole world"
                },
                ...
                new Word { Greek = "ἀπολέσας", Transliteration = "apolesas", Gloss = "having destroyed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἢ", Transliteration = "ē", Gloss = "or", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ζημιωθείς", Transliteration = "zēmiōtheis", Gloss = "having forfeited", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
            },
            Translation = "For what is a man profited, having gained the whole world but having destroyed or forfeited himself?"
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐπαισχυνθῇ", Transliteration = "epaischynthē", Gloss = "is ashamed of", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "For whoever is ashamed of me and my words"
                },
                ...
                new Word { Greek = "ἐπαισχυνθήσεται", Transliteration = "epaischynthēsetai", Gloss = "will be ashamed of", GrammarCodes = new List<string> { "V", "FUT", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "[the glory] of the Father"
                        },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Phrase
                        {
                            ...
                            Translation = "of the holy angels"
                        }
                    },
                    Translation = "when He comes in His glory and the Father's and the holy angels'"
                }
            },
            Translation = "For whoever is ashamed of me and my words, of him the Son of Man will be ashamed when He comes in His glory and the Father's and the holy angels'."
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀληθῶς", Transliteration = "alēthōs", Gloss = "truly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "here", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                            ...
                            Translation = "of those standing here"
                        }
                    },
                    Translation = "standing here"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "REL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "no", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "part" },
                        new Word { Greek = "γεύσωνται", Transliteration = "geusōntai", Gloss = "will taste", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "3P", "P" }, PartOfSpeech = "v" },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "until they see the kingdom of God"
                        }
                    },
                    Translation = "who will by no means taste death until they see the kingdom of God"
                }
            },
            Translation = "But I say to you truly, there are some of those standing here who will by no means taste death until they see the kingdom of God."
        },
        // Verse 28
        new Phrase
        {
            ...
            Content = new List<object>
            {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "τοὺς", Transliteration = "tous", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "M", "P" }, PartOfSpeech = "art" },
                                new Word { Greek = "λόγους", Transliteration = "logous", Gloss = "words", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" },
                                new Word { Greek = "τούτους", Transliteration = "toutous", Gloss = "these", GrammarCodes = new List<string> { "PRON", "ACC", "M", "P" }, PartOfSpeech = "pron" }
                            },
                            Translation = "these words"
                        }
                    },
                    Translation = "after these words"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "having taken along Peter and John and James"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "εἰς", Transliteration = "eis", Gloss = "onto", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
            ...
            Translation = "Now it happened about eight days after these words, that having taken along Peter and John and James, He went up onto the mountain to pray."
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "προσεύχεσθαι", Transliteration = "proseuchesthai", Gloss = "praying", GrammarCodes = new List<string> { "V", "PRES", "MID", "INF" }, PartOfSpeech = "v" },
                                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "of Him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" }
                            },
                            Translation = "He was praying"
                        }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἶδος", Transliteration = "eidos", Gloss = "appearance", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "the appearance of His face"
                },
                new Word { Greek = "ἕτερον", Transliteration = "heteron", Gloss = "became different", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    ...
                    {
                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "ἱματισμὸς", Transliteration = "himatismos", Gloss = "clothing", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "of Him", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "pron" }
                    },
                    Translation = "His clothing"
                },
                new Word { Greek = "λευκὸς", Transliteration = "leukos", Gloss = "white", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἐξαστράπτων", Transliteration = "exastraptōn", Gloss = "flashing like lightning", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
            },
            Translation = "And it happened while He was praying, that the appearance of His face became different, and His clothing white and flashing like lightning."
        },
        // Verse 30
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "συνελάλουν", Transliteration = "synelaloun", Gloss = "were talking with", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "who were Moses and Elijah"
                }
            },
            Translation = "And behold, two men were talking with Him, who were Moses and Elijah,"
        },
        // Verse 31
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ὀφθέντες", Transliteration = "ophthentes", Gloss = "having appeared", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "having appeared in glory"
                },
                new Word { Greek = "ἔλεγον", Transliteration = "elegon", Gloss = "were speaking of", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πληροῦν", Transliteration = "plēroun", Gloss = "to fulfill", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "which He was about to fulfill in Jerusalem"
                }
            },
            Translation = "who, having appeared in glory, were speaking of His departure which He was about to fulfill in Jerusalem."
        },
        // Verse 32
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But Peter and those with Him"
                },
                new Word { Greek = "ἦσαν", Transliteration = "ēsan", Gloss = "were", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "βεβαρημένοι", Transliteration = "bebarēmenoi", Gloss = "overcome", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "ὕπῳ", Transliteration = "hypnō", Gloss = "by sleep", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "διαγρηγορήσαντες", Transliteration = "diagrēgorēsantes", Gloss = "having become fully awake", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "συνεστῶτας", Transliteration = "synestōtas", Gloss = "standing with", GrammarCodes = new List<string> { "V", "PERF", "ACT", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" },
                                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "Him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "pron" }
                                    },
                                    Translation = "standing with Him"
                                }
                            },
                            Translation = "the two men standing with Him"
                        }
                    },
                    Translation = "but having become fully awake, they saw His glory and the two men standing with Him"
                }
            },
            Translation = "But Peter and those with Him were overcome by sleep; but having become fully awake, they saw His glory and the two men standing with Him."
        }
    };
}
...
- Luke 9:26: Relative Clause with 'an' (ὃς ἂν ἐπαισχυνθῇ)
- Luke 9:27: Emphatic Negation (οὐ μὴ γεύσωνται)
- Luke 9:28: Temporal/Circumstantial Participle (παραλαβὼν)
- Luke 9:28: Infinitive of Purpose (προσεύξασθαι)
- Luke 9:29: Articular Infinitive with preposition (ἐν τῷ προσεύχεσθαι)
- Luke 9:32: Periphrastic-like Perfect Passive Participle (ἦσαν βεβαρημένοι)
*/

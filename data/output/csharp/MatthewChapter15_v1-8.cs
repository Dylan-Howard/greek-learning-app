    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "προσέρχονται", Transliteration = "proserchontai", Gloss = "come to", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Translation = "Pharisees and scribes"
                },
                new Phrase
                {
            ...
            Translation = "Then Pharisees and scribes came to Jesus from Jerusalem, saying,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "παραβαίνουσιν", Transliteration = "parabainousin", Gloss = "break", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "Why do your disciples break the tradition of the elders?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "νίπτονται", Transliteration = "niptontai", Gloss = "wash", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐσθίωσιν", Transliteration = "esthiōsin", Gloss = "they eat", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "whenever they eat bread"
                }
            },
            Translation = "For they do not wash their hands when they eat bread."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "παραβαίνετε", Transliteration = "parabainete", Gloss = "break", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "because of your tradition"
                }
            },
            Translation = "Why do you also break the commandment of God because of your tradition?"
        },
        ...
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "κακολογῶν", Transliteration = "kakologōn", Gloss = "speaking evil of", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "speaking evil of"
                        }
                    },
                    Translation = "the one speaking evil of"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
            ...
            Translation = "and, ‘The one who speaks evil of father or mother must be put to death.’"
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "to his father or mother"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                new Word { Greek = "δῶρον", Transliteration = "dōron", Gloss = "A gift [is]", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "REL_CLAUSE" },
                                    Content = new List<object>
                                    ...
                                    Translation = "whatever you might have been helped by from me"
                                }
                            },
                            Translation = "A gift is whatever you might have received from me"
                        }
                    },
                    Translation = "‘Whoever says to his father or mother, “What you would have gained from me is a gift,”"
                }
            },
            Translation = "But you say, ‘Whoever says to his father or mother, “What you would have gained from me is Corban” (that is, a gift devoted to God),’"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "οὐ", Transliteration = "ou", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "no", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                new Word { Greek = "τιμήσει", Transliteration = "timēsei", Gloss = "he shall honor", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "he shall not honor his father."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἠκυρώσατε", Transliteration = "ēkyrōsate", Gloss = "you nullified", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "And you have nullified the word of God because of your tradition."
        },
        ...
        new Phrase
        {
            ...
            Translation = "Hypocrites! Isaiah rightly prophesied about you, saying,"
        },
        ...
        new Phrase
        {
            ...
            Translation = "‘This people honors Me with their lips,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "πόρρω", Transliteration = "porrō", Gloss = "far", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
...
- GEN_DESC: "τῶν πρεσβυτέρων" (v2), "τοῦ θεοῦ" (v3, v6)
- DAT_INSTR: "χείλεσίν" (v8)
- VOC: "ὑποκριταί" (v7)
- PTCP: "λέγοντες" (v1), "ἀποκριθεὶς" (v3), "κακολογῶν" (v4), "λέγων" (v7)
- REL_CLAUSE: "ὃς ἂν εἴπῃ..." (v5), "ὃ ἐὰν ἐξ ἐμοῦ ὠφεληθῇς" (v5)
- TEMP_CLAUSE: "ὅταν ἄρτον ἐσθίωσιν" (v2)
*/

            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δύνηται", Transliteration = "dynētai", Gloss = "to be able", GrammarCodes = new List<string> { "V", "PRES", "MP", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        ...
                        new Word { Greek = "πωλῆσαι", Transliteration = "pōlēsai", Gloss = "to sell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {

...
- 1 John 5:1: NOUN_PHRASE (SUBJ) with PTCP (πιστεύων, ἀγαπῶν)
- 1 John 5:4: NOUN_PHRASE (SUBJ) with PERF PTCP (γεγεννημένον)
- 1 John 5:6: NOUN_PHRASE (PRED) with AOR PTCP (ἐλθὼν)
- 1 John 5:7: NOUN_PHRASE (SUBJ) with PRES PTCP (μαρτυροῦντες)
*/

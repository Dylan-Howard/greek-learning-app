private static List<object> GetChapter8()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "what was spoken through Isaiah the prophet"
                },
            ...
            Translation = "This was to fulfill what was spoken through the prophet Isaiah, saying:"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀσθενείας", Transliteration = "astheneias", Gloss = "weakness", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" },
                        new Word { Greek = "ἡμῶν", Transliteration = "hēmōn", Gloss = "of us", GrammarCodes = new List<string> { "PRON", "GEN", "1P", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "our weaknesses"
                },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τὰς", Transliteration = "tas", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "P" }, PartOfSpeech = "art" },
                        new Word { Greek = "νόσους", Transliteration = "nosous", Gloss = "disease", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "the diseases"
                },
                new Word { Greek = "ἐβάστασεν", Transliteration = "ebastasen", Gloss = "carried", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "He himself took our weaknesses and carried our diseases."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "a crowd around him"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "to go to the other side"
                }
            },
            Translation = "Now when Jesus saw a crowd around him, he gave orders to go to the other side."
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "προσελθὼν", Transliteration = "proselthōn", Gloss = "coming to", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀπέρχῃ", Transliteration = "aperchē", Gloss = "you go away", GrammarCodes = new List<string> { "V", "PRES", "MID", "SUBJ", "2P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "wherever you go"
                        }
                    },
                    Translation = "\"Teacher, I will follow you wherever you go.\""
                }
            },
            Translation = "And a scribe came up and said to him, \"Teacher, I will follow you wherever you go.\""
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "somewhere to lay his head"
                        }
                    },
                    Translation = "\"Foxes have holes, and birds of the air have nests, but the Son of Man has nowhere to lay his head.\""
                }
            },
            Translation = "And Jesus said to him, \"Foxes have holes, and birds of the air have nests, but the Son of Man has nowhere to lay his head.\""
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "Another of the disciples"
                },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    ...
                    Translation = "\"Lord, let me first go and bury my father.\""
                }
            },
            Translation = "Another of the disciples said to him, \"Lord, let me first go and bury my father.\""
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "\"Follow me, and leave the dead to bury their own dead.\""
                }
            },
            Translation = "But Jesus said to him, \"Follow me, and leave the dead to bury their own dead.\""
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐμβάντι", Transliteration = "embanti", Gloss = "getting into", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "he", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "when he got in"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "And when he got into the boat, his disciples followed him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "σεισμὸς", Transliteration = "seismos", Gloss = "storm", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "μέγας", Transliteration = "megas", Gloss = "great", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "a great storm"
                },
                new Word { Greek = "ἐγένετο", Transliteration = "egeneto", Gloss = "arose", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καλύπτεσθαι", Transliteration = "kaluptesthai", Gloss = "to be covered", GrammarCodes = new List<string> { "V", "PRES", "PASS", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "κυμάτων", Transliteration = "kymatōn", Gloss = "waves", GrammarCodes = new List<string> { "N", "GEN", "N", "P" }, PartOfSpeech = "n" }
                                    },
                    ...
                    Translation = "so that the boat was being covered by the waves"
                },
                new Word { Greek = "αὐτὸς", Transliteration = "autos", Gloss = "he", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐκάθευδεν", Transliteration = "ekatheuden", Gloss = "was sleeping", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "And behold, a great storm arose on the sea, so that the boat was being covered by the waves; but he was sleeping."
        }
    };
}
...
- APPOS: "the prophet" (v17)
- GEN_DESC: "of the air" (v20), "of Man" (v20), "of his disciples" (v21)
- GEN_ABS: "when he got in" (v23) - dative absolute variant (participial construction following main verb)
- RESULT_CLAUSE: "so that the boat was being covered..." (v24)
*/

    ...
    return new List<object>
    {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐκπορευομένου", Transliteration = "ekporeuomenou", Gloss = "going out", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "he", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "And as he was going out"
                },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "προσδραμὼν", Transliteration = "prosdramōn", Gloss = "running up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "εἷς", Transliteration = "heis", Gloss = "one", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "one running up"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "γονυπετήσας", Transliteration = "gonypetēsas", Gloss = "kneeling", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "having knelt before him"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀγαθέ", Transliteration = "agathe", Gloss = "good", GrammarCodes = new List<string> { "ADJ", "VOC", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "Good Teacher"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κληρονομήσω", Transliteration = "klēronomēsō", Gloss = "I may inherit", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "that I may inherit eternal life"
                }
            },
            Translation = "And as he was going out into the way, one ran up and knelt before him and asked him, 'Good Teacher, what shall I do that I may inherit eternal life?'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "λέγεις", Transliteration = "legeis", Gloss = "you call", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἀγαθόν", Transliteration = "agathon", Gloss = "good", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Translation = "except one, God"
                }
            },
            Translation = "And Jesus said to him, 'Why do you call me good? No one is good except one, God.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "φονεύσῃς", Transliteration = "phoneusēs", Gloss = "do murder", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "S" }, PartOfSpeech = "v" }
                    },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "κλέψῃς", Transliteration = "klepsēs", Gloss = "steal", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "S" }, PartOfSpeech = "v" }
                    },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ψευδομαρτυρήσῃς", Transliteration = "pseudomartyrēsēs", Gloss = "bear false witness", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "Do not bear false witness"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                    ...
                    {
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἀποστερήσῃς", Transliteration = "aposterēsēs", Gloss = "defraud", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "Do not defraud"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                    ...
                    Translation = "Honor your father and mother"
                }
            },
            Translation = "You know the commandments: Do not murder, Do not commit adultery, Do not steal, Do not bear false witness, Do not defraud, Honor your father and mother."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐφυλαξάμην", Transliteration = "ephylaxamēn", Gloss = "I have kept", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "νεότητός", Transliteration = "neotētos", Gloss = "youth", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "μου", Transliteration = "mou", Gloss = "my", GrammarCodes = new List<string> { "PRON", "GEN", "1P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "from my youth"
                }
            },
            Translation = "And he said to him, 'Teacher, all these things I have kept from my youth.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐμβλέψας", Transliteration = "emblepsas", Gloss = "looking at", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "looking at him"
                },
                ...
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἕν", Transliteration = "hen", Gloss = "one thing", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "σε", Transliteration = "se", Gloss = "you", GrammarCodes = new List<string> { "PRON", "ACC", "2P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ὑστερεῖ", Transliteration = "hysterei", Gloss = "lacks", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "whatever you have"
                },
                new Word { Greek = "πώλησον", Transliteration = "pōlēson", Gloss = "sell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "And Jesus, looking at him, loved him and said to him, 'One thing you lack: go, sell whatever you have and give to the poor, and you will have treasure in heaven; and come, follow me.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "στυγνάσας", Transliteration = "stygnasas", Gloss = "being gloomy", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "being gloomy at the word"
                },
                ...
                new Word { Greek = "λυπούμενος", Transliteration = "lypoumenos", Gloss = "sorrowful", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Translation = "for he had many possessions"
                }
            },
            Translation = "But he, being gloomy at the word, went away sorrowful, for he had many possessions."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "περιβλεψάμενος", Transliteration = "periblepsamenos", Gloss = "looking around", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "looking around"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                ...
                new Word { Greek = "δυσκόλως", Transliteration = "dyskolōs", Gloss = "hardly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "χρήματα", Transliteration = "chrēmata", Gloss = "riches", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                            ...
                            Translation = "having riches"
                        }
                    },
                    Translation = "those who have riches"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Word { Greek = "εἰσελεύσονται", Transliteration = "eiseleusontai", Gloss = "will enter", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "And Jesus, looking around, said to his disciples, 'How hardly shall those who have riches enter into the kingdom of God!'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐθαμβοῦντο", Transliteration = "ethambounto", Gloss = "were amazed", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Word { Greek = "πῶς", Transliteration = "pōs", Gloss = "how", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "δύσκολόν", Transliteration = "dyskolon", Gloss = "hard", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Translation = "to enter into the kingdom of God"
                }
            },
            Translation = "But the disciples were amazed at his words. But Jesus answering again said to them, 'Children, how hard it is to enter into the kingdom of God!'"
        }
    };
}

/* Identified Constructions:
- GEN_ABS: Verse 17 (Καὶ ἐκπορευομένου αὐτοῦ)
- PERIPH: Verse 22 (ἦν... ἔχων)
- VOC: Verse 17 (διδάσκαλε ἀγαθέ), Verse 20 (διδάσκαλε), Verse 24 (τέκνα)
- COND_CLAUSE: Verse 18 (εἰ μὴ εἷς ὁ θεός)
- PURPOSE_CLAUSE: Verse 17 (ἵνα ζωὴν αἰώνιον κληρονομήσω)
*/

            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀρνήσηταί", Transliteration = "arnēsētai", Gloss = "denies", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "But whoever denies me before men"
                },
                new Word { Greek = "ἀρνήσομαι", Transliteration = "arnēsomai", Gloss = "will deny", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },

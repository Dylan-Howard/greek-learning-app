private static List<object> GetChapter4()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Translation = "And they have no root in themselves,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "πρόσκαιροί", Transliteration = "proskairoi", Gloss = "temporary", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "διωγμοῦ", Transliteration = "diōgmou", Gloss = "persecution", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "when tribulation or persecution arises"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Word { Greek = "σκανδαλίζονται", Transliteration = "skandalizontai", Gloss = "they fall away", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "then, when tribulation or persecution arises on account of the word, immediately they fall away."
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "being sown among the thorns"
                        }
                    },
                    Translation = "those sown among the thorns"
                }
            },
            Translation = "And others are the ones being sown among the thorns;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "having heard the word"
                        }
                    },
                    Translation = "the ones who heard the word"
                }
            },
            Translation = "these are the ones who heard the word,"
        },
        ...
        new Phrase
        {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "μέριμναι", Transliteration = "merimnai", Gloss = "cares", GrammarCodes = new List<string> { "N", "NOM", "F", "P" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                            ...
                            Translation = "the cares of the age"
                        },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀπάτη", Transliteration = "apatē", Gloss = "deceitfulness", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "GEN_DESC" },
                                    Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "concerning the other things"
                                },
                                new Word { Greek = "ἐπιθυμίαι", Transliteration = "epithymiai", Gloss = "desires", GrammarCodes = new List<string> { "N", "NOM", "F", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "the desires for other things"
                        }
                    },
                    Translation = "the cares of the world, the deceitfulness of riches, and the desires for other things"
                },
                new Word { Greek = "εἰσπορευόμεναι", Transliteration = "eisporeuomenai", Gloss = "entering in", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "F", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "συμπνίγουσιν", Transliteration = "sympnigousin", Gloss = "they choke", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "but the cares of the world and the deceitfulness of riches and the desires for other things enter in and choke the word,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἄκαρπος", Transliteration = "akarpos", Gloss = "unfruitful", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "γίνεται", Transliteration = "ginetai", Gloss = "it becomes", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and it becomes unfruitful."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐκεῖνοί", Transliteration = "ekeinoi", Gloss = "those", GrammarCodes = new List<string> { "PRON", "NOM", "M", "P" }, PartOfSpeech = "adv" }
                    },
                    Translation = "those"
                },
                new Word { Greek = "εἰσιν", Transliteration = "eisin", Gloss = "are", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                ...
                                                new Word { Greek = "γῆν", Transliteration = "gēn", Gloss = "soil", GrammarCodes = new List<string> { "N", "ACC", "F", "

private static List<object> GetChapter13()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "Πείθεσθε", Transliteration = "Peithesthe", Gloss = "Obey", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἡγουμένοις", Transliteration = "hēgoumenois", Gloss = "leaders", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "DAT", "M", "P" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "ὑπείκετε", Transliteration = "hypeikete", Gloss = "submit", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "Obey your leaders and submit to them,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀγρυπνοῦσιν", Transliteration = "agrypnousin", Gloss = "keep watch", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Word { Greek = "ἀποδώσοντες", Transliteration = "apodōsontes", Gloss = "will give", GrammarCodes = new List<string> { "V", "FUT", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
            },
            Translation = "for they keep watch over your souls as those who will give an account,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ποιῶσιν", Transliteration = "poiōsin", Gloss = "they may do", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                new Word { Greek = "στενάζοντες", Transliteration = "stenazontes", Gloss = "groaning", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
            },
            Translation = "that they may do this with joy and not with groaning,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "ἀλυσιτελὲς", Transliteration = "alysiteles", Gloss = "unprofitable", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "for this would be unprofitable for you."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "πειθόμεθα", Transliteration = "peithometha", Gloss = "we are sure", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "1P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    ...
                    Translation = "that we have a good conscience"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καλῶς", Transliteration = "kalōs", Gloss = "honorably", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "θέλοντες", Transliteration = "thelontes", Gloss = "desiring", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "INF_PHRASE" },
                            Content = new List<object>
                            {
                                new Word { Greek = "ἀναστρέφεσθαι", Transliteration = "anastrephesthai", Gloss = "to conduct ourselves", GrammarCodes = new List<string> { "V", "PRES", "PASS", "INF" }, PartOfSpeech = "v" }
                            },
                            Translation = "to conduct ourselves"
                        }
                    },
                    Translation = "desiring to conduct ourselves honorably in all things."
                }
            },
            Translation = "for we are sure that we have a good conscience, desiring to conduct ourselves honorably in all things."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "περισσοτέρως", Transliteration = "perissoterōs", Gloss = "more earnestly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ἵνα", Transliteration = "hina", Gloss = "that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "τάχιον", Transliteration = "tachion", Gloss = "sooner", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἀποκατασταθῶ", Transliteration = "apokatastathō", Gloss = "I may be restored", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "ὑμῖν", Transliteration = "hymin", Gloss = "to you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "that I may be restored to you sooner."
                }
            },
            Translation = "I urge you the more earnestly to do this, that I may be restored to you sooner."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀναγαγὼν", Transliteration = "anagagōn", Gloss = "brought up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the great shepherd of the sheep"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Translation = "of the eternal covenant"
                                        }
                                    },
                                    Translation = "the blood of the eternal covenant"
                                }
                            },
                            Translation = "by the blood of the eternal covenant"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                    ...
                    Translation = "who brought up from the dead our Lord Jesus, the great shepherd of the sheep, by the blood of the eternal covenant,"
                }
            },
            Translation = "Now may the God of peace who brought up from the dead our Lord Jesus, the great shepherd of the sheep, by the blood of the eternal covenant,"
        },
        ...
        new Phrase
        {
            ...
            {
                // (continues verse 20)
                new Word { Greek = "καταρτίσαι", Transliteration = "katartisai", Gloss = "equip", GrammarCodes = new List<string> { "V", "AOR", "ACT", "OPT", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀγαθῷ", Transliteration = "agathō", Gloss = "good thing", GrammarCodes = new List<string> { "ADJ", "DAT", "N", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "in every good thing"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ποιῆσαι", Transliteration = "poiēsai", Gloss = "do", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ποιῶν", Transliteration = "poiōn", Gloss = "working", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "εὐάρεστον", Transliteration = "euareston", Gloss = "pleasing", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "him", GrammarCodes = new List<string> { "PRON", "GEN", "3P", "M", "S" }, PartOfSpeech = "prep" }
                                    },
                                    Translation = "before him"
                                }
                            },
                            Translation = "that which is pleasing before him"
                        }
                    },
                    Translation = "working in us that which is pleasing before him"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    Translation = "to whom be glory forever and ever. Amen."
                }
            },
            Translation = "equip you in every good thing to do his will, working in us that which is pleasing before him through Jesus Christ, to whom be glory forever and ever. Amen."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀνέχεσθε", Transliteration = "anechesthe", Gloss = "bear with", GrammarCodes = new List<string> { "V", "PRES", "MID", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    {
                                        new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "παρακλήσεως", Transliteration = "paraklēseōs", Gloss = "exhortation", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "of exhortation"
                                }
                            },
                            Translation = "the word of exhortation"
                        }
                    },
                    Translation = "to bear with the word of exhortation"
                }
            },
            Translation = "I urge you, brothers, bear with the word of exhortation,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "βραχέων", Transliteration = "bracheōn", Gloss = "few words", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "briefly"
                },
                new Word { Greek = "ἐπέστειλα", Transliteration = "epesteila", Gloss = "I have written", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὑμῖν", Transliteration = "hymin", Gloss = "to you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "P" }, PartOfSpeech = "prep" }
            },
            Translation = "for I have written to you briefly."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "our brother Timothy"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀπολελυμένον", Transliteration = "apolelymenon", Gloss = "has been released", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "has been released"
                }
            },
            Translation = "Know that our brother Timothy has been released,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τάχιον", Transliteration = "tachion", Gloss = "soon", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἔρχηται", Transliteration = "erchētai", Gloss = "he comes", GrammarCodes = new List<string> { "V", "PRES", "MID", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "if he comes soon"
                },
                new Word { Greek = "ὄψομαι", Transliteration = "opsomai", Gloss = "I will see", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὑμᾶς", Transliteration = "hymas", Gloss = "you", GrammarCodes = new List<string> { "PRON", "ACC", "2P", "P" }, PartOfSpeech = "prep" }
            },
            Translation = "with whom, if he comes soon, I will see you."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τοὺς", Transliteration = "tous", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "M", "P" }, PartOfSpeech = "art" },
                        new Word { Greek = "ἡγουμένους", Transliteration = "hēgoumenous", Gloss = "leaders", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "ὑμῶν", Transliteration = "hymōn", Gloss = "of you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "all your leaders"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
            ...
            Translation = "Greet all your leaders and all the saints."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "Ἀσπάζονται", Transliteration = "Aspazontai", Gloss = "greet", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "ὑμᾶς", Transliteration = "hymas", Gloss = "you", GrammarCodes = new List<string> { "PRON", "ACC", "2P", "P" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    ...
                    Translation = "Those from Italy"
                }
            },
            Translation = "Those who come from Italy greet you."
        }
    };
}
...
- Verse 20: NOUN_PHRASE apposition defining "God of peace".
- Verse 21: REL_CLAUSE (ᾧ...) referring to Jesus Christ.
- Verse 23: PTCP (ἀπολελυμένον) functioning as a complement to the object Timothy.
*/

            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "βασιλικός", Transliteration = "basilikos", Gloss = "royal official", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "the royal official"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀποθανεῖν", Transliteration = "apothanein", Gloss = "to die", GrammarCodes = new List<string> { "V", "2", "ACT", "AOR", "INF" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                                    Content = new List<object>
                            ...
                            Translation = "before my child dies"
                        }
                    },
                    Translation = "Sir, come down before my child dies."
                }
            },
            Translation = "The royal official says to him, 'Sir, come down before my child dies.'"
        },
        // Verse 50
        new Phrase
        {
            ...
            Translation = "Jesus says to him, 'Go; your son lives.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "said", GrammarCodes = new List<string> { "V", "2", "ACT", "AOR", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "pron" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    ...
                    Translation = "which Jesus said to him"
                },
            ...
            Translation = "The man believed the word that Jesus said to him and went his way."
        },
        // Verse 51
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καταβαίνοντος", Transliteration = "katabainontos", Gloss = "going down", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "Now as he was already going down"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "παῖς", Transliteration = "pais", Gloss = "son", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "his", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "pron" }
                            },
                            Translation = "his son"
                        },
                    ...
                    Translation = "that his son lives"
                }
            },
            Translation = "Now as he was already going down, his servants met him and said that his son lives."
        },
        // Verse 52
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἐπύθετο", Transliteration = "epytheto", Gloss = "he asked", GrammarCodes = new List<string> { "V", "2", "MID", "AOR", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κομψότερον", Transliteration = "kompsoteron", Gloss = "better", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἔσχεν", Transliteration = "eschen", Gloss = "he got", GrammarCodes = new List<string> { "V", "2", "ACT", "AOR", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "in which he got better"
                },
                new Word { Greek = "εἶπαν", Transliteration = "eipan", Gloss = "they said", GrammarCodes = new List<string> { "V", "2", "ACT", "AOR", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἐχθὲς", Transliteration = "echthes", Gloss = "yesterday", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "ὥραν", Transliteration = "hōran", Gloss = "hour", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "ἑβδόμην", Transliteration = "hebdomēn", Gloss = "seventh", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "seventh hour"
                        },
                    ...
                    Translation = "that yesterday at the seventh hour the fever left him"
                }
            },
            Translation = "So he asked them the hour when he began to get better, and they said to him, 'Yesterday at the seventh hour the fever left him.'"
        },
        // Verse 53
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἔγνω", Transliteration = "egnō", Gloss = "realized", GrammarCodes = new List<string> { "V", "2", "ACT", "AOR", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "οὖν", Transliteration = "oun", Gloss = "so", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "in which Jesus said to him, 'Your son lives'"
                        }
                    },
                    Translation = "that it was at that very hour in which Jesus said to him, 'Your son lives'"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐπίστευσεν", Transliteration = "episteusen", Gloss = "believed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "οἰκία", Transliteration = "oikia", Gloss = "household", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "his", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "pron" },
                        new Word { Greek = "ὅλη", Transliteration = "holē", Gloss = "whole", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "his whole household"
                }
            },
            Translation = "The father realized that it was at that very hour in which Jesus had said to him, 'Your son lives,' and he himself believed, and his whole household."
        },
        // Verse 54
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐλθὼν", Transliteration = "elthōn", Gloss = "having come", GrammarCodes = new List<string> { "V", "2", "ACT", "AOR", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "This was now the second sign that Jesus did when he had come from Judea to Galilee."
        }
    };
}
...
- GEN_ABS: Verse 51 (αὐτοῦ καταβαίνοντος)
- TEMP_CLAUSE: Verse 49 (πρὶν ἀποθανεῖν τὸ παιδίον μου)
- REL_CLAUSE: Verse 50 (ὃν εἶπεν αὐτῷ ὁ Ἰησοῦς), Verse 52 (ἐν ᾗ κομψότερον ἔσχεν), Verse 53 (ἐν ᾗ εἶπεν αὐτῷ ὁ Ἰησοῦς)
- CAUSAL_CLAUSE (Indirect Discourse): Verse 51 (ὅτι ὁ παῖς αὐτοῦ ζῇ), Verse 52 (ὅτι ἐχθὲς ὥραν ἑβδόμην ἀφῆκεν αὐτὸν ὁ πυρετός), Verse 53 (ὅτι ἐν ἐκείνῃ τῇ ὥρᾳ...)
*/

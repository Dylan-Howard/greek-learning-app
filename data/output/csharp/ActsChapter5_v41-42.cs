    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐπορεύοντο", Transliteration = "eporeuonto", Gloss = "were going", GrammarCodes = new List<string> { "V", "IMPF", "MP", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "προσώπου", Transliteration = "prosōpou", Gloss = "presence", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "the presence of the council"
                        }
                    },
                    Translation = "from the presence of the council"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κατηξιώθησαν", Transliteration = "katēxiōthēsan", Gloss = "they were counted worthy", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀτιμασθῆναι", Transliteration = "atimasthēnai", Gloss = "to be dishonored", GrammarCodes = new List<string> { "V", "AOR", "PASS", "INF" }, PartOfSpeech = "v" }
                            },
                            Translation = "to suffer dishonor for the name"
                        }
                    },
                    Translation = "because they were counted worthy to suffer dishonor for the name"
                }
            },
            Translation = "So they went out from the presence of the council, rejoicing that they were counted worthy to suffer dishonor for the name."
        },
        // Verse 42
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πᾶσάν", Transliteration = "pasan", Gloss = "every", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" },
                ...
                new Word { Greek = "ἐπαύοντο", Transliteration = "epauonto", Gloss = "they ceased", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
            ...
            Translation = "And every day, in the temple and from house to house, they did not cease teaching and preaching Jesus as the Christ."
        }
    };
}
...
- Verse 42: "τὸν χριστὸν Ἰησοῦν" - APPOS (Apposition identifying the Christ as Jesus)
- Verse 42: "πᾶσάν τε ἡμέραν" - Accusative of extent of time
*/

...
- DAT_REF: τῇ ἀγάπῃ (v12) - dative of reference/sphere.
- PURPOSE_CLAUSE: εἰς τὸ στηρίξαι... (v13) - preposition + articular infinitive expressing purpose.
- INF_PHRASE: εἰς τὸ ἰδεῖν... (v10) - preposition + articular infinitive expressing purpose/result.
*/

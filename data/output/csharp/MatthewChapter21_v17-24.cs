    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "into Bethany"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ηὐλίσθη", Transliteration = "ēulisthē", Gloss = "he lodged", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἐκεῖ", Transliteration = "ekei", Gloss = "there", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
            },
            Translation = "And leaving them, he went out outside the city into Bethany and lodged there."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐπανάγων", Transliteration = "epanagōn", Gloss = "returning", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "to the city"
                        }
                    },
                    Translation = "returning to the city"
                },
            ...
            Translation = "Now early in the morning, as he was returning to the city, he was hungry."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    {
                                        new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "ὁδοῦ", Transliteration = "hodou", Gloss = "road", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                                    },
                    ...
                    Translation = "seeing a single fig tree by the road"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "φύλλα", Transliteration = "phylla", Gloss = "leaves", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                                new Word { Greek = "μόνον", Transliteration = "monon", Gloss = "only", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "leaves only"
                        }
                    },
                    Translation = "except leaves only"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γένηται", Transliteration = "genētai", Gloss = "let there be", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "May no fruit ever come from you again"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐξηράνθη", Transliteration = "exēranthē", Gloss = "withered", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "And seeing a single fig tree by the road, he went to it and found nothing on it except leaves only. and he says to it, 'May no fruit ever come from you again!' And at once the fig tree withered."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "How did the fig tree wither at once?"
                }
            },
            Translation = "And when the disciples saw it, they marveled, saying, 'How did the fig tree wither at once?'"
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "διακριθῆτε", Transliteration = "diakrithēte", Gloss = "you doubt", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "if you have faith and do not doubt"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "of the fig tree"
                        }
                    },
                    Translation = "the matter of the fig tree"
                },
                new Word { Greek = "ποιήσετε", Transliteration = "poiēsete", Gloss = "you will do", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "even if you say to this mountain"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    ...
                    Translation = "'Be taken up and thrown into the sea'"
                },
                new Word { Greek = "γενήσεται", Transliteration = "genēsetai", Gloss = "it will happen", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "Jesus answered and said to them, 'Truly I say to you, if you have faith and do not doubt, you will not only do what was done to the fig tree, but even if you say to this mountain, \"Be taken up and thrown into the sea,\" it will happen.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "whatever you ask in prayer"
                        }
                    },
                    Translation = "all things whatever you ask in prayer"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                ...
                new Word { Greek = "λήμψεσθε", Transliteration = "lēmpsesthe", Gloss = "you will receive", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "And whatever you ask in prayer, believing, you will receive."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "προσῆλθον", Transliteration = "prosēlthon", Gloss = "they came to", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "διδάσκοντι", Transliteration = "didaskonti", Gloss = "as he was teaching", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "as he was teaching"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                ...
                new Phrase
                {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "ποίᾳ", Transliteration = "poia", Gloss = "what", GrammarCodes = new List<string> { "PRON", "DAT", "F", "S" }, PartOfSpeech = "interj" },
                    ...
                    Translation = "By what authority are you doing these things?"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Translation = "and who gave you this authority?"
                }
            },
            Translation = "And when he had come into the temple, the chief priests and the elders of the people came to him as he was teaching, saying, 'By what authority are you doing these things? and who gave you this authority?'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτοῖς", Transliteration = "autois", Gloss = "to them", GrammarCodes = new List<string> { "PRON", "DAT", "M", "P" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἐρωτήσω", Transliteration = "erōtēsō", Gloss = "I will ask", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "λόγον", Transliteration = "logon", Gloss = "question", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "ἕνα", Transliteration = "hena", Gloss = "one", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "one question"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "REL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐὰν", Transliteration = "ean", Gloss = "if", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "εἴπητέ", Transliteration = "eipēte", Gloss = "you tell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "μοι", Transliteration = "moi", Gloss = "me", GrammarCodes = new List<string> { "PRON", "DAT", "1P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "which if you tell me"
                },
                new Word { Greek = "κἀγὼ", Transliteration = "kagō", Gloss = "I also", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ὑμῖν", Transliteration = "hymin", Gloss = "to you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "P" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἐρῶ", Transliteration = "erō", Gloss = "will tell", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "Jesus answered and said to them, 'I also will ask you one question, which if you tell me, I also will tell you by what authority I do these things.'"
        }
    };
}
...
- GEN_ABS: Verse 23 (ἐλθόντος αὐτοῦ)
- NOUN_PHRASE (with multiple articles/modifiers): Verse 21 (τὸ τῆς συκῆς), Verse 23 (οἱ πρεσβύτεροι τοῦ λαοῦ)
- REL_CLAUSE: Verse 22 (ὅσα ἂν αἰτήσητε), Verse 24 (ὃν ἐὰν εἴπητέ μοι)
- COND_CLAUSE: Verse 21 (ἐὰν ἔχητε πίστιν...), Verse 21 (κἂν τῷ ὄρει τούτῳ εἴπητε)
*/

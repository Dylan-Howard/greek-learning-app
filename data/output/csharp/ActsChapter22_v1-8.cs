    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀκούσατέ", Transliteration = "akousate", Gloss = "hear", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀπολογίας", Transliteration = "apologias", Gloss = "defense", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the defense now to you"
                }
            },
            Translation = "Brothers and fathers, hear my defense which I now make to you."
        },
        // Verse 2
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "And when they heard"
                },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "Ἑβραΐδι", Transliteration = "Hebraïdi", Gloss = "Hebrew", GrammarCodes = new List<string> { "ADJ", "DAT", "F", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "διαλέκτῳ", Transliteration = "dialektō", Gloss = "language", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "in the Hebrew language"
                        },
                        new Word { Greek = "προσεφώνει", Transliteration = "prosephōnei", Gloss = "he was speaking", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτοῖς", Transliteration = "autois", Gloss = "to them", GrammarCodes = new List<string> { "PRON", "DAT", "M", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "that he was speaking to them in the Hebrew language"
                },
                new Word { Greek = "μᾶλλον", Transliteration = "mallon", Gloss = "more", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "παρέσχον", Transliteration = "pareschon", Gloss = "they kept", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "ἡσυχίαν", Transliteration = "hēsychian", Gloss = "silence", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "And when they heard that he was addressing them in the Hebrew language, they became even more quiet. And he says:"
        },
        // Verse 3
        new Phrase
        {
            ...
            Content = new List<object>
            {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "Ταρσῷ", Transliteration = "Tarsō", Gloss = "Tarsus", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                            ...
                            Translation = "in Tarsus of Cilicia"
                        }
                    },
                    Translation = "born in Tarsus of Cilicia"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀνατεθραμμένος", Transliteration = "anatethrammenos", Gloss = "having been brought up", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "δὲ", Transliteration = "de", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "but brought up in this city"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "Γαμαλιὴλ", Transliteration = "Gamaliēl", Gloss = "of Gamaliel", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "the feet of Gamaliel"
                        }
                    },
                    Translation = "at the feet of Gamaliel"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "πεπαιδευμένος", Transliteration = "pepaideumenos", Gloss = "having been instructed", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀκρίβειαν", Transliteration = "akribeian", Gloss = "strictness", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "πατρῴου", Transliteration = "patrōou", Gloss = "ancestral", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "S" }, PartOfSpeech = "adj" },
                                        new Word { Greek = "νόμου", Transliteration = "nomou", Gloss = "law", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "the ancestral law"
                                }
                            },
                            Translation = "according to the strictness of the ancestral law"
                        }
                    },
                    Translation = "instructed according to the strictness of our ancestral law"
                },
                new Word { Greek = "ζηλωτὴς", Transliteration = "zēlōtēs", Gloss = "a zealot", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "τοῦ", Transliteration = "tou", Gloss = "for", GrammarCodes = new List<string> { "ART", "GEN", "M", "S" }, PartOfSpeech = "art" },
                ...
                new Phrase
                {
                    ...
                    Translation = "just as you all are today"
                }
            },
            Translation = "I am a Jew, born in Tarsus of Cilicia, but brought up in this city, educated at the feet of Gamaliel according to the strict manner of the law of our fathers, being zealous for God as all of you are this day."
        },
        // Verse 4
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐδίωξα", Transliteration = "ediōxa", Gloss = "persecuted", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ἄχρι", Transliteration = "achri", Gloss = "to", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "δεσμεύων", Transliteration = "desmeuōn", Gloss = "binding", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "binding"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "παραδιδοὺς", Transliteration = "paradidous", Gloss = "delivering", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "φυλακὰς", Transliteration = "phylakas", Gloss = "prisons", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "to prisons"
                },
            ...
            Translation = "I persecuted this Way to the death, binding and delivering to prison both men and women,"
        },
        // Verse 5
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "μαρτυρεῖ", Transliteration = "martyrei", Gloss = "testifies", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πρεσβυτέριον", Transliteration = "presbyterion", Gloss = "council of elders", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "all the council of elders"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "δεξάμενος", Transliteration = "dexamenos", Gloss = "having received", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "at Damascus"
                        },
                        new Word { Greek = "ἐπορευόμην", Transliteration = "eporeuomēn", Gloss = "I was going", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PTCP" },
                            Content = new List<object>
                            {
                                new Word { Greek = "ἄξων", Transliteration = "axōn", Gloss = "to bring", GrammarCodes = new List<string> { "V", "FUT", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "those being there bound"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "τιμωρηθῶσιν", Transliteration = "timōrēthōsin", Gloss = "they might be punished", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "that they might be punished"
                        }
                    },
                    Translation = "from whom I received letters to the brothers, and I journeyed toward Damascus to take those also who were there and bring them in bonds to Jerusalem to be punished."
                }
            },
            Translation = "as the high priest and the whole council of elders can bear me witness. From them I received letters to the brothers, and I journeyed toward Damascus to take those also who were there and bring them in bonds to Jerusalem to be punished."
        },
        // Verse 6
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πορευομένῳ", Transliteration = "poreuomenō", Gloss = "as I was journeying", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἐγγίζοντι", Transliteration = "engizonti", Gloss = "drawing near", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "as I was journeying and drawing near to Damascus"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μεσημβρίαν", Transliteration = "mesēmbrian", Gloss = "noon", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "about noon"
                },
                ...
                new Word { Greek = "περιαστράψαι", Transliteration = "periastrapsai", Gloss = "flashed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἱκανὸν", Transliteration = "hikanon", Gloss = "great", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                    },
            ...
            Translation = "As I was on my way and drew near to Damascus, about noon a great light from heaven suddenly shone around me."
        },
        // Verse 7
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἔπεσά", Transliteration = "epesa", Gloss = "I fell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἔδαφος", Transliteration = "edaphos", Gloss = "ground", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                            },
                ...
                new Phrase
                {
                    ...
                    Translation = "Saul, Saul, why are you persecuting me?"
                }
            },
            Translation = "And I fell to the ground and heard a voice saying to me, 'Saul, Saul, why are you persecuting me?'"
        },
        // Verse 8
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀπεκρίθην", Transliteration = "apekrithēn", Gloss = "answered", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    {
                                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "Ναζωραῖος", Transliteration = "Nazōraios", Gloss = "Nazarene", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                                    },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "διώκεις", Transliteration = "diōkeis", Gloss = "persecute", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "whom you are persecuting"
                        }
                    },
                    Translation = "I am Jesus the Nazarene, whom you are persecuting."
                }
            },
            Translation = "And I answered, 'Who are you, Lord?' And he said to me, 'I am Jesus of Nazareth, whom you are persecuting.'"
        }
    };
}
/*
Constructions identified:
- DAT_INSTR: τῇ Ἑβραΐδι διαλέκτῳ (v2) - Dative of instrument/means (language)
- PRED: ἀνὴρ Ἰουδαῖος (v3), Ἰησοῦς ὁ Ναζωραῖος (v8) - Predicate nominative
- PURPOSE_CLAUSE: ἵνα τιμωρηθῶσιν (v5) - Purpose clause with ἵνα + subjunctive
- REL_CLAUSE: παρ᾽ ὧν... (v5), ὃν σὺ διώκεις (v8) - Relative clauses
*/

        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "we saw someone casting out demons in your name"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐκωλύομεν", Transliteration = "ekōlyomen", Gloss = "we tried to hinder", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀκολουθεῖ", Transliteration = "akolouthei", Gloss = "he follows", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "because he does not follow with us"
                }
            },
            Translation = "John answered and said, 'Master, we saw someone casting out demons in your name, and we tried to hinder him, because he does not follow with us.'"
        },
        // Verse 50
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κωλύετε", Transliteration = "kōlyete", Gloss = "do hinder", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    Content = new List<object>
                    ...
                    Translation = "for whoever is not against you"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "But Jesus said to him, 'Do not hinder him, for whoever is not against you is for you.'"
        },
        // Verse 51
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐν", Transliteration = "en", Gloss = "in", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "τῷ", Transliteration = "tō", Gloss = "the", GrammarCodes = new List<string> { "ART", "DAT", "N", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "συμπληροῦσθαι", Transliteration = "symplērousthai", Gloss = "to be fulfilled", GrammarCodes = new List<string> { "V", "PRES", "PASS", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "ἀναλήμψεως", Transliteration = "analēmpseōs", Gloss = "ascension", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "of him", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" }
                                    },
                                    Translation = "of his ascension"
                                }
                            },
                            Translation = "the days of his ascension"
                        }
                    },
                    Translation = "when the days drew near for him to be taken up"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Word { Greek = "ἐστήρισεν", Transliteration = "estērisen", Gloss = "he set firmly", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "When the days drew near for him to be taken up, he set his face to go to Jerusalem."
        },
        // Verse 52
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀγγέλους", Transliteration = "angelous", Gloss = "messengers", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "into a village of the Samaritans"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INF_PHRASE", "PURPOSE_CLAUSE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ὡς", Transliteration = "hōs", Gloss = "to", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἑτοιμάσαι", Transliteration = "hetoimasai", Gloss = "prepare", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "for him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "to make ready for him"
                }
            },
            Translation = "And he sent messengers before him, who went and entered a village of the Samaritans, to make ready for him."
        },
        // Verse 53
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἐδέξαντο", Transliteration = "edexanto", Gloss = "they did receive", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πορευόμενον", Transliteration = "poreuomenon", Gloss = "going", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "N", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "because his face was set toward Jerusalem"
                }
            },
            Translation = "But they did not receive him, because his face was set toward Jerusalem."
        },
        // Verse 54
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the disciples James and John"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "εἴπωμεν", Transliteration = "eipōmen", Gloss = "that we tell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                        ...
                        new Word { Greek = "καταβῆναι", Transliteration = "katabēnai", Gloss = "to come down", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἀναλῶσαι", Transliteration = "analōsai", Gloss = "consume", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτούς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "M", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "for fire to come down from heaven and consume them"
                }
            },
            Translation = "And when his disciples James and John saw it, they said, 'Lord, do you want us to tell fire to come down from heaven and consume them?'"
        },
        // Verse 55
        new Phrase
        {
            ...
            Translation = "But he turned and rebuked them."
        },
        // Verse 56
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "εἰς", Transliteration = "eis", Gloss = "to", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἑτέραν", Transliteration = "heteran", Gloss = "another", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" },
            ...
            Translation = "And they went on to another village."
        }
    };
}
/*
Constructions Identified:
- APPOT (Appositive): Verse 54 (James and John)
- PURPOSE_CLAUSE (with Inf.): Verse 51 (to go), Verse 52 (to prepare), Verse 54 (fire to come down)
- INF_PHRASE (with Art.): Verse 51 (in the [time] of being fulfilled)
*/

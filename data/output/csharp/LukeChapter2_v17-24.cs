private static List<object> GetChapter2()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἰδόντες", Transliteration = "idontes", Gloss = "to see", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "δὲ", Transliteration = "de", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                    },
                    Translation = "And when they saw it"
                },
                new Word { Greek = "ἐγνώρισαν", Transliteration = "egnōrisan", Gloss = "to make known", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τοῦ", Transliteration = "tou", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "N", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "λαληθέντος", Transliteration = "lalēthentos", Gloss = "to speak", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "GEN", "N", "S" }, PartOfSpeech = "v" },
                                new Word { Greek = "αὐτοῖς", Transliteration = "autois", Gloss = "he", GrammarCodes = new List<string> { "PRON", "DAT", "M", "P" }, PartOfSpeech = "prep" },
                            },
                            Translation = "which was told them"
                        }
                    },
                    Translation = "concerning the saying which was told them"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "τοῦ", Transliteration = "τοῦ", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "N", "S" }, PartOfSpeech = "art" },
                    ...
                    Translation = "concerning this child"
                }
            },
            Translation = "And when they saw it, they made known the saying which had been told them concerning this child."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀκούσαντες", Transliteration = "akousantes", Gloss = "to hear", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                    },
                    Translation = "all who heard it"
                },
                new Word { Greek = "ἐθαύμασαν", Transliteration = "ethaumasan", Gloss = "to be amazed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "λαληθέντων", Transliteration = "lalēthentōn", Gloss = "to speak", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "GEN", "N", "P" }, PartOfSpeech = "v" },
                            },
                            Translation = "the things told"
                        }
                    },
                    Translation = "at the things told"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ποιμένων", Transliteration = "poimenōn", Gloss = "shepherd", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "n" },
                            },
                            Translation = "the shepherds"
                        }
                    },
                    Translation = "by the shepherds"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "And all who heard it wondered at what the shepherds told them."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ῥήματα", Transliteration = "rhēmata", Gloss = "word", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                ...
                new Word { Greek = "συνετήρει", Transliteration = "synetērei", Gloss = "to treasure", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "συμβάλλουσα", Transliteration = "symballousa", Gloss = "to ponder", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "F", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "in her heart"
                        }
                    },
                    Translation = "pondering them in her heart"
                }
            },
            Translation = "But Mary treasured up all these things, pondering them in her heart."
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ὑπέστρεψαν", Transliteration = "hypestrepsan", Gloss = "to return", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "δοξάζοντες", Transliteration = "doxazontes", Gloss = "glorifying", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "αἰνοῦντες", Transliteration = "ainountes", Gloss = "praising", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "glorifying and praising God"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "which they had heard and seen"
                                }
                            },
                            Translation = "all they had heard and seen"
                        }
                    },
                    Translation = "for all they had heard and seen"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐλαλήθη", Transliteration = "elalēthē", Gloss = "it was told", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "as it had been told them"
                }
            },
            Translation = "And the shepherds returned, glorifying and praising God for all they had heard and seen, as it had been told them."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τοῦ", Transliteration = "tou", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "N", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "περιτεμεῖν", Transliteration = "peritemein", Gloss = "to circumcise", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                            },
                            Translation = "for circumcising him"
                        }
                    },
                    Translation = "when eight days were fulfilled for circumcising him"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "N", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "κληθὲν", Transliteration = "klēthen", Gloss = "called", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "N", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    {
                                        new Word { Greek = "τοῦ", Transliteration = "tou", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "N", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "συλλημφθῆναι", Transliteration = "syllēmphthēnai", Gloss = "to be conceived", GrammarCodes = new List<string> { "V", "AOR", "PASS", "INF" }, PartOfSpeech = "v" },
                                        new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                                    },
                                    Translation = "his being conceived"
                                },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            {
                                                new Word { Greek = "τῇ", Transliteration = "tē", Gloss = "the", GrammarCodes = new List<string> { "ART", "DAT", "F", "S" }, PartOfSpeech = "art" },
                                                new Word { Greek = "κοιλίᾳ", Transliteration = "koilia", Gloss = "womb", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                                            },
                            ...
                            Translation = "before he was conceived in the womb"
                        }
                    },
                    Translation = "the name given by the angel before he was conceived in the womb"
                }
            },
            Translation = "And when eight days were fulfilled for circumcising him, his name was called Jesus, the name given by the angel before he was conceived in the womb."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "of their purification"
                                }
                            },
                            Translation = "the days of their purification"
                        }
                    },
                    Translation = "when the days of their purification were fulfilled"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "according to the law of Moses"
                },
                new Word { Greek = "ἀνήγαγον", Transliteration = "anēgagon", Gloss = "they brought up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    Translation = "to present him to the Lord"
                }
            },
            Translation = "And when the days for their purification according to the Law of Moses were fulfilled, they brought him up to Jerusalem to present him to the Lord,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "in the Law of the Lord"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "διανοῖγον", Transliteration = "dianoigon", Gloss = "opening", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "N", "S" }, PartOfSpeech = "v" },
                                        new Word { Greek = "μήτραν", Transliteration = "mētran", Gloss = "womb", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                    },
                                    Translation = "who opens the womb"
                                }
                            },
                            Translation = "Every male who opens the womb"
                        },
                    ...
                    Translation = "Every male who opens the womb shall be called holy to the Lord"
                }
            },
            Translation = "as it is written in the Law of the Lord, 'Every male who opens the womb shall be called holy to the Lord'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "εἰρημένον", Transliteration = "eirēmenon", Gloss = "what is said", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "ACC", "N", "S" }, PartOfSpeech = "v" },
                            },
                            Translation = "what is said"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "according to what is said in the Law of the Lord"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ζεῦγος", Transliteration = "zeugos", Gloss = "pair", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "τρυγόνων", Transliteration = "trygonōn", Gloss = "turtledoves", GrammarCodes = new List<string> { "N", "GEN", "F", "P" }, PartOfSpeech = "n" },
                            },
                            Translation = "a pair of turtledoves"
                        },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "νοσσοὺς", Transliteration = "nossous", Gloss = "young pigeons", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" },
                                new Word { Greek = "περιστερῶν", Transliteration = "peristerōn", Gloss = "doves", GrammarCodes = new List<string> { "N", "GEN", "F", "P" }, PartOfSpeech = "n" },
                            },
                            Translation = "two young pigeons"
                        }
                    },
                    Translation = "a pair of turtledoves, or two young pigeons"
                }
            },
            Translation = "and to offer a sacrifice according to what is said in the Law of the Lord, 'a pair of turtledoves, or two young pigeons.'"
        }
    };
}
...
- Articular Infinitive: v21 (τοῦ περιτεμεῖν), v21 (τοῦ συλλημφθῆναι), v24 (τοῦ δοῦναι).
- Relative Clause: v20 (οἷς ἤκουσαν).
- Appositive: v21 (τὸ κληθὲν...).
*/

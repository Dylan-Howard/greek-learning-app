            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "στήκετε", Transliteration = "stēkete", Gloss = "to stand", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PTCP" },
                            Content = new List<object>
                            {
                                new Word { Greek = "προσευχόμενοι", Transliteration = "proseuchomenoi", Gloss = "to pray", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "praying"
                        }
                    },
                    Translation = "whenever you stand praying"
                },
                new Word { Greek = "ἀφίετε", Transliteration = "aphiete", Gloss = "to forgive", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἔχετε", Transliteration = "echete", Gloss = "to have", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "τινος", Transliteration = "tinos", Gloss = "someone", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "part" }
                            },
                            Translation = "against someone"
                        }
                    },
                    Translation = "if you have anything against anyone"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "your Father who is in heaven"
                        },
                    ...
                    Translation = "so that your Father also who is in heaven may forgive you your trespasses"
                }
            },
            Translation = "And whenever you stand praying, forgive, if you have anything against anyone, so that your Father also who is in heaven may forgive you your trespasses."
        },
        // Verse 27
        new Phrase
        {
            ...
            {
                new Word { Greek = "Καὶ", Transliteration = "Kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἔρχονται", Transliteration = "erchontai", Gloss = "to come", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "3P", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "And they came again to Jerusalem."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "περιπατοῦντος", Transliteration = "peripatountos", Gloss = "walking", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "he", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "as he was walking"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    Translation = "the chief priests and the scribes and the elders"
                }
            },
            Translation = "And as he was walking in the temple, the chief priests and the scribes and the elders came to him."
        },
        // Verse 28
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἔλεγον", Transliteration = "elegon", Gloss = "to say", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "to do these things"
                        }
                    },
                    Translation = "or who gave you this authority to do them?"
                }
            },
            Translation = "and they said to him, 'By what authority are you doing these things, or who gave you this authority to do them?'"
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "to say", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτοῖς", Transliteration = "autois", Gloss = "to them", GrammarCodes = new List<string> { "PRON", "DAT", "M", "P" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἐπερωτήσω", Transliteration = "eperōtēsō", Gloss = "to ask", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἀποκρίθητέ", Transliteration = "apokrithēte", Gloss = "to answer", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "μοι", Transliteration = "moi", Gloss = "me", GrammarCodes = new List<string> { "PRON", "DAT", "1P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐρῶ", Transliteration = "erō", Gloss = "to say", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὑμῖν", Transliteration = "hymin", Gloss = "to you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "P" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE", "DAT_INSTR" },
                ...
                new Word { Greek = "ταῦτα", Transliteration = "tauta", Gloss = "these things", GrammarCodes = new List<string> { "PRON", "ACC", "N", "P" }, PartOfSpeech = "adv" },
                new Word { Greek = "ποιῶ", Transliteration = "poiō", Gloss = "to do", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "But Jesus said to them, 'I will ask you one question; answer me, and I will tell you by what authority I do these things.'"
        },
        // Verse 30
        new Phrase
        {
            ...
            Translation = "Was the baptism of John from heaven or from men? Answer me."
        },
        // Verse 31
        new Phrase
        {
            ...
            {
                new Word { Greek = "Καὶ", Transliteration = "Kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "διελογίζοντο", Transliteration = "dielogizonto", Gloss = "to reason", GrammarCodes = new List<string> { "V", "IMPF", "MP", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐπιστεύσατε", Transliteration = "episteusate", Gloss = "to believe", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "And they reasoned with themselves, saying, 'If we say, \"From heaven,\" he will say, \"Why then did you not believe him?\"'"
        },
        // Verse 32
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐφοβοῦντο", Transliteration = "ephobounto", Gloss = "to fear", GrammarCodes = new List<string> { "V", "IMPF", "MP", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἶχον", Transliteration = "eichon", Gloss = "to hold", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that he was a prophet"
                        }
                    },
                    Translation = "for all held John really to be a prophet"
                }
            },
            Translation = "But if we say, 'From men'—they were afraid of the crowd, for they all held John to be truly a prophet."
        }
    };
}
...
- GEN_ABS: Verse 27 (περιπατοῦντος αὐτοῦ)
- DAT_INSTR: Verse 28 (ἐν ποίᾳ ἐξουσίᾳ), Verse 29 (ἐν ποίᾳ ἐξουσίᾳ)
- TSKS: Verse 27 (οἱ ἀρχιερεῖς καὶ οἱ γραμματεῖς καὶ οἱ πρεσβύτεροι - multiple articles, coordinated substantives)
- GEN_DESC: Verse 30 (τὸ Ἰωάννου)
*/

    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "θέλω", Transliteration = "thelō", Gloss = "I do wish", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τοῦτο", Transliteration = "touto", Gloss = "this", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἦτε", Transliteration = "ēte", Gloss = "you might be", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "lest you be wise in your own sight"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πώρωσις", Transliteration = "pōrōsis", Gloss = "a hardening", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "the fullness of the Gentiles"
                                },
                                new Word { Greek = "εἰσέλθῃ", Transliteration = "eiselthē", Gloss = "has come in", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "until the fullness of the Gentiles has come in"
                        }
                    },
                    Translation = "that a partial hardening has happened to Israel, until the fullness of the Gentiles has come in"
                }
            },
            Translation = "For I do not want you to be ignorant, brothers, of this mystery, lest you be wise in your own sight, that a partial hardening has happened to Israel, until the fullness of the Gentiles has come in."
        },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ῥυόμενος", Transliteration = "rhyomenos", Gloss = "rescuing", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "the Deliverer"
                        },
                        new Word { Greek = "ἀποστρέψει", Transliteration = "apostrepsei", Gloss = "he will turn away", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἀσεβείας", Transliteration = "asebeias", Gloss = "ungodliness", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "from Jacob"
                        }
                    },
                    Translation = "as it is written, 'The Deliverer will come out of Zion; he will turn away ungodliness from Jacob'"
                }
            },
            Translation = "And so all Israel will be saved, as it is written: 'The Deliverer will come out of Zion; he will turn away ungodliness from Jacob.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "my covenant with them"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "TEMP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀφέλωμαι", Transliteration = "aphelōmai", Gloss = "I take away", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "when I take away their sins"
                }
            },
            Translation = "And this will be my covenant with them when I take away their sins."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "As regards the gospel"
                },
                new Word { Greek = "ἐχθροὶ", Transliteration = "echthroi", Gloss = "[they are] enemies", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "but as regards election"
                },
                new Word { Greek = "ἀγαπητοὶ", Transliteration = "agapētoi", Gloss = "[they are] beloved", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    ...
                    Translation = "for the sake of their forefathers"
                }
            },
            Translation = "As regards the gospel, they are enemies for your sake. But as regards election, they are beloved for the sake of their forefathers."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἀμεταμέλητα", Transliteration = "ametamelēta", Gloss = "irrevocable", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "P" }, PartOfSpeech = "adj" },
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "χαρίσματα", Transliteration = "charismata", Gloss = "gifts", GrammarCodes = new List<string> { "N", "NOM", "N", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "the gifts"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ἡ", Transliteration = "hē", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "F", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "κλῆσις", Transliteration = "klēsis", Gloss = "calling", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" }
                    },
            ...
            Translation = "For the gifts and the calling of God are irrevocable."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ποτε", Transliteration = "pote", Gloss = "once", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                new Word { Greek = "ἠπειθήσατε", Transliteration = "ēpeithēsate", Gloss = "disobeyed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "IND_OBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "ἠλεήθητε", Transliteration = "ēleēthēte", Gloss = "you have received mercy", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τούτων", Transliteration = "toutōn", Gloss = "of these", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "pron" },
                        new Word { Greek = "ἀπειθείᾳ", Transliteration = "apeitheia", Gloss = "disobedience", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "by their disobedience"
                }
            },
            Translation = "For just as you were at one time disobedient to God but now have received mercy by their disobedience,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "νῦν", Transliteration = "nyn", Gloss = "now", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                new Word { Greek = "ἠπείθησαν", Transliteration = "ēpeithēsan", Gloss = "have been disobedient", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὑμετέρῳ", Transliteration = "hymeterō", Gloss = "your", GrammarCodes = new List<string> { "ADJ", "DAT", "N", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἐλέει", Transliteration = "eleei", Gloss = "mercy", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "to the mercy shown to you"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "νῦν", Transliteration = "nyn", Gloss = "now", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                        new Word { Greek = "ἐλεηθῶσιν", Transliteration = "eleēthōsin", Gloss = "may receive mercy", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "so that they too may now receive mercy"
                }
            },
            Translation = "so they too have now been disobedient in order that by the mercy shown to you they also may now receive mercy."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "συνέκλεισεν", Transliteration = "synekleisen", Gloss = "has consigned", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐλεήσῃ", Transliteration = "eleēsē", Gloss = "he might have mercy", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "that he may have mercy on all"
                }
            },
            Translation = "For God has consigned all to disobedience, that he may have mercy on all."
        }
    };
}
...
- DAT_INSTR: Romans 11:30 (τῇ τούτων ἀπειθείᾳ)
- DAT_REF: Romans 11:31 (τῷ ὑμετέρῳ ἐλέει)
- PURPOSE_CLAUSE: Romans 11:25 (ἵνα μὴ ἦτε...), 11:31 (ἵνα καὶ αὐτοὶ...), 11:32 (ἵνα τοὺς πάντας...)
- CAUSAL_CLAUSE: Romans 11:25 (ὅτι πώρωσις...), 11:26 (καθὼς γέγραπται...)
- TEMP_CLAUSE: Romans 11:25 (ἄχρι οὗ...), 11:27 (ὅταν ἀφέλωμαι...)
*/

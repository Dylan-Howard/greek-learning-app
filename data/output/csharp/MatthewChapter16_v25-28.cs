private static List<object> GetChapter16()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "θέλῃ", Transliteration = "thelē", Gloss = "would desire", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "For whoever would save his life"
                },
            ...
            Translation = "For whoever would save his life will lose it,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀπολέσῃ", Transliteration = "apolesē", Gloss = "should lose", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "but whoever loses his life for my sake"
                },
            ...
            Translation = "but whoever loses his life for my sake will find it."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ὠφεληθήσεται", Transliteration = "ōphelēthēsetai", Gloss = "will be profited", GrammarCodes = new List<string> { "V", "FUT", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κερδήσῃ", Transliteration = "kerdēsē", Gloss = "he might gain", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "if he gains the whole world"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "COND_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ψυχὴν", Transliteration = "psychēn", Gloss = "life", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "his", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ζημιωθῇ", Transliteration = "zēmiōthē", Gloss = "he might forfeit", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "but forfeits his life"
                }
            },
            Translation = "For what will it profit a man if he gains the whole world and forfeits his soul?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἄνθρωπος", Transliteration = "anthrōpos", Gloss = "a man", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                new Word { Greek = "ἀντάλλαγμα", Transliteration = "antallagma", Gloss = "as an exchange", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
            ...
            Translation = "Or what shall a man give in return for his soul?"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "with his angels"
                }
            },
            Translation = "For the Son of Man is going to come in the glory of his Father with his angels,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀποδώσει", Transliteration = "apodōsei", Gloss = "he will repay", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "πρᾶξιν", Transliteration = "praxin", Gloss = "deed", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "his", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "his deed"
                        }
                    },
                    Translation = "according to his deed"
                }
            },
            Translation = "and then he will repay each person according to what he has done."
        },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἑστώτων", Transliteration = "hestōtōn", Gloss = "standing", GrammarCodes = new List<string> { "V", "PERF", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" }
                            },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "who will not taste death"
                        },
                        new Phrase
                        {
                            ...
                            Translation = "until they see the Son of Man coming in his kingdom"
                        }
                    },
                    Translation = "that there are some standing here who will not taste death until they see the Son of Man coming in his kingdom"
                }
            },
            Translation = "Truly, I say to you, there are some standing here who will not taste death until they see the Son of Man coming in his kingdom."
        }
    };
}

// Identified Constructions:
// - Conditional Relative Clause (ὃς ἐὰν/ἂν + subjunctive): 16:25 (twice)
// - Objective Genitive (τῆς ψυχῆς αὐτοῦ): 16:26
// - Emphatic Negation (οὐ μὴ + subjunctive): 16:28
// - Temporal Clause (ἕως ἂν + subjunctive): 16:28
// - Participle used substantivally (τῶν ἑστώτων): 16:28
// - Predicative Participle (ἐρχόμενον): 16:28

private static List<object> GetChapter9()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "If this man were not from God"
                },
            ...
            Translation = "If this man were not from God, he could do nothing."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἀπεκρίθησαν", Transliteration = "apekrithēsan", Gloss = "they answered", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐγεννήθης", Transliteration = "egennēthēs", Gloss = "were born", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "2P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "ὅλος", Transliteration = "holos", Gloss = "altogether", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "You were born altogether in sins"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Translation = "and do you teach us?"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "They answered and said to him, \"You were born altogether in sins, and do you teach us?\" And they cast him out."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐξέβαλον", Transliteration = "exebalon", Gloss = "they had cast out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἔξω", Transliteration = "exō", Gloss = "out", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
                    },
                    Translation = "that they had cast him out"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "σὺ", Transliteration = "sy", Gloss = "you", GrammarCodes = new List<string> { "PRON", "NOM", "2P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "πιστεύεις", Transliteration = "pisteueis", Gloss = "do believe", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "in the Son of Man"
                        }
                    },
                    Translation = "Do you believe in the Son of Man?"
                }
            },
            Translation = "Jesus heard that they had cast him out, and having found him, he said, \"Do you believe in the Son of Man?\""
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πιστεύσω", Transliteration = "pisteusō", Gloss = "I may believe", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "that I may believe in him"
                }
            },
            Translation = "He answered and said, \"And who is he, Lord, that I may believe in him?\""
        },
        ...
        new Phrase
        {
            ...
            Translation = "Jesus said to him, \"You have seen him, and the one speaking with you is he.\""
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "I believe, Lord"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "προσεκύνησεν", Transliteration = "prosekynēsen", Gloss = "he worshiped", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" }
            },
            Translation = "He said, \"Lord, I believe,\" and he worshiped him."
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "those who do not see"
                        },
                    ...
                    Translation = "that those who do not see may see, and those who see may become blind"
                }
            },
            Translation = "Jesus said, \"For judgment I came into this world, that those who do not see may see, and those who see may become blind.\""
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "those being with him"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τυφλοί", Transliteration = "typhloi", Gloss = "blind", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἐσμεν", Transliteration = "esmen", Gloss = "are", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "Are we also blind?"
                }
            },
            Translation = "Some of the Pharisees who were with him heard these things and said to him, \"Are we also blind?\""
        }
    };
}
// Constructions identified:
// 9:35 - Substantival Articular Participle (τὸν υἱὸν τοῦ ἀνθρώπου)
// 9:37 - Articular Participle as Subject (ὁ λαλῶν)
// 9:39 - Articular Participles as Subjects (οἱ μὴ βλέποντες, οἱ βλέποντες)
// 9:40 - Articular Participle with Prepositional Phrase (οἱ μετ’ αὐτοῦ ὄντες)

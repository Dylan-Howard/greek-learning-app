private static List<object> GetChapter12()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "Ἔγνω", Transliteration = "Egnō", Gloss = "learned", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐστιν", Transliteration = "estin", Gloss = "he was", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "that he was there"
                }
            },
            Translation = "The large crowd of the Jews therefore learned that he was there;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "not only because of Jesus"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὸν", Transliteration = "ton", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "Λάζαρον", Transliteration = "Lazaron", Gloss = "Lazarus", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "Lazarus"
                        },
                        new Word { Greek = "ἴδωσιν", Transliteration = "idōsin", Gloss = "they might see", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "but so that they might also see Lazarus"
                },
                new Phrase
                {
            ...
            Translation = "and they came, not only for Jesus’ sake, but also that they might see Lazarus, whom he had raised from the dead."
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἐβουλεύσαντο", Transliteration = "ebouleusanto", Gloss = "planned", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "to kill Lazarus also"
                }
            },
            Translation = "So the chief priests made plans to kill Lazarus also,"
        },
        // Verse 11
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ὑπῆγον", Transliteration = "hypēgon", Gloss = "were going away", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐπίστευον", Transliteration = "episteuon", Gloss = "were believing", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "because on account of him many of the Jews were going away and believing in Jesus."
        },
        // Verse 12
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that had come to the feast"
                        }
                    },
                    Translation = "the large crowd"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that Jesus was coming to Jerusalem"
                        }
                    },
                    Translation = "heard that Jesus was coming to Jerusalem"
                },
                // (continues verse 12)
                // Verse 13
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "βαΐα", Transliteration = "baïa", Gloss = "branches", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "GEN_DESC" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "φοινίκων", Transliteration = "phoinikōn", Gloss = "palms", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "of the palm trees"
                        }
                    },
                    Translation = "the branches of palm trees"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "εἰς", Transliteration = "eis", Gloss = "to", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ὑπάντησιν", Transliteration = "hypantēsin", Gloss = "a meeting", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐκραύγαζον", Transliteration = "ekraugazon", Gloss = "were crying out", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "ὡσαννά", Transliteration = "hōsanna", Gloss = "Hosanna!", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "ἐρχόμενος", Transliteration = "erchomenos", Gloss = "one coming", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "he who comes"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    Translation = "even the King of Israel!"
                }
            },
            Translation = "The next day the large crowd that had come to the feast heard that Jesus was coming to Jerusalem. So they took branches of palm trees and went out to meet him, crying out, “Hosanna! Blessed is he who comes in the name of the Lord, even the King of Israel!”"
        },
        // Verse 14
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὀνάριον", Transliteration = "onarion", Gloss = "a young donkey", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "And Jesus, having found a young donkey,"
                },
                new Word { Greek = "ἐκάθισεν", Transliteration = "ekathisen", Gloss = "sat", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "And Jesus found a young donkey and sat on it, just as it is written,"
        },
        // Verse 15
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Σιών", Transliteration = "Siōn", Gloss = "of Zion", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "daughter of Zion"
                }
            },
            Translation = "“Fear not, daughter of Zion;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "βασιλεύς", Transliteration = "basileus", Gloss = "King", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "σου", Transliteration = "sou", Gloss = "of you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "your King"
                },
                new Word { Greek = "ἔρχεται", Transliteration = "erchetai", Gloss = "is coming", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "καθήμενος", Transliteration = "kathēmenos", Gloss = "sitting", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "ὄνου", Transliteration = "onou", Gloss = "of a donkey", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "a donkey's colt"
                                }
                            },
                            Translation = "on a donkey's colt"
                        }
                    },
                    Translation = "sitting on a donkey's colt"
                }
            },
            Translation = "behold, your king is coming, sitting on a donkey’s colt!”"
        },
        // Verse 16
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔγνωσαν", Transliteration = "egnōsan", Gloss = "understood", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "His disciples did not understand these things at first,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "when Jesus was glorified"
                },
                new Word { Greek = "τότε", Transliteration = "tote", Gloss = "then", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἐμνήσθησαν", Transliteration = "emnēsthēsan", Gloss = "they remembered", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἐπ᾽", Transliteration = "ep'", Gloss = "about", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        ...
                        new Word { Greek = "γεγραμμένα", Transliteration = "gegrammena", Gloss = "written", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "N", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "that these things had been written about him"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Translation = "and they had done these things to him"
                }
            },
            Translation = "but when Jesus was glorified, then they remembered that these things had been written about him and had been done to him."
        }
    };
}
...
- PERIPH (Periphrastic Pluperfect/Imperfect Passive): v16 (ἦν ... γεγραμμένα)
- APPOS (Appositive): v13 (ὁ βασιλεὺς τοῦ Ἰσραήλ)
- VOC (Vocative): v15 (θυγάτηρ Σιών)
- PTCP (Attributive/Adjectival Participle): v12 (ὁ ἐλθὼν), v13 (ὁ ἐρχόμενος)
- PTCP (Circumstantial/Adverbial Participle): v12 (ἀκούσαντες), v14 (εὑρὼν), v15 (καθήμενος)
*/

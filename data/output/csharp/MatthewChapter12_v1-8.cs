                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the grainfields"
                        }
                    },
                    Translation = "through the grainfields"
                }
            },
            Translation = "At that time Jesus went through the grainfields on the Sabbath."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "but his disciples"
                },
                new Word { Greek = "ἐπείνασαν", Transliteration = "epeinasan", Gloss = "were hungry", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "τίλλειν", Transliteration = "tillein", Gloss = "to pick", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                    ...
                    Translation = "to pick heads of grain"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐσθίειν", Transliteration = "esthiein", Gloss = "to eat", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" }
            },
            Translation = "His disciples were hungry, and they began to pluck heads of grain and to eat."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ποιοῦσιν", Transliteration = "poiousin", Gloss = "are doing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "to do on the Sabbath"
                                }
                            },
                            Translation = "what is not lawful to do on the Sabbath"
                        }
                    },
                    Translation = "Look, your disciples are doing what is not lawful to do on the Sabbath."
                }
            },
            Translation = "But when the Pharisees saw it, they said to him, 'Look, your disciples are doing what is not lawful to do on the Sabbath.'"
        },
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                new Word { Greek = "οἱ", Transliteration = "hoi", Gloss = "the (ones)", GrammarCodes = new List<string> { "ART", "NOM

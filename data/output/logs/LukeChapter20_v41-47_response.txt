    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "λέγουσιν", Transliteration = "legousin", Gloss = "do they say", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "Δαυὶδ", Transliteration = "Dauid", Gloss = "David's", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "υἱόν", Transliteration = "huion", Gloss = "son", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "David's son"
                }
            },
            Translation = "But He said to them, \"How do they say that the Christ is David's son?\""
        },
        // Verse 42
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ψαλμῶν", Transliteration = "psalmōn", Gloss = "of Psalms", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "in the book of Psalms"
                },
                ...
                new Word { Greek = "κάθου", Transliteration = "kathou", Gloss = "Sit", GrammarCodes = new List<string> { "V", "PRES", "MID", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "For David himself says in the book of Psalms, 'The Lord said to my Lord, \"Sit at my right hand,\""
        },
        // Verse 43
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "θῶ", Transliteration = "thō", Gloss = "I make", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ὑποπόδιον", Transliteration = "hypopodion", Gloss = "a footstool", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "καλεῖ", Transliteration = "kalei", Gloss = "calls", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "ἐστιν", Transliteration = "estin", Gloss = "is he", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "David therefore calls him Lord, so how is he his son?\""
        },
        // Verse 45
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "Ἀκούοντος", Transliteration = "Akouontos", Gloss = "while hearing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "And while all the people were listening"
                },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "He said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "And while all the people were listening, He said to his disciples,"
        },
        // Verse 46
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "θελόντων", Transliteration = "thelontōn", Gloss = "desire", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    {
                                        new Word { Greek = "ἐν", Transliteration = "en", Gloss = "in", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                                        new Word { Greek = "στολαῖς", Transliteration = "stolais", Gloss = "long robes", GrammarCodes = new List<string> { "N", "DAT", "F", "P" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "in long robes"
                                }
                            },
                            Translation = "to walk in long robes"
                        }
                    },
                    Translation = "who desire to walk in long robes"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "φιλούντων", Transliteration = "philountōn", Gloss = "love", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" },
                    ...
                    Translation = "and love greetings in the marketplaces"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Translation = "and best seats in the synagogues"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πρωτοκλισίας", Transliteration = "prōtoklisias", Gloss = "places of honor", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "δείπνοις", Transliteration = "deipnois", Gloss = "banquets", GrammarCodes = new List<string> { "N", "DAT", "N", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "at the banquets"
                        }
                    },
                    Translation = "and places of honor at the banquets"
                }
            },
            Translation = "Beware of the scribes, who desire to walk in long robes and love greetings in the marketplaces and the best seats in the synagogues and the places of honor at the banquets,"
        },
        // Verse 47
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κατεσθίουσιν", Transliteration = "katesthiousin", Gloss = "devour", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "οἰκίας", Transliteration = "oikias", Gloss = "houses", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "χηρῶν", Transliteration = "chērōn", Gloss = "widows", GrammarCodes = new List<string> { "ADJ", "GEN", "F", "P" }, PartOfSpeech = "adj" }
                            },
                            Translation = "of the widows"
                        }
                    },
                    Translation = "the houses of the widows"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "προφάσει", Transliteration = "prophasei", Gloss = "as a pretense", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                new Word { Greek = "μακρὰ", Transliteration = "makra", Gloss = "lengthy prayers", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" },
                new Word { Greek = "προσεύχονται", Transliteration = "proseuchontai", Gloss = "make", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "who devour widows' houses and for a pretense make long prayers."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "λήμψονται", Transliteration = "lēmpsontai", Gloss = "will receive", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "περισσότερον", Transliteration = "perissoteron", Gloss = "greater", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "κρίμα", Transliteration = "krima", Gloss = "judgment", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "greater judgment"
                }
            },
            Translation = "These will receive greater judgment."
        }
    };
}
...
- GEN_ABS: Verse 45 (Ἀκούοντος δὲ παντὸς τοῦ λαοῦ)
- REL_CLAUSE: Verse 47 (οἳ κατεσθίουσιν...)
- INF_PHRASE: Verse 46 (περιπατεῖν ἐν στολαῖς)
*/

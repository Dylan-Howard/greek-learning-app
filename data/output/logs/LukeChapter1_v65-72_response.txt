private static List<object> GetChapter1()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "περιοικοῦντας", Transliteration = "perioikountas", Gloss = "living around", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" },
                                new Word { Greek = "αὐτούς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "M", "P" }, PartOfSpeech = "pron" }
                            },
                            Translation = "all those living around them"
                        }
                    },
                    Translation = "upon all those living around them"
                },
                new Phrase
                {
            ...
            Translation = "And fear came upon all those living around them,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ὀρεινῇ", Transliteration = "oreinē", Gloss = "hill country", GrammarCodes = new List<string> { "ADJ", "DAT", "F", "S" }, PartOfSpeech = "adj" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "all the hill country of Judea"
                        }
                    },
                    Translation = "in all the hill country of Judea"
                },
                new Word { Greek = "διελαλεῖτο", Transliteration = "dielaleito", Gloss = "were being talked about", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ῥήματα", Transliteration = "rhēmata", Gloss = "things", GrammarCodes = new List<string> { "N", "NOM", "N", "P" }, PartOfSpeech = "n" },
            ...
            Translation = "and in all the hill country of Judea all these things were being talked about."
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἔθεντο", Transliteration = "ethento", Gloss = "laid up", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "And all who heard laid them up in their heart, saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "\"What then will this child be?\""
        },
        new Phrase
        {
            ...
            Translation = "For the hand of the Lord was with him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "Zechariah his father"
                },
            ...
            Translation = "And his father Zechariah was filled with the Holy Spirit"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "and prophesied, saying,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the Lord God of Israel"
                }
            },
            Translation = "Blessed be the Lord God of Israel,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐπεσκέψατο", Transliteration = "epeskepsato", Gloss = "he has visited", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐποίησεν", Transliteration = "epoiēsen", Gloss = "accomplished", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "λύτρωσιν", Transliteration = "lytrōsin", Gloss = "redemption", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
            ...
            Translation = "because he has visited and accomplished redemption for his people,"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἤγειρεν", Transliteration = "ēgeiren", Gloss = "has raised up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "κέρας", Transliteration = "keras", Gloss = "a horn", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                    ...
                    Translation = "a horn of salvation"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "οἴκῳ", Transliteration = "oikō", Gloss = "the house", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "the house of David his servant"
                        }
                    },
                    Translation = "in the house of David his servant"
                }
            },
            Translation = "and has raised up a horn of salvation for us in the house of David his servant,"
        },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                ...
                                                new Word { Greek = "αἰῶνος", Transliteration = "aiōnos", Gloss = "old", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                                            },
                                    ...
                                    Translation = "of his holy prophets from of old"
                                }
                            },
                            Translation = "the mouth of his holy prophets from of old"
                        }
                    },
                    Translation = "through the mouth of his holy prophets from of old,"
                }
            },
            Translation = "just as he spoke through the mouth of his holy prophets from of old,"
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἐχθρῶν", Transliteration = "echthrōn", Gloss = "enemies", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "P" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "χειρὸς", Transliteration = "cheiros", Gloss = "the hand", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "μισούντων", Transliteration = "misountōn", Gloss = "hating", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" },
                                        new Word { Greek = "ἡμᾶς", Transliteration = "hēmas", Gloss = "us", GrammarCodes = new List<string> { "PRON", "ACC", "1P", "P" }, PartOfSpeech = "pron" }
                                    },
                                    Translation = "of all those who hate us"
                                }
                            },
                            Translation = "the hand of all those who hate us"
                        }
                    },
                    Translation = "from the hand of all those who hate us"
                }
            },
            Translation = "salvation from our enemies and from the hand of all those who hate us,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ποιῆσαι", Transliteration = "poiēsai", Gloss = "to show", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
            ...
            Translation = "to show mercy with our fathers"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INF_PHRASE", "PURPOSE_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἁγίας", Transliteration = "hagias", Gloss = "holy", GrammarCodes = new List<string> { "ADJ", "GEN", "F", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "his", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "pron" }
                    },
                    Translation = "his holy covenant"
                }
            },
            Translation = "and to remember his holy covenant,"
        }
    };
}
...
- Luke 1:65: NOUN_PHRASE SUBJ ("φόβος")
- Luke 1:66: PTCP ("λέγοντες"), NOUN_PHRASE SUBJ ("πάντες οἱ ἀκούσαντες")
- Luke 1:66: PRED ("τί ... ἔσται")
- Luke 1:67: APPOS ("ὁ πατὴρ αὐτοῦ")
- Luke 1:68: PRED ("Εὐλογητὸς κύριος")
- Luke 1:68: APPOS ("ὁ θεὸς τοῦ Ἰσραήλ")
- Luke 1:69: GEN_DESC ("σωτηρίας")
- Luke 1:71: APPOS ("σωτηρίαν ...")
- Luke 1:72: INF_PHRASE ("ποιῆσαι ...", "μνησθῆναι ...")
*/

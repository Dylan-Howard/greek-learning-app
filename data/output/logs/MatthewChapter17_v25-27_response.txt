        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐλθόντα", Transliteration = "elthonta", Gloss = "having come", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "when he came into the house"
                },
                new Word { Greek = "προέφθασεν", Transliteration = "proephthasen", Gloss = "anticipated", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "And when he came into the house, Jesus anticipated him, saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "Σίμων", Transliteration = "Simōn", Gloss = "Simon", GrammarCodes = new List<string> { "N", "VOC", "M", "S" }, PartOfSpeech = "n" }
            },
            Translation = "What do you think, Simon?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τίνων", Transliteration = "tinōn", Gloss = "whom?", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "interj" }
                    },
                    Translation = "from whom"
                },
                new Word { Greek = "λαμβάνουσιν", Transliteration = "lambanousin", Gloss = "do they take", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "τέλη", Transliteration = "telē", Gloss = "toll", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                ...
                new Phrase
                {
                    ...
                    Translation = "from strangers"
                }
            },
            Translation = "From whom do the kings of the earth take toll or tax? From their sons or from strangers?"
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "εἰπόντος", Transliteration = "eipontos", Gloss = "having said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" }
                    },
            ...
            Translation = "And when he said, 'From strangers,' Jesus said to him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐλεύθεροί", Transliteration = "eleutheroi", Gloss = "free", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" },
            ...
            Translation = "Then the sons are free."
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "σκανδαλίσωμεν", Transliteration = "skandalisōmen", Gloss = "we might offend", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτούς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "M", "P" }, PartOfSpeech = "prep" }
            },
            Translation = "But so that we may not offend them,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "go to the sea"
                },
                new Word { Greek = "βάλε", Transliteration = "bale", Gloss = "throw", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἄγκιστρον", Transliteration = "ankistron", Gloss = "hook", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀναβάντα", Transliteration = "anabanta", Gloss = "coming up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "πρῶτον", Transliteration = "prōton", Gloss = "first", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἰχθὺν", Transliteration = "ichthyn", Gloss = "fish", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the fish that comes up first"
                },
                new Word { Greek = "ἆρον", Transliteration = "aron", Gloss = "take", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "go to the sea and cast a hook and take the first fish that comes up,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "when you open its mouth"
                },
                new Word { Greek = "εὑρήσεις", Transliteration = "heurēseis", Gloss = "you will find", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "στατῆρα", Transliteration = "statēra", Gloss = "a shekel", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                new Word { Greek = "ἐκεῖνον", Transliteration = "ekeinon", Gloss = "that", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "adv" }
            },
            Translation = "and when you open its mouth, you will find a shekel."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "for me and yourself"
                }
            },
            Translation = "take that and give it to them for me and yourself."
        }
    };
}
...
- GEN_ABS: Verse 26 (εἰπόντος δέ) - Though technically Matthew 17:26 starts with a Genitive Absolute to set the scene.
- PURPOSE_CLAUSE: Verse 27 (ἵνα δὲ μὴ σκανδαλίσωμεν αὐτούς)
*/

private static List<object> GetChapter3()
{
    ...
    return new List<object>
    {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κρίνῃ", Transliteration = "krinē", Gloss = "he might judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "that he might judge the world"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "but that the world might be saved through him"
                }
            },
            Translation = "For God did not send the Son into the world that he might judge the world, but that the world might be saved through him."
        },
        ...
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "believing in him"
                        }
                    },
                    Translation = "The one who believes in him"
                },
            ...
            Translation = "Whoever believes in him is not judged,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "but the one not believing"
                },
                new Word { Greek = "ἤδη", Transliteration = "ēdē", Gloss = "already", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "κέκριται", Transliteration = "kekritai", Gloss = "has been judged", GrammarCodes = new List<string> { "V", "PERF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                        new Word { Greek = "πεπίστευκεν", Transliteration = "pepisteuken", Gloss = "he has believed", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "μονογενοῦς", Transliteration = "monogenous", Gloss = "only", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "S" }, PartOfSpeech = "adj" },
                                    ...
                                    Translation = "of the only Son"
                                }
                            },
                            Translation = "in the name of the only Son of God"
                        }
                    },
                    Translation = "because he has not believed in the name of the only Son of God"
                }
            },
            Translation = "but whoever does not believe has been judged already, because he has not believed in the name of the only Son of God."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐλήλυθεν", Transliteration = "elēlythen", Gloss = "has come", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Word { Greek = "ἠγάπησαν", Transliteration = "ēgapēsan", Gloss = "loved", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                    ...
                    Translation = "that the light has come into the world, and men loved the darkness rather than the light"
                }
            },
            Translation = "And this is the judgment: that the light has come into the world, and men loved the darkness rather than the light,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
            ...
            Translation = "for their works were evil."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πᾶς", Transliteration = "pas", Gloss = "every [one]", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the [one]", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "φαῦλα", Transliteration = "phaula", Gloss = "evil things", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" },
                                new Word { Greek = "πράσσων", Transliteration = "prassōn", Gloss = "doing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "doing evil things"
                        }
                    },
                    Translation = "For everyone doing evil"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἐλεγχθῇ", Transliteration = "elenchthē", Gloss = "might be exposed", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                    ...
                    Translation = "lest his works should be exposed"
                }
            },
            Translation = "For everyone who does evil hates the light and does not come to the light, lest his works should be exposed."
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "doing the truth"
                        }
                    },
                    Translation = "But the one who does the truth"
                },
                new Word { Greek = "ἔρχεται", Transliteration = "erchetai", Gloss = "comes", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "εἰργασμένα", Transliteration = "eirgasmena", Gloss = "having been worked", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "N", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "that they have been worked in God"
                        }
                    },
                    Translation = "so that his works may be clearly seen, that they have been worked in God"
                }
            },
            Translation = "But whoever does what is true comes to the light, so that it may be clearly seen that his works have been carried out in God."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "Ἰουδαίαν", Transliteration = "Ioudaian", Gloss = "Judean", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "γῆν", Transliteration = "gēn", Gloss = "land", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "the Judean land"
                        }
                    },
                    Translation = "into the Judean land"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐβάπτιζεν", Transliteration = "ebaptizen", Gloss = "was baptizing", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "After this, Jesus and his disciples went into the Judean countryside, and he remained there with them and was baptizing."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ἐν", Transliteration = "en", Gloss = "in", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "Αἰνὼν", Transliteration = "Ainōn", Gloss = "Aenon", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "in Aenon"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "Σαλείμ", Transliteration = "Saleim", Gloss = "Salim", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "Salim"
                        }
                    },
                    Translation = "near Salim"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὕδατα", Transliteration = "hydata", Gloss = "waters", GrammarCodes = new List<string> { "N", "NOM", "N", "P" }, PartOfSpeech = "n" },
                    ...
                    Translation = "because there was much water there"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "παρεγίνοντο", Transliteration = "pareginonto", Gloss = "they were coming", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "John also was baptizing at Aenon near Salim, because there was much water there, and people were coming and being baptized."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἦν", Transliteration = "ēn", Gloss = "was", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "βεβλημένος", Transliteration = "beblēmenos", Gloss = "having been thrown", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "For John had not yet been thrown into prison."
        }
    };
}
...
- PERIPH (Periphrastic): v21 (ἐστιν εἰργασμένα), v24 (ἦν βεβλημένος)
- CAUSAL_CLAUSE: v18 (ὅτι μὴ πεπίστευκεν...), v19 (ἦν γὰρ αὐτῶν πονηρὰ...), v23 (ὅτι ὕδατα πολλὰ ἦν...)
- PURPOSE_CLAUSE: v17 (ἵνα κρίνῃ..., ἵνα σωθῇ...), v20 (ἵνα μὴ ἐλεγχθῇ...), v21 (ἵνα φανερωθῇ...)
*/

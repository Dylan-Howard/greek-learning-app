private static List<object> GetChapter6()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Translation = "Your fathers ate the manna in the wilderness and died."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καταβαίνων", Transliteration = "katabainōn", Gloss = "comes down", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "that comes down from heaven"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "φάγῃ", Transliteration = "phagē", Gloss = "may eat", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἀποθάνῃ", Transliteration = "apothanē", Gloss = "die", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "so that one may eat of it and not die"
                }
            },
            Translation = "This is the bread that comes down from heaven, so that one may eat of it and not die."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καταβάς", Transliteration = "katabas", Gloss = "came down", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "having come down from heaven"
                }
            },
            Translation = "I am the living bread that came down from heaven."
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "τις", Transliteration = "tis", Gloss = "anyone", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "part" },
                new Word { Greek = "φάγῃ", Transliteration = "phagē", Gloss = "eats", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    ...
                    Translation = "of this bread"
                },
                new Word { Greek = "ζήσει", Transliteration = "zēsei", Gloss = "he will live", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "If anyone eats of this bread, he will live forever."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the life of the world"
                        }
                    },
                    Translation = "for the life of the world"
                }
            },
            Translation = "And the bread that I will give for the life of the world is my flesh."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "Ἐμάχοντο", Transliteration = "emachonto", Gloss = "argued", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "How is this man able to give us his flesh to eat?"
                }
            },
            Translation = "The Jews then argued with one another, saying, 'How can this man give us his flesh to eat?'"
        },
        ...
        new Phrase
        {
            ...
            Translation = "So Jesus said to them,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                        new Word { Greek = "φάγητε", Transliteration = "phagēte", Gloss = "you eat", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "of the Son of Man"
                                }
                            },
                            Translation = "the flesh of the Son of Man"
                        },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "πίητε", Transliteration = "piēte", Gloss = "you drink", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                    ...
                    Translation = "Unless you eat the flesh of the Son of Man and drink his blood"
                },
            ...
            Translation = "Truly, truly, I say to you, unless you eat the flesh of the Son of Man and drink his blood, you have no life in you."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "The one who feeds on my flesh and drinks my blood"
                },
                ...
                new Word { Greek = "ἀναστήσω", Transliteration = "anastēsō", Gloss = "will raise up", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "Whoever feeds on my flesh and drinks my blood has eternal life, and I will raise him up on the last day."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐστιν", Transliteration = "estin", Gloss = "is", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "βρῶσις", Transliteration = "brōsis", Gloss = "food", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "αἷμά", Transliteration = "haima", Gloss = "blood", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "μου", Transliteration = "mou", Gloss = "my", GrammarCodes = new List<string> { "PRON", "GEN", "1P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "my blood"
                },
                new Word { Greek = "ἀληθής", Transliteration = "alēthēs", Gloss = "true", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἐστιν", Transliteration = "estin", Gloss = "is", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "πόσις", Transliteration = "posis", Gloss = "drink", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" }
            },
            Translation = "For my flesh is true food, and my blood is true drink."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "Whoever feeds on my flesh and drinks my blood"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "Whoever feeds on my flesh and drinks my blood abides in me, and I in him."
        }
    };
}
...
- COND_CLAUSE: Verses 51, 53
- PURPOSE_CLAUSE: Verse 50
- REL_CLAUSE: Verse 51
- NOUN_PHRASE (SUBJ/OBJ/PRED): Throughout
- PTCP (attributive/substantival): Verses 50, 51, 52, 54, 56
*/

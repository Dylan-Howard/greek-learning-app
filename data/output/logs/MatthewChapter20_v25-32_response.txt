                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "the rulers of the Gentiles"
                                },
                            ...
                            Translation = "that the rulers of the Gentiles lord it over them and the great ones exercise authority over them"
                        }
                    },
                    Translation = "You know that the rulers of the Gentiles lord it over them, and the great ones exercise authority over them."
                }
            },
            Translation = "But Jesus called them to him and said, 'You know that the rulers of the Gentiles lord it over them, and their great ones exercise authority over them.'"
        },
        // Verse 26
        new Phrase
        {
            ...
            Translation = "It shall not be so among you. But whoever would be great among you must be your servant,"
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "and whoever would be first among you"
                },
                new Word { Greek = "ἔσται", Transliteration = "estai", Gloss = "shall be", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "and whoever would be first among you must be your slave,"
        },
        // Verse 28
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "even as the Son of Man came not"
                },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "λύτρον", Transliteration = "lytron", Gloss = "as a ransom", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "to give his life as a ransom for many"
                }
            },
            Translation = "even as the Son of Man came not to be served but to serve, and to give his life as a ransom for many."
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐκπορευομένων", Transliteration = "ekporeuomenōn", Gloss = "going out", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "And as they went out from Jericho, a great crowd followed him."
        },
        // Verse 30
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τυφλοὶ", Transliteration = "typhloi", Gloss = "blind men", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "two blind men"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    ...
                    Translation = "sitting by the roadside"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "Ἰησοῦς", Transliteration = "Iēsous", Gloss = "Jesus", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "παράγει", Transliteration = "paragei", Gloss = "is passing by", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "that Jesus was passing by"
                        }
                    },
                    Translation = "when they heard that Jesus was passing by"
                },
                new Word { Greek = "ἔκραξαν", Transliteration = "ekraxan", Gloss = "cried out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐλέησον", Transliteration = "eleēson", Gloss = "have mercy on", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "Have mercy on us, Lord, Son of David!"
                }
            },
            Translation = "And behold, there were two blind men sitting by the roadside, and when they heard that Jesus was passing by, they cried out, 'Lord, have mercy on us, Son of David!'"
        },
        // Verse 31
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σιωπήσωσιν", Transliteration = "siōpēsōsin", Gloss = "they should be silent", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "telling them to be silent"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δὲ", Transliteration = "de", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "μεῖζον", Transliteration = "meizon", Gloss = "all the more", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adv" },
                        new Word { Greek = "ἔκραξαν", Transliteration = "ekraxan", Gloss = "cried out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PTCP" },
                    ...
                    Translation = "but they cried out all the more, 'Lord, have mercy on us, Son of David!'"
                }
            },
            Translation = "The crowd rebuked them, telling them to be silent, but they cried out all the more, 'Lord, have mercy on us, Son of David!'"
        },
        // Verse 32
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "στὰς", Transliteration = "stas", Gloss = "stopping", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "ἐφώνησεν", Transliteration = "ephōnēsen", Gloss = "called", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτοὺς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "M", "P" }, PartOfSpeech = "pron" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "θέλετε", Transliteration = "thelete", Gloss = "do you want", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                    ...
                    Translation = "What do you want me to do for you?"
                }
            },
            Translation = "And stopping, Jesus called them and said, 'What do you want me to do for you?'"
        }
    };
}

// Identified Constructions:
// GEN_ABS: Verse 29 (ἐκπορευομένων αὐτῶν)
// NOUN_PHRASE/VOC: Verse 30, 31 (υἱὸς Δαυίδ)
// PURPOSE_CLAUSE: Verse 31 (ἵνα σιωπήσωσιν)
// CAUSAL_CLAUSE: Verse 25 (ὅτι ...), Verse 30 (ὅτι ...)

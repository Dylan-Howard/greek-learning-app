private static List<object> GetChapter13()
{
    ...
    return new List<object>
    {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀσθενῶμεν", Transliteration = "asthenōmen", Gloss = "may be weak", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "whenever we are weak"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δυνατοὶ", Transliteration = "dynatoi", Gloss = "strong", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "P" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ἦτε", Transliteration = "ēte", Gloss = "may be", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "but you may be strong"
                }
            },
            Translation = "For we rejoice whenever we are weak but you are strong."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "εὐχόμεθα", Transliteration = "euchometha", Gloss = "we pray for", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "1P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὑμῶν", Transliteration = "hymōn", Gloss = "your", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "prep" },
                        new Word { Greek = "κατάρτισιν", Transliteration = "katartisin", Gloss = "restoration", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "your restoration"
                }
            },
            Translation = "This also we pray for: your restoration."
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀποτόμως", Transliteration = "apotomōs", Gloss = "harshly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                        new Word { Greek = "χρήσωμαι", Transliteration = "chrēsōmai", Gloss = "I might use", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "according to the authority"
                        },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἔδωκέν", Transliteration = "edōken", Gloss = "gave", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                                new Word { Greek = "μοι", Transliteration = "moi", Gloss = "to me", GrammarCodes = new List<string> { "PRON", "DAT", "1P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "which the Lord gave to me"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "εἰς", Transliteration = "eis", Gloss = "for", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                                new Word { Greek = "καθαίρεσιν", Transliteration = "kathairesin", Gloss = "tearing down", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "for tearing down"
                        }
                    },
                    Translation = "so that when present I might not use [it] harshly according to the authority which the Lord gave to me for building up and not for tearing down"
                }
            },
            Translation = "Because of this I write these things while absent, so that when present I might not use my authority harshly according to the authority which the Lord gave to me for building up and not for tearing down."
        },
        // Verse 11
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "Λοιπόν", Transliteration = "Loipon", Gloss = "finally", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                ...
                new Word { Greek = "καταρτίζεσθε", Transliteration = "katartizesthe", Gloss = "be restored", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "παρακαλεῖσθε", Transliteration = "parakaleisthe", Gloss = "be comforted", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "φρονεῖτε", Transliteration = "phroneite", Gloss = "think", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "think the same thing"
                },
                new Word { Greek = "εἰρηνεύετε", Transliteration = "eirēneuete", Gloss = "live in peace", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "Finally, brothers, rejoice, be restored, be comforted, think the same thing, live in peace."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "of love and peace"
                        }
                    },
                    Translation = "the God of love and peace"
                },
            ...
            Translation = "And the God of love and peace will be with you."
        },
        // Verse 12
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἁγίῳ", Transliteration = "hagiō", Gloss = "a holy", GrammarCodes = new List<string> { "ADJ", "DAT", "N", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "φιλήματι", Transliteration = "philēmati", Gloss = "kiss", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" }
                            },
        ...
        new Phrase
        {
            ...
            Translation = "All the saints greet you."
        },
        // Verse 13
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the fellowship of the Holy Spirit"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "πάντων", Transliteration = "pantōn", Gloss = "all of", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "P" }, PartOfSpeech = "adj" },
                                new Word { Greek = "ὑμῶν", Transliteration = "hymōn", Gloss = "you", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "prep" }
                            },
                            Translation = "all of you"
                        }
                    },
                    Translation = "[be] with all of you"
                }
            },
            Translation = "The grace of the Lord Jesus Christ and the love of God and the fellowship of the Holy Spirit be with all of you."
        }
    };
}
...
- Verse 11: VOC (ἀδελφοί)
- Verse 13: GEN_SUBJ/GEN_OBJ (multiple genitives defining source/relation of Grace, Love, and Fellowship)
*/

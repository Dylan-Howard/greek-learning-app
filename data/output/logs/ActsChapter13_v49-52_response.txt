private static List<object> GetChapter13()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "διεφέρετο", Transliteration = "diephereto", Gloss = "was being spread", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "all the region"
                        }
                    },
                    Translation = "through all the region"
                }
            },
            Translation = "And the word of the Lord was being spread through all the region."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But the Jews"
                },
                new Word { Greek = "παρώτρυναν", Transliteration = "parōtrynan", Gloss = "incited", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "σεβομένας", Transliteration = "sebomenas", Gloss = "devout", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "ACC", "F", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "devout"
                        },
                        new Word { Greek = "γυναῖκας", Transliteration = "gunaikas", Gloss = "women", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" },
                        new Word { Greek = "τὰς", Transliteration = "tas", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "P" }, PartOfSpeech = "art" },
                        new Word { Greek = "εὐσχήμονας", Transliteration = "euschēmonas", Gloss = "of high standing", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "the devout women of high standing"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "the leading men of the city"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐπήγειραν", Transliteration = "epēgeiran", Gloss = "stirred up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "διωγμὸν", Transliteration = "diōgmon", Gloss = "persecution", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                    },
                ...
                new Phrase
                {
                    ...
                    Translation = "against Paul and Barnabas"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐξέβαλον", Transliteration = "exebalon", Gloss = "drove out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ὁρίων", Transliteration = "horiōn", Gloss = "district", GrammarCodes = new List<string> { "N", "GEN", "N", "P" }, PartOfSpeech = "n" },
                                new Word { Greek = "αὐτῶν", Transliteration = "autōn", Gloss = "their", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "pron" }
                            },
                            Translation = "their district"
                        }
                    },
                    Translation = "from their district"
                }
            },
            Translation = "But the Jews incited the devout women of high standing and the leading men of the city, and stirred up persecution against Paul and Barnabas, and drove them out of their district."
        },
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐκτιναξάμενοι", Transliteration = "ektinaxamenoi", Gloss = "having shaken off", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            ...
                            Translation = "the dust of the feet"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "having shaken off the dust of their feet against them"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Ἰκόνιον", Transliteration = "Ikonion", Gloss = "Iconium", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "to Iconium"
                }
            },
            Translation = "But having shaken off the dust of their feet against them, they went to Iconium."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐπληροῦντο", Transliteration = "eplērounto", Gloss = "were being filled", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "χαρᾶς", Transliteration = "charas", Gloss = "with joy", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                    ...
                    Translation = "with joy and the Holy Spirit"
                }
            },
            Translation = "And the disciples were being filled with joy and with the Holy Spirit."
        }
    };
}
/*
Constructions identified:
- GEN_DESC: Acts 13:49 (τοῦ κυρίου), Acts 13:50 (τῆς πόλεως), Acts 13:51 (τῶν ποδῶν)
- PTCP: Acts 13:50 (σεβομένας), Acts 13:51 (ἐκτιναξάμενοι)
- DAT_REF: Acts 13:52 (χαρᾶς καὶ πνεύματος ἁγίου - Genitive of Content/Material after fill verb)
*/

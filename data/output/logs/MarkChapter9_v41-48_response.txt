            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ποτίσῃ", Transliteration = "potisē", Gloss = "gives a drink", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "because you belong to Christ"
                        }
                    },
                    Translation = "For whoever gives you a cup of water to drink in the name because you are Christ's"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀπολέσῃ", Transliteration = "apolesē", Gloss = "he will lose", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "that he will by no means lose his reward"
                }
            },
            Translation = "For whoever gives you a cup of water to drink in the name because you belong to Christ, truly I say to you, he will by no means lose his reward."
        },
        // Verse 42
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "one of these little ones who believe in me"
                        }
                    },
                    Translation = "whoever causes one of these little ones who believe in me to sin"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "περίκειται", Transliteration = "perikeitai", Gloss = "is hung", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ὀνικὸς", Transliteration = "onikos", Gloss = "of a donkey", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "a large millstone"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                        ...
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "βέβληται", Transliteration = "beblētai", Gloss = "he has been thrown", GrammarCodes = new List<string> { "V", "PERF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "if a great millstone were hung around his neck and he were thrown into the sea"
                }
            },
            Translation = "Whoever causes one of these little ones who believe in me to sin, it would be better for him if a great millstone were hung around his neck and he were thrown into the sea."
        },
        // Verse 43
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σκανδαλίζῃ", Transliteration = "skandalisē", Gloss = "causes to sin", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "And if your hand causes you to sin"
                },
                new Word { Greek = "ἀπόκοψον", Transliteration = "apokopson", Gloss = "cut off", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτήν", Transliteration = "autēn", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "F", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "·", Transliteration = "", Gloss = "", GrammarCodes = new List<string> { "PUNC" }, PartOfSpeech = "p" },
                new Word { Greek = "καλόν", Transliteration = "kalon", Gloss = "better", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Translation = "for you to enter life crippled"
                },
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "ἄσβεστον", Transliteration = "asbeston", Gloss = "unquenchable", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                                    },
                                    Translation = "the unquenchable fire"
                                }
                            },
                            Translation = "to the unquenchable fire"
                        }
                    },
                    Translation = "than having two hands to go away into hell, to the unquenchable fire"
                }
            },
            Translation = "And if your hand causes you to sin, cut it off; it is better for you to enter life crippled than having two hands to go away into hell, into the unquenchable fire."
        },
        // Verse 45
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "And if your foot causes you to sin"
                },
                new Word { Greek = "ἀπόκοψον", Transliteration = "apokopson", Gloss = "cut off", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "for you to enter life lame"
                },
                new Word { Greek = "ἢ", Transliteration = "ē", Gloss = "than", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Translation = "than having two feet to be thrown into hell"
                }
            },
            Translation = "And if your foot causes you to sin, cut it off; it is better for you to enter life lame than having two feet to be thrown into hell."
        },
        // Verse 47
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "And if your eye causes you to sin"
                },
                new Word { Greek = "ἔκβαλε", Transliteration = "ekbale", Gloss = "throw out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "·", Transliteration = "", Gloss = "", GrammarCodes = new List<string> { "PUNC" }, PartOfSpeech = "p" },
                new Word { Greek = "καλόν", Transliteration = "kalon", Gloss = "better", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "μονόφθαλμον", Transliteration = "monophthalmon", Gloss = "one-eyed", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "εἰσελθεῖν", Transliteration = "eiselthein", Gloss = "to enter", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "for you to enter the kingdom of God one-eyed"
                },
                new Word { Greek = "ἢ", Transliteration = "ē", Gloss = "than", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Translation = "than having two eyes to be thrown into hell"
                }
            },
            Translation = "And if your eye causes you to sin, throw it out; it is better for you to enter the kingdom of God one-eyed than having two eyes to be thrown into hell,"
        },
        // Verse 48
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "σκώληξ", Transliteration = "skōlēx", Gloss = "worm", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "αὐτῶν", Transliteration = "autōn", Gloss = "of them", GrammarCodes = new List<string> { "PRON", "GEN", "3P", "P" }, PartOfSpeech = "prep" }
                            },
                            Translation = "their worm"
                        },
                        new Word { Greek = "οὐ", Transliteration = "ou", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "τελευτᾷ", Transliteration = "teleuta", Gloss = "dies", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "their worm does not die"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "οὐ", Transliteration = "ou", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "σβέννυται", Transliteration = "sbennytai", Gloss = "is quenched", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "the fire is not quenched"
                }
            },
            Translation = "where their worm does not die and the fire is not quenched."
        }
    };
}
// Constructions:
// Mark 9:41 - SUBJ_NEG (ou mē + aorist subjunctive)
// Mark 9:41 - PREP_PHRASE (en onomati)
// Mark 9:42 - Partitive Genitive (hena tōn mikrōn)
// Mark 9:43 - Comparative construction (kalon... ē)
// Mark 9:47 - Genitive of Possession (basileian tou theou)

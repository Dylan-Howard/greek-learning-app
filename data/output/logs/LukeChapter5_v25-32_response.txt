    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "κατέκειτο", Transliteration = "katekeito", Gloss = "he was lying", GrammarCodes = new List<string> { "V", "IMPF", "MP", "IND", "3P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "which he was lying"
                        }
                    },
                    Translation = "upon which he was lying"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "glorifying God"
                }
            },
            Translation = "And immediately rising up before them, taking up that on which he was lying, he went away to his house, glorifying God."
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔλαβεν", Transliteration = "elaben", Gloss = "seized", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἅπαντας", Transliteration = "hapantas", Gloss = "all", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "P" }, PartOfSpeech = "adj" }
            },
            Translation = "And amazement seized them all,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "and they were glorifying God;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "φόβου", Transliteration = "phobou", Gloss = "with fear", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἴδομεν", Transliteration = "eidomen", Gloss = "we have seen", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "παράδοξα", Transliteration = "paradoxa", Gloss = "remarkable things", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" },
                        new Word { Greek = "σήμερον", Transliteration = "sēmeron", Gloss = "today", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" }
                    },
                    Translation = "that \"We have seen remarkable things today.\""
                }
            },
            Translation = "and they were filled with fear, saying, \"We have seen remarkable things today.\""
        },
        // Verse 27
        new Phrase
        {
            ...
            Translation = "After these things he went out"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐθεάσατο", Transliteration = "etheasato", Gloss = "he saw", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "τελώνην", Transliteration = "telōnēn", Gloss = "a tax collector", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "a tax collector"
                },
                new Phrase
                {
                ...
                new Phrase
                {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "τελώνιον", Transliteration = "telōnion", Gloss = "tax office", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                                    },
                    ...
                    Translation = "sitting at the tax office"
                }
            },
            Translation = "and saw a tax collector named Levi sitting at the tax office,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἠκολούθει", Transliteration = "ēkolouthei", Gloss = "he followed", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "pron" }
            },
            Translation = "And leaving everything, he rose up and followed him."
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "δοχὴν", Transliteration = "dochēn", Gloss = "a banquet", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "μεγάλην", Transliteration = "megalēn", Gloss = "great", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "a great banquet"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "Λευὶς", Transliteration = "Leuis", Gloss = "Levi", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "Levi"
                },
            ...
            Translation = "And Levi made a great banquet for him in his house,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τελωνῶν", Transliteration = "telōnōn", Gloss = "of tax collectors", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "n" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἄλλων", Transliteration = "allōn", Gloss = "others", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "a large crowd of tax collectors and others"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "REL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "κατακείμενοι", Transliteration = "katakeimenoi", Gloss = "reclining", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "were reclining with them"
                        }
                    },
                    Translation = "who were reclining with them"
                }
            },
            Translation = "and there was a large crowd of tax collectors and others who were reclining with them."
        },
        // Verse 30
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐγόγγυζον", Transliteration = "egongyzon", Gloss = "were grumbling", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    ...
                    Translation = "the Pharisees and their scribes"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐσθίετε", Transliteration = "esthiete", Gloss = "do you eat", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "πίνετε", Transliteration = "pinete", Gloss = "drink", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "\"Why do you eat and drink with tax collectors and sinners?\""
                }
            },
            Translation = "And the Pharisees and their scribes grumbled at his disciples, saying, \"Why do you eat and drink with tax collectors and sinners?\""
        },
        // Verse 31
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "οἱ", Transliteration = "hoi", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "P" }, PartOfSpeech = "art" },
                                new Word { Greek = "ὑγιαίνοντες", Transliteration = "hygiainontes", Gloss = "those being healthy", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                            },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἔχοντες", Transliteration = "echontes", Gloss = "having [it]", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "those who are sick"
                        }
                    },
                    Translation = "\"Those who are healthy have no need of a physician, but those who are sick.\""
                }
            },
            Translation = "And answering, Jesus said to them, \"Those who are healthy have no need of a physician, but those who are sick.\""
        },
        // Verse 32
        new Phrase
        {
            ...
            Translation = "I have not come to call the righteous but sinners to repentance."
        }
    };
}
/*
Identified Constructions:
- PERIPH: V29 (ἦσαν ... κατακείμενοι)
- REL_CLAUSE: V25 (ἐφ᾽ ὃ κατέκειτο), V29 (οἳ ἦσαν...)
- APP_POS: V27 (ὀνόματι Λευὶν)
*/

private static List<object> GetChapter8()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πολλοῦ", Transliteration = "pollou", Gloss = "a great", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "S" }, PartOfSpeech = "adj" },
                    ...
                    Translation = "when there was again a great crowd"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "GEN_ABS" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "what they might eat"
                        }
                    },
                    Translation = "and they had nothing to eat"
                },
                new Phrase
                {
                    ...
                    Translation = "having called the disciples"
                },
            ...
            Translation = "In those days, when there was again a great crowd and they had nothing to eat, having called the disciples, he says to them,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "σπλαγχνίζομαι", Transliteration = "splanchnizomai", Gloss = "I have compassion", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "προσμένουσίν", Transliteration = "prosmeneusin", Gloss = "they have remained", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "μοι", Transliteration = "moi", Gloss = "with me", GrammarCodes = new List<string> { "PRON", "DAT", "1P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "because they have remained with me already three days"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    ...
                    Translation = "and they have nothing to eat"
                }
            },
            Translation = "I have compassion on the crowd, because they have remained with me already three days and they have nothing to eat."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀπολύσω", Transliteration = "apolysō", Gloss = "I send away", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "to their home"
                        }
                    },
                    Translation = "And if I send them away hungry to their home"
                },
                new Word { Greek = "ἐκλυθήσονται", Transliteration = "eklythēsontai", Gloss = "they will faint", GrammarCodes = new List<string> { "V", "FUT", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "And if I send them away hungry to their home, they will faint on the way;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μακρόθεν", Transliteration = "makrothen", Gloss = "a distance", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
                    },
                    Translation = "from a distance"
                },
                new Word { Greek = "ἥκασιν", Transliteration = "hēkasin", Gloss = "have come", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "and some of them have come from a distance."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δυνήσεταί", Transliteration = "dynēsetai", Gloss = "will be able", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        ...
                        new Word { Greek = "χορτάσαι", Transliteration = "chortasai", Gloss = "to satisfy", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἄρτων", Transliteration = "artōn", Gloss = "with bread", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἐρημίας", Transliteration = "erēmias", Gloss = "a remote place", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "in a remote place"
                        }
                    },
                    Translation = "that 'From where will anyone be able here to satisfy these with bread in a remote place?'"
                }
            },
            Translation = "And his disciples answered him, 'From where will anyone be able here to satisfy these with bread in a remote place?'"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "And", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἠρώτα", Transliteration = "ērōta", Gloss = "he was asking", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "How many loaves do you have?"
                }
            },
            Translation = "And he was asking them, 'How many loaves do you have?'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἑπτά", Transliteration = "hepta", Gloss = "Seven", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "P" }, PartOfSpeech = "adj" }
            },
            Translation = "And they said, 'Seven.'"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "And", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "παραγγέλλει", Transliteration = "parangellei", Gloss = "he commands", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀναπεσεῖν", Transliteration = "anapesein", Gloss = "to recline", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "to recline on the ground"
                }
            },
            Translation = "And he commands the crowd to recline on the ground;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "having taken the seven loaves"
                },
                new Word { Greek = "εὐχαριστήσας", Transliteration = "eucharistēsas", Gloss = "having given thanks", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἔκλασεν", Transliteration = "eklasen", Gloss = "he broke [them]", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "παρατιθῶσιν", Transliteration = "paratithōsin", Gloss = "they might set [them] before", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "that they might set [them] before [the crowd]"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "παρέθηκαν", Transliteration = "parethēkan", Gloss = "they set [them] before", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "IND_OBJ" },
                    Content = new List<object>
            ...
            Translation = "and having taken the seven loaves, having given thanks, he broke them and was giving them to his disciples to set before them, and they set them before the crowd."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἰχθύδια", Transliteration = "ichthydia", Gloss = "small fish", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                        new Word { Greek = "ὀλίγα", Transliteration = "oliga", Gloss = "a few", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "a few small fish"
                }
            },
            Translation = "And they had a few small fish;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "εὐλογήσας", Transliteration = "eulogēsas", Gloss = "having blessed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτὰ", Transliteration = "auta", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "N", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "having blessed them"
                },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "he said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "παρατιθέναι", Transliteration = "paratithenai", Gloss = "to set before [them]", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" }
                    },
                    Translation = "also these to be set before [them]"
                }
            },
            Translation = "and having blessed them, he said also for these to be set before them."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐχορτάσθησαν", Transliteration = "echorthasthēsan", Gloss = "were satisfied", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "And they ate and were satisfied;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "περισσεύματα", Transliteration = "perisseumata", Gloss = "remnants", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                        new Word { Greek = "κλασμάτων", Transliteration = "klasmatōn", Gloss = "of broken pieces", GrammarCodes = new List<string> { "N", "GEN", "N", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "remnants of broken pieces"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σπυρίδας", Transliteration = "spyridas", Gloss = "baskets", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "seven baskets"
                }
            },
            Translation = "and they took up the remnants of broken pieces, seven baskets."
        }
    };
}
...
- GEN_ABS: Mark 8:1 ("πολλοῦ ὄχλου ὄντος", "καὶ μὴ ἐχόντων τί φάγωσιν")
- PTCP (Participial Phrases): Mark 8:1, 8:6, 8:7
- COND_CLAUSE (εἰ/ἐὰν): Mark 8:3
- PURPOSE_CLAUSE (ἵνα + subjunctive): Mark 8:6
- INF_PHRASE (Infinitive Phrases): Mark 8:4, 8:6, 8:7
*/

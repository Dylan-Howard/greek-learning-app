    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "πτωχείαν", Transliteration = "ptōcheian", Gloss = "poverty", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the poverty"
                }
            },
            Translation = "I know your tribulation and poverty"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                new Word { Greek = "βλασφημίαν", Transliteration = "blasphēmian", Gloss = "blasphemy", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "those saying"
                        }
                    },
                    Translation = "from those saying"
                },
                new Phrase
                {
                    ...
                    Translation = "they themselves are Jews"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "συναγωγὴ", Transliteration = "synagōgē", Gloss = "synagogue", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "a synagogue of Satan"
                }
            },
            Translation = "and the blasphemy from those saying themselves to be Jews and are not, but a synagogue of Satan"
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μέλλεις", Transliteration = "melleis", Gloss = "you are about", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "which things you are about to suffer"
                }
            },
            Translation = "Fear nothing of what you are about to suffer"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "βάλλειν", Transliteration = "ballein", Gloss = "to cast", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πειρασθῆτε", Transliteration = "peirasthēte", Gloss = "you may be tested", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "that you may be tested"
                }
            },
            Translation = "Behold, the devil is about to cast some of you into prison, that you may be tested"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἕξετε", Transliteration = "hexete", Gloss = "you will have", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "for ten days"
                        }
                    },
                    Translation = "tribulation for ten days"
                }
            },
            Translation = "and you will have tribulation for ten days"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the crown of life"
                }
            },
            Translation = "and I will give to you the crown of life"
        },
        // Verse 11
        new Phrase
        {
            ...
            Translation = "The one having an ear, let him hear what the Spirit says to the churches"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "The one overcoming"
                },
                ...
                new Word { Greek = "ἀδικηθῇ", Transliteration = "adikēthē", Gloss = "shall be harmed", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    {
                                        new Word { Greek = "τοῦ", Transliteration = "tou", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "M", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "δευτέρου", Transliteration = "deuterou", Gloss = "second", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "S" }, PartOfSpeech = "adj" }
                                    },
                    ...
                    Translation = "by the second death"
                }
            },
            Translation = "The one overcoming shall not be harmed by the second death"
        },
        // Verse 12
        new Phrase
        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "Περγάμῳ", Transliteration = "Pergamō", Gloss = "Pergamum", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "in Pergamum"
                                },
                                new Word { Greek = "ἐκκλησίας", Transliteration = "ekklēsias", Gloss = "church", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "church in Pergamum"
                        }
                    },
                    Translation = "to the angel of the church in Pergamum"
                },
                new Word { Greek = "γράψον", Transliteration = "grapson", Gloss = "write", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "And to the angel of the church in Pergamum write"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "Τάδε", Transliteration = "Tade", Gloss = "these things", GrammarCodes = new List<string> { "PRON", "ACC", "N", "P" }, PartOfSpeech = "adv" },
                new Word { Greek = "λέγει", Transliteration = "legei", Gloss = "says", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "ῥομφαίαν", Transliteration = "romphaian", Gloss = "sword", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "δίστομον", Transliteration = "distomon", Gloss = "two-edged", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" }
                                    },
                                    Translation = "the two-edged"
                                },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    ...
                                    {
                                        new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "ὀξεῖαν", Transliteration = "oxeian", Gloss = "sharp", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" }
                                    },
                                    Translation = "the sharp"
                                }
                            },
                            Translation = "the sharp two-edged sword"
                        }
                    },
                    Translation = "the one having the sharp two-edged sword"
                }
            },
            Translation = "These things says the one having the sharp two-edged sword"
        },
        // Verse 13
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κατοικεῖς", Transliteration = "katoikeis", Gloss = "you dwell", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "where you dwell"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the throne of Satan"
                        }
                    },
                    Translation = "where the throne of Satan is"
                }
            },
            Translation = "I know where you dwell, where the throne of Satan is"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "κρατεῖς", Transliteration = "krateis", Gloss = "you hold fast", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἠρνήσω", Transliteration = "ērnēsō", Gloss = "you denied", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "and you hold fast My name, and did not deny My faith"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "Ἀντιπᾶς", Transliteration = "Antipas", Gloss = "Antipas", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "μου", Transliteration = "mou", Gloss = "one of Me", GrammarCodes = new List<string> { "PRON", "GEN", "1P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "My faithful one"
                        }
                    },
                    Translation = "Antipas My witness My faithful one"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "REL_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀπεκτάνθη", Transliteration = "apektanthē", Gloss = "was killed", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "where Satan dwells"
                        }
                    },
                    Translation = "who was killed among you where Satan dwells"
                }
            },
            Translation = "even in the days of Antipas My witness My faithful one who was killed among you where Satan dwells"
        },
        // Verse 14
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ὀλίγα", Transliteration = "oliga", Gloss = "a few things", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "κρατοῦντας", Transliteration = "kratountas", Gloss = "ones holding", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "Βαλαάμ", Transliteration = "Balaam", Gloss = "of Balaam", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "the teaching of Balaam"
                                }
                            },
                            Translation = "those holding the teaching of Balaam"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "REL_CLAUSE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "Βαλὰκ", Transliteration = "Balak", Gloss = "Balak", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "Balak"
                                },
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "before the sons of Israel"
                                },
                            ...
                            Translation = "who was teaching Balak to cast a stumbling block before the sons of Israel to eat things sacrificed to idols and to commit immorality"
                        }
                    },
                    Translation = "because you have there those holding the teaching of Balaam, who was teaching Balak to cast a stumbling block before the sons of Israel"
                }
            },
            Translation = "But I have a few things against you, because you have there those holding the teaching of Balaam"
        },
        // Verse 15
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "οὕτως", Transliteration = "houtōs", Gloss = "likewise", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἔχεις", Transliteration = "echeis", Gloss = "you have", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the teaching of the Nicolaitans"
                        }
                    },
                    Translation = "those holding the teaching of the Nicolaitans"
                },
                new Word { Greek = "ὁμοίως", Transliteration = "homoiōs", Gloss = "in like manner", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
            },
            Translation = "So you also have those who hold the teaching of the Nicolaitans in like manner"
        },
        // Verse 16
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔρχομαί", Transliteration = "erchomai", Gloss = "I am coming", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "σοι", Transliteration = "soi", Gloss = "to you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ταχὺ", Transliteration = "tachy", Gloss = "quickly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
            },
            Translation = "but if not, I am coming to you quickly"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "πολεμήσω", Transliteration = "polemēsō", Gloss = "I will fight", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "μετ᾽", Transliteration = "met", Gloss = "against", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ῥομφαίᾳ", Transliteration = "romphaia", Gloss = "sword", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "the sword of My mouth"
                        }
                    },
                    Translation = "with the sword of My mouth"
                }
            },
            Translation = "and I will fight against them with the sword of My mouth"
        }
    };
}
...
- APPOS: Ἀντιπᾶς ὁ μάρτυς μου ὁ πιστός μου (v13)
- PURPOSE_CLAUSE: ἵνα πειρασθῆτε (v10)
- REL_CLAUSE: ἃ μέλλεις πάσχειν (v10), ὃς ἀπεκτάνθη... (v13), ὃς ἐδίδασκεν... (v14)
- CAUSAL_CLAUSE: ὅτι ἔχεις ἐκεῖ κρατοῦντας... (v14)
- COND_CLAUSE: εἰ δὲ μή... (v16)
- DAT_INSTR: ἐν τῇ ῥομφαίᾳ τοῦ στόματός μου (v16)
*/

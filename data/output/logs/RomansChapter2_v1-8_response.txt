    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀναπολόγητος", Transliteration = "anapologētos", Gloss = "without excuse", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "πᾶς", Transliteration = "pas", Gloss = "every [one]", GrammarCodes = new List<string> { "ADJ", "VOC", "M", "S" }, PartOfSpeech = "adj" },
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "κρίνων", Transliteration = "krinōn", Gloss = "judging", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "VOC", "M", "S" }, PartOfSpeech = "v" }
                                    },
                                    Translation = "the one judging"
                                }
                            },
                            Translation = "every one who judges"
                        }
                    },
                    Translation = "O man, every one who judges"
                }
            },
            Translation = "Therefore you are without excuse, O man, every one who judges."
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κρίνεις", Transliteration = "krineis", Gloss = "you judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Word { Greek = "κατακρίνεις", Transliteration = "katakrineis", Gloss = "you condemn", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "for in that which you judge the other, you condemn yourself,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "αὐτὰ", Transliteration = "auta", Gloss = "same [things]", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "the same things"
                },
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "πράσσεις", Transliteration = "prasseis", Gloss = "you practice", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "for you, the one judging, practice the same things."
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the judgment of God"
                        },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "according to truth"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },

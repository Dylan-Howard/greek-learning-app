        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τῷ", Transliteration = "tō", Gloss = "the", GrammarCodes = new List<string> { "ART", "DAT", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "ὑμετέρῳ", Transliteration = "hymeterō", Gloss = "your", GrammarCodes = new List<string> { "ADJ", "DAT", "M", "S" }, PartOfSpeech = "adj" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the testimony of two men"
                        },
                    ...
                    Translation = "that the testimony of two men is true"
                }
            },
            Translation = "In your law it has also been written that the testimony of two men is true."
        },
        // Verse 18
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μαρτυρῶν", Transliteration = "martyrōn", Gloss = "testifying", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "the one testifying about myself"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "I am the one testifying about myself, and the Father who sent me testifies about me."
        },
        // Verse 19
        new Phrase
        {
            ...
            Translation = "So they were saying to him, 'Where is your father?'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "You know neither me nor my father."
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐμὲ", Transliteration = "eme", Gloss = "me", GrammarCodes = new List<string> { "PRON", "ACC", "1P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ᾔδειτε", Transliteration = "ēdeite", Gloss = "you had known", GrammarCodes = new List<string> { "V", "PLPF", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        ...
                        new Word { Greek = "ᾔδειτε", Transliteration = "ēdeite", Gloss = "you would have known", GrammarCodes = new List<string> { "V", "PLPF", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "if you had known me, you would have known my father also."
                }
            },
            Translation = "Jesus answered, 'You know neither me nor my father; if you had known me, you would have known my father also.'"
        },
        // Verse 20
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γαζοφυλακίῳ", Transliteration = "gazophylakiō", Gloss = "treasury", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "in the treasury"
                },
                new Phrase
                {
                    ...
                    Translation = "as he taught in the temple"
                }
            },
            Translation = "These words he spoke in the treasury, as he taught in the temple;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐπίασεν", Transliteration = "epiasen", Gloss = "seized", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "and no one seized him, because his hour had not yet come."
        },
        // Verse 21
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὑπάγω", Transliteration = "hypagō", Gloss = "am going away", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "I am going away"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "ἁμαρτίᾳ", Transliteration = "hamartia", Gloss = "sin", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                            ...
                            Translation = "in your sin"
                        },
                        new Word { Greek = "ἀποθανεῖσθε", Transliteration = "apothaneisthe", Gloss = "you will die", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "you will die in your sin"
                }
            },
            Translation = "Then he said to them again, 'I am going away, and you will seek me, and you will die in your sin;'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐγὼ", Transliteration = "egō", Gloss = "I", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ὑπάγω", Transliteration = "hypagō", Gloss = "am going", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "where I am going"
                },
            ...
            Translation = "where I am going, you cannot come."
        },
        // Verse 22
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Ἰουδαῖοι", Transliteration = "Ioudaioi", Gloss = "Jews", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "adj" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "μήτι", Transliteration = "mēti", Gloss = "Will [not]", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἀποκτενεῖ", Transliteration = "apoktenei", Gloss = "he kill", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἑαυτόν", Transliteration = "heauton", Gloss = "himself", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "f" }
                    },
                    Translation = "Will he kill himself?"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    ...
                    Translation = "since he says, 'Where I am going, you cannot come.'"
                }
            },
            Translation = "So the Jews were saying, 'Will he kill himself, since he says, \"Where I am going, you cannot come\"?'"
        },
        // Verse 23
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "You are from below;"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Translation = "You are of this world;"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    ...
                    Translation = "I am not of this world."
                }
            },
            Translation = "And he was saying to them, 'You are from below; I am from above. You are of this world; I am not of this world.'"
        },
        // Verse 24
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "in your sins"
                        }
                    },
                    Translation = "that you will die in your sins"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "COND_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πιστεύσητε", Transliteration = "pisteusēte", Gloss = "you believe", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                            Content = new List<object>
                    ...
                    Translation = "for unless you believe that I am he"
                },
                new Word { Greek = "ἀποθανεῖσθε", Transliteration = "apothaneisthe", Gloss = "you will die", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "Therefore I said to you that you will die in your sins; for unless you believe that I am he, you will die in your sins."
        }
    };
}
...
- SECOND CLASS CONDITIONAL: John 8:19 (εἰ ... ἂν ... ᾔδειτε)
- SUBSTANTIVAL PARTICIPLE: John 8:18 (ὁ μαρτυρῶν), John 8:18 (ὁ πέμψας)
- CIRCUMSTANTIAL PARTICIPLE: John 8:20 (διδάσκων)
- FIRST CLASS CONDITIONAL (NEGATIVE): John 8:24 (ἐὰν ... μὴ πιστεύσητε)
*/

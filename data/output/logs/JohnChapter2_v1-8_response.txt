private static List<object> GetChapter2()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "γάμος", Transliteration = "gamos", Gloss = "a wedding", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "a wedding"
                },
            ...
            Translation = "On the third day a wedding took place in Cana of Galilee,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἐκλήθη", Transliteration = "eklēthē", Gloss = "was invited", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γάμον", Transliteration = "gamon", Gloss = "wedding", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "to the wedding"
                }
            },
            Translation = "Now Jesus was also invited, and his disciples, to the wedding."
        },
        // Verse 3
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ὑστερήσαντος", Transliteration = "ysterēsantos", Gloss = "having failed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "οἴνου", Transliteration = "oinou", Gloss = "wine", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "When the wine failed"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "They have no wine."
                }
            },
            Translation = "When the wine failed, the mother of Jesus says to him, 'They have no wine.'"
        },
        // Verse 4
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "What is that to me and to you, woman?"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    ...
                    Translation = "My hour has not yet come."
                }
            },
            Translation = "And Jesus says to her, 'What is that to me and to you, woman? My hour has not yet come.'"
        },
        // Verse 5
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "διακόνοις", Transliteration = "diakonois", Gloss = "servants", GrammarCodes = new List<string> { "N", "DAT", "M", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "to the servants"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "λέγῃ", Transliteration = "legē", Gloss = "he may say", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "ὑμῖν", Transliteration = "hymin", Gloss = "to you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "Whatever he may say to you"
                },
                new Word { Greek = "ποιήσατε", Transliteration = "poiēsate", Gloss = "do", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "His mother says to the servants, 'Whatever he may say to you, do it.'"
        },
        // Verse 6
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "λίθιναι", Transliteration = "lithinai", Gloss = "stone", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "P" }, PartOfSpeech = "adj" },
                        new Word { Greek = "ὑδρίαι", Transliteration = "hydriai", Gloss = "water jars", GrammarCodes = new List<string> { "N", "NOM", "F", "P" }, PartOfSpeech = "n" },
                        new Word { Greek = "ἓξ", Transliteration = "hex", Gloss = "six", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "six stone water jars"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὸν", Transliteration = "ton", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "καθαρισμὸν", Transliteration = "katharismon", Gloss = "purification", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "GEN_DESC" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "Ἰουδαίων", Transliteration = "Ioudaiōn", Gloss = "Jews", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "adj" }
                                    },
                                    Translation = "of the Jews"
                                }
                            },
                            Translation = "the purification of the Jews"
                        }
                    },
                    Translation = "for the Jewish rites of purification"
                },
                new Word { Greek = "κείμεναι", Transliteration = "keimenai", Gloss = "lying", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "F", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "χωροῦσαι", Transliteration = "chōrousai", Gloss = "holding", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "F", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἀνὰ", Transliteration = "ana", Gloss = "each", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "μετρητὰς", Transliteration = "metrētas", Gloss = "measures", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" },
                    ...
                    Translation = "holding twenty or thirty gallons each"
                }
            },
            Translation = "Now six stone water jars were standing there, for the Jewish rites of purification, each holding twenty or thirty gallons."
        },
        // Verse 7
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "γεμίσατε", Transliteration = "gemisate", Gloss = "fill", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὑδρίας", Transliteration = "hydrias", Gloss = "water jars", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "the water jars"
                },
                new Word { Greek = "ὕδατος", Transliteration = "hydatos", Gloss = "with water", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" }
            },
            Translation = "Jesus says to them, 'Fill the water jars with water.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                // (continues verse 7)
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐγέμισαν", Transliteration = "egemisan", Gloss = "they filled", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἄνω", Transliteration = "anō", Gloss = "the top", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
                    },
                    Translation = "up to the brim"
                }
            },
            Translation = "And they filled them up to the brim."
        },
        // Verse 8
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "αὐτοῖς", Transliteration = "autois", Gloss = "to them", GrammarCodes = new List<string> { "PRON", "DAT", "M", "P" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἀντλήσατε", Transliteration = "antlēsate", Gloss = "draw out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀρχιτρικλίνῳ", Transliteration = "architriklino", Gloss = "master of the banquet", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "to the master of the feast"
                }
            },
            Translation = "And he says to them, 'Now draw some out and take it to the master of the feast.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                // (continues verse 8)
                new Word { Greek = "οἱ", Transliteration = "hoi", Gloss = "they", GrammarCodes = new List<string> { "PRON", "NOM", "M", "P" }, PartOfSpeech = "art" },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "so", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἤνεγκαν", Transliteration = "ēnegkan", Gloss = "they took", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "So they took it."
        }
    };
}
...
- GEN_ABS: ὑστερήσαντος οἴνου (v3)
- DAT_TIME: τῇ ἡμέρᾳ τῇ τρίτῃ (v1)
*/

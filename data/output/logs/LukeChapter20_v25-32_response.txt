private static List<object> GetChapter20()
{
    ...
    return new List<object>
    {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "αὐτούς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "3P", "ACC", "M", "P" }, PartOfSpeech = "pron" }
                    },
                    Translation = "to them"
                }
            },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "τοίνυν", Transliteration = "toinun", Gloss = "then", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἀπόδοτε", Transliteration = "apodote", Gloss = "render", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Translation = "the things of Caesar"
                },
                new Phrase
                {
            ...
            Translation = "“Then render the things of Caesar to Caesar, and the things of God to God.”"
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἴσχυσαν", Transliteration = "ischysan", Gloss = "they were able", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INF_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐπιλαβέσθαι", Transliteration = "epilabesthai", Gloss = "to take hold", GrammarCodes = new List<string> { "V", "AOR", "MID", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "of his", GrammarCodes = new List<string> { "PRON", "3P", "GEN", "M", "S" }, PartOfSpeech = "pron" },
                                new Word { Greek = "ῥήματος", Transliteration = "rhematos", Gloss = "word", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "of his word"
                        }
                    },
                    Translation = "to take hold of his word"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "before the people"
                }
            },
            Translation = "And they were not able to take hold of his word before the people;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "θαυμάσαντες", Transliteration = "thaumasantes", Gloss = "being amazed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "ἀποκρίσει", Transliteration = "apokrisei", Gloss = "answer", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "of him", GrammarCodes = new List<string> { "PRON", "3P", "GEN", "M", "S" }, PartOfSpeech = "pron" }
                                    },
                                    Translation = "his answer"
                                }
                            },
                            Translation = "at his answer"
                        }
                    },
                    Translation = "being amazed at his answer"
                },
                new Word { Greek = "ἐσίγησαν", Transliteration = "esigēsan", Gloss = "they were silent", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "and being amazed at his answer, they were silent."
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "some of the Sadducees"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀντιλέγοντες", Transliteration = "antilegontes", Gloss = "speaking against", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "INF_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "that there is no resurrection"
                        }
                    },
                    Translation = "those who say there is no resurrection"
                },
                ...
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "3P", "ACC", "M", "S" }, PartOfSpeech = "pron" }
            },
            Translation = "There came to him some of the Sadducees, those who say there is no resurrection, and they asked him,"
        },
        // Verse 28
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἡμῖν", Transliteration = "hēmin", Gloss = "for us", GrammarCodes = new List<string> { "PRON", "1P", "DAT", "P" }, PartOfSpeech = "pron" }
            },
            Translation = "Moses wrote for us,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "τινος", Transliteration = "tinos", Gloss = "of someone", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "pron" },
                        new Word { Greek = "ἀδελφὸς", Transliteration = "adelphos", Gloss = "brother", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "someone's brother"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "having a wife"
                }
            },
            Translation = "if someone's brother should die having a wife,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "COND_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "οὗτος", Transliteration = "outos", Gloss = "he", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "pron" }
                    },
                    Translation = "he"
                },
                new Word { Greek = "ἄτεκνος", Transliteration = "ateknos", Gloss = "childless", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "ᾖ", Transliteration = "ē", Gloss = "should be", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and he should be childless,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "λάβῃ", Transliteration = "labē", Gloss = "should take", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "that his brother should take the wife,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐξαναστήσῃ", Transliteration = "exanastēsē", Gloss = "should raise up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "for his brother.”"
                }
            },
            Translation = "and should raise up offspring for his brother.”"
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "Now there were seven brothers;"
                },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "having taken a wife,"
                },
            ...
            Translation = "and the first, having taken a wife, died childless."
        },
        // Verse 30
        new Phrase
        {
            ...
            Translation = "And the second [took her and died childless],"
        },
        // Verse 31
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔλαβεν", Transliteration = "elaben", Gloss = "took", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτήν", Transliteration = "autēn", Gloss = "her", GrammarCodes = new List<string> { "PRON", "3P", "ACC", "F", "S" }, PartOfSpeech = "pron" }
            },
            Translation = "and the third took her;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "κατέλιπον", Transliteration = "katelipon", Gloss = "left", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "τέκνα", Transliteration = "tekna", Gloss = "children", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" }
            },
            Translation = "and in the same way also the seven left no children"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ὕστερον", Transliteration = "hysteron", Gloss = "finally", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "also", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
            ...
            Translation = "Finally the woman also died."
        }
    };
}
...
- Verse 25: NOUN_PHRASE with genitive (τὰ Καίσαρος, τὰ τοῦ θεοῦ)
- Verse 27: Partitive Genitive (τινες τῶν Σαδδουκαίων)
- Verse 28: Dative of Reference/Interest (ἡμῖν, τῷ ἀδελφῷ αὐτοῦ)
- Verse 28: PURPOSE_CLAUSE with ἵνα + subjunctive (ἵνα λάβῃ..., καὶ ἐξαναστήσῃ...)
- Verse 28: COND_CLAUSE with ἐάν + subjunctive (ἐάν... ἀποθάνῃ..., καὶ... ᾖ)
- Verse 29: PTCP used adverbially/circumstantially (λαβὼν γυναῖκα)
*/

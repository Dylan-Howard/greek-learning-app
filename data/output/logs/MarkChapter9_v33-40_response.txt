private static List<object> GetChapter9()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Translation = "And they came to Capernaum."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "διελογίζεσθε", Transliteration = "dielogizesthe", Gloss = "you were discussing", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "What were you discussing in the way?"
                }
            },
            Translation = "And when he was in the house, he asked them, 'What were you discussing in the way?'"
        },
        // Verse 34
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "διελέχθησαν", Transliteration = "dielechthēsan", Gloss = "they reasoned", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "who was the greatest"
                }
            },
            Translation = "For in the way they had reasoned with one another who was the greatest."
        },
        // Verse 35
        new Phrase
        {
            ...
            Translation = "And sitting down, he called the twelve and says to them:"
        },
        new Phrase
        {
            ...
            Translation = "If anyone desires to be first,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "ἔσται", Transliteration = "estai", Gloss = "he shall be", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Translation = "servant of all"
                }
            },
            Translation = "he shall be last of all and servant of all."
        },
        // Verse 36
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐναγκαλισάμενος", Transliteration = "enankalisamenos", Gloss = "having taken in his arms", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸ", Transliteration = "auto", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "he said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτοῖς", Transliteration = "autois", Gloss = "to them", GrammarCodes = new List<string> { "PRON", "DAT", "M", "P" }, PartOfSpeech = "prep" }
            },
            Translation = "And taking a child, he set him in the midst of them; and taking him in his arms, he said to them:"
        },
        // Verse 37
        new Phrase
        {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "τοιούτων", Transliteration = "toioutōn", Gloss = "such", GrammarCodes = new List<string> { "ADJ", "GEN", "N", "P" }, PartOfSpeech = "adv" },
                                new Word { Greek = "παιδίων", Transliteration = "paidiōn", Gloss = "children", GrammarCodes = new List<string> { "N", "GEN", "N", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "of such children"
                        }
                    },
                    Translation = "one of such children"
                },
                new Word { Greek = "δέξηται", Transliteration = "dexētai", Gloss = "welcomes", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "Whoever welcomes one of such children in my name"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "δέχεται", Transliteration = "dechetai", Gloss = "welcomes", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "welcomes me;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἂν", Transliteration = "an", Gloss = "[particle]", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἐμὲ", Transliteration = "eme", Gloss = "me", GrammarCodes = new List<string> { "PRON", "ACC", "1P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "δέχηται", Transliteration = "dexētai", Gloss = "welcomes", GrammarCodes = new List<string> { "V", "PRES", "MID", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "whoever welcomes me"
                },
            ...
            Translation = "and whoever welcomes me, welcomes not me but the one who sent me."
        },
        // Verse 38
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "εἴδομέν", Transliteration = "eidomen", Gloss = "we saw", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐκβάλλοντα", Transliteration = "ekballonta", Gloss = "casting out", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "δαιμόνια", Transliteration = "daimonia", Gloss = "demons", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "casting out demons in your name"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐκωλύομεν", Transliteration = "ekwoluomen", Gloss = "we were hindering", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "because he was not following us"
                }
            },
            Translation = "Teacher, we saw someone casting out demons in your name, and we tried to hinder him because he was not following us."
        },
        // Verse 39
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κωλύετε", Transliteration = "kōluete", Gloss = "hinder", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" }
            },
            Translation = "Do not hinder him;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δύναμιν", Transliteration = "dunamin", Gloss = "a work of power", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "who will do a miracle in my name"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "δυνήσεται", Transliteration = "dunēsetai", Gloss = "will be able", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ταχὺ", Transliteration = "tachu", Gloss = "soon", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INF_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "κακολογῆσαί", Transliteration = "kakologēsai", Gloss = "to speak evil of", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Word { Greek = "με", Transliteration = "me", Gloss = "me", GrammarCodes = new List<string> { "PRON", "ACC", "1P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "to speak evil of me"
                }
            },
            Translation = "For there is no one who will do a work of power in my name and be able soon to speak evil of me."
        },
        // Verse 40
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ὑπὲρ", Transliteration = "huper", Gloss = "for", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἡμῶν", Transliteration = "hēmōn", Gloss = "us", GrammarCodes = new List<string> { "PRON", "GEN", "1P", "P" }, PartOfSpeech = "prep" }
                    },
                    Translation = "for us"
                },
            ...
            Translation = "For he who is not against us is for us."
        }
    };
}
...
- 9:33: Circumstantial Participle (γενόμενος)
- 9:35: Aorist Participle of Attendant Circumstance (καθίσας)
- 9:35: Conditional Sentence (First Class/Third Class hybrid style common in Koine with εἴ + indicative)
- 9:36: Aorist Participle of Attendant Circumstance (λαβὼν, ἐναγκαλισάμενος)
- 9:37: Indefinite Relative Clause (ὃς ἂν + subjunctive)
- 9:38: Present Participle functioning as Object Complement (ἐκβάλλοντα)
- 9:39: Indefinite Relative Clause (ὃς + future indicative)
*/

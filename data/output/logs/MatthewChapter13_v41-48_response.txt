private static List<object> GetChapter13()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "ἀποστελεῖ", Transliteration = "apostelei", Gloss = "will send", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "συλλέξουσιν", Transliteration = "syllexousin", Gloss = "they will gather", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Translation = "out of his kingdom"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σκάνδαλα", Transliteration = "skandala", Gloss = "causes of sin", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "all causes of sin"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ποιοῦντας", Transliteration = "poiountas", Gloss = "doing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀνομίαν", Transliteration = "anomian", Gloss = "lawlessness", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "lawlessness"
                        }
                    },
                    Translation = "those who do lawlessness"
                }
            },
            Translation = "and they will gather out of his kingdom all causes of sin and those who do lawlessness,"
        },
        // Verse 42
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "βαλοῦσιν", Transliteration = "balousin", Gloss = "they will throw", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "and they will throw them into the furnace of fire."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the weeping and the gnashing of teeth"
                }
            },
            Translation = "In that place there will be weeping and gnashing of teeth."
        },
        // Verse 43
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐκλάμψουσιν", Transliteration = "eklampsousin", Gloss = "will shine forth", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "in the kingdom of their Father"
                }
            },
            Translation = "Then the righteous will shine forth like the sun in the kingdom of their Father."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "θησαυρῷ", Transliteration = "thēsaurō", Gloss = "to treasure", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "κεκρυμμένῳ", Transliteration = "kekrymmenō", Gloss = "having been hidden", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "in a field"
                        }
                    },
                    Translation = "to treasure hidden in a field"
                }
            },
            Translation = "The kingdom of heaven is like treasure hidden in a field,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "εὑρὼν", Transliteration = "heurōn", Gloss = "having found", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "which a man found and hid;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "from his joy"
                },
                new Word { Greek = "ὑπάγει", Transliteration = "hypagei", Gloss = "he goes", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "πωλεῖ", Transliteration = "pōlei", Gloss = "sells", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὅσα", Transliteration = "hosa", Gloss = "as many as", GrammarCodes = new List<string> { "PRON", "ACC", "N", "P" }, PartOfSpeech = "pron" },
                    ...
                    Translation = "all that he has"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἀγοράζει", Transliteration = "agorazei", Gloss = "buys", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "and in his joy he goes and sells all that he has and buys that field."
        },
        // Verse 45
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐμπόρῳ", Transliteration = "emporō", Gloss = "merchant", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "ζητοῦντι", Transliteration = "zētounti", Gloss = "seeking", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                new Word { Greek = "καλοὺς", Transliteration = "kalous", Gloss = "fine", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "P" }, PartOfSpeech = "adj" },
                                new Word { Greek = "μαργαρίτας", Transliteration = "margaritas", Gloss = "pearls", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "fine pearls"
                        }
                    },
                    Translation = "to a merchant seeking fine pearls"
                }
            },
            Translation = "Again, the kingdom of heaven is like a merchant seeking fine pearls,"
        },
        // Verse 46
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πολύτιμον", Transliteration = "polytimon", Gloss = "very precious", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "μαργαρίτην", Transliteration = "margaritēn", Gloss = "pearl", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "one pearl of great value"
                },
                ...
                new Word { Greek = "πέπρακεν", Transliteration = "pepraken", Gloss = "he has sold", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that he had"
                        }
                    },
                    Translation = "all that he had"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἠγόρασεν", Transliteration = "ēgorasen", Gloss = "bought", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" }
            },
            Translation = "who, when he had found one pearl of great value, went and sold all that he had and bought it."
        },
        // Verse 47
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "σαγήνῃ", Transliteration = "sagēnē", Gloss = "to a net", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "βληθείσῃ", Transliteration = "blētheisē", Gloss = "having been thrown", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "DAT", "F", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "to a net thrown into the sea"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γένους", Transliteration = "genous", Gloss = "kind", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "of every kind"
                },
                new Word { Greek = "συναγαγούσῃ", Transliteration = "synagagousē", Gloss = "having gathered", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "DAT", "F", "S" }, PartOfSpeech = "v" }
            },
            Translation = "Again, the kingdom of heaven is like a net that was thrown into the sea and gathered fish of every kind."
        },
        // Verse 48
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐπληρώθη", Transliteration = "eplērōthē", Gloss = "it was full", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "when it was full"
                },
                new Word { Greek = "ἀναβιβάσαντες", Transliteration = "anabibasantes", Gloss = "having drawn up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Word { Greek = "συνέλεξαν", Transliteration = "synelexan", Gloss = "they gathered", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "τὰ", Transliteration = "ta", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "P" }, PartOfSpeech = "art" },
                        new Word { Greek = "καλὰ", Transliteration = "kala", Gloss = "good", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "the good [fish]"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    {
                        new Word { Greek = "εἰς", Transliteration = "eis", Gloss = "into", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἄγγη", Transliteration = "angē", Gloss = "containers", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "into containers"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σαπρὰ", Transliteration = "sapra", Gloss = "bad", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "but the bad"
                },
            ...
            Translation = "When it was full, men drew it ashore and sat down and sorted the good into containers but threw away the bad."
        }
    };
}
...
- Substantival Participle: τοὺς ποιοῦντας (v41), ὁ ἔχων (v43)
- Attributive Participle: θησαυρῷ κεκρυμμένῳ (v44), ἀνθρώπῳ... ζητοῦντι (v45), σαγήνῃ βληθείσῃ (v47)
- Circumstantial Participle: εὑρὼν (v44, 46), ἀπελθὼν (v46), ἀναβιβάσαντες (v48), καθίσαντες (v48)
- Adverbial Clause (Temporal): ὅτε ἐπληρώθη (v48)
*/

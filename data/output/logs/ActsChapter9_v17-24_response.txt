        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "Ἁνανίας", Transliteration = "Hananias", Gloss = "Ananias", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "Ananias"
                },
            ...
            Translation = "So Ananias departed and entered the house."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐπιθεὶς", Transliteration = "epitheis", Gloss = "laying", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "And laying his hands upon him"
                },
                ...
                new Word { Greek = "ἀπέσταλκέν", Transliteration = "apestalken", Gloss = "has sent", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὀφθείς", Transliteration = "ophtheis", Gloss = "having appeared", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἤρχου", Transliteration = "ērchou", Gloss = "you were coming", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "2P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "by which you were coming"
                        }
                    },
                    Translation = "who appeared to you on the road by which you were coming"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀναβλέψῃς", Transliteration = "anablepsēs", Gloss = "you may see again", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "πλησθῇς", Transliteration = "plēsthēs", Gloss = "be filled with", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "2P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "so that you may regain your sight and be filled with the Holy Spirit."
                }
            },
            Translation = "And laying his hands on him he said, 'Brother Saul, the Lord Jesus, who appeared to you on the road by which you were coming, has sent me so that you may regain your sight and be filled with the Holy Spirit.'"
        },
        // Verse 18
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀπέπεσαν", Transliteration = "apepesan", Gloss = "there fell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "αὐτοῦ", Transliteration = "autou", Gloss = "from him", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "prep" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ὡς", Transliteration = "hōs", Gloss = "something like", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "λεπίδες", Transliteration = "lepides", Gloss = "scales", GrammarCodes = new List<string> { "N", "NOM", "F", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "something like scales"
                }
            },
            Translation = "And immediately something like scales fell from his eyes,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "ἀνέβλεψέν", Transliteration = "aneblepsen", Gloss = "he regained sight", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "ἐβαπτίσθη", Transliteration = "ebaptisthē", Gloss = "he was baptized", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and he regained his sight, and he rose and was baptized."
        },
        // Verse 19
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "taking food"
                },
                new Word { Greek = "ἐνίσχυσεν", Transliteration = "enischysen", Gloss = "he was strengthened", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and taking food, he was strengthened."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "Ἐγένετο", Transliteration = "Egeneto", Gloss = "He was", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the disciples in Damascus"
                        }
                    },
                    Translation = "with the disciples in Damascus"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τινὰς", Transliteration = "tinas", Gloss = "some", GrammarCodes = new List<string> { "PRON", "ACC", "F", "P" }, PartOfSpeech = "part" }
                    },
                    Translation = "for some days"
                }
            },
            Translation = "For some days he was with the disciples in Damascus."
        },
        // Verse 20
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐκήρυσσεν", Transliteration = "ekēryssen", Gloss = "he was preaching", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "that He is the Son of God."
                }
            },
            Translation = "And immediately he proclaimed Jesus in the synagogues, saying, 'He is the Son of God.'"
        },
        // Verse 21
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "all those who heard"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "And all who heard him were amazed and were saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the [one]", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "πορθήσας", Transliteration = "porthēsas", Gloss = "who destroyed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "those who call upon this name?"
                        }
                    },
                    Translation = "the one who destroyed in Jerusalem those who call upon this name?"
                }
            },
            Translation = "'Is not this the man who made havoc in Jerusalem of those who called upon this name?'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐληλύθει", Transliteration = "elēlythei", Gloss = "he had come", GrammarCodes = new List<string> { "V", "PLPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "before the chief priests"
                        }
                    },
                    Translation = "that he might bring them bound before the chief priests"
                }
            },
            Translation = "And has he not come here for this purpose, to bring them bound before the chief priests?"
        },
        // Verse 22
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐνεδυναμοῦτο", Transliteration = "enedynamouto", Gloss = "was increasing in strength", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "συνέχυννεν", Transliteration = "synechynnen", Gloss = "was confounding", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "κατοικοῦντας", Transliteration = "katoikountas", Gloss = "living", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "who lived in Damascus"
                        }
                    },
                    Translation = "the Jews who lived in Damascus"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "συμβιβάζων", Transliteration = "symbibazōn", Gloss = "proving", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "proving"
                },
                new Phrase
                {
                    ...
                    Translation = "that this man is the Christ."
                }
            },
            Translation = "But Saul increased all the more in strength, and confounded the Jews who lived in Damascus by proving that Jesus was the Christ."
        },
        // Verse 23
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δὲ", Transliteration = "de", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἐπληροῦντο", Transliteration = "eplērounto", Gloss = "were fulfilled", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἱκαναί", Transliteration = "hikanai", Gloss = "many", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "P" }, PartOfSpeech = "adj" }
                            },
                            Translation = "many days"
                        }
                    },
                    Translation = "When many days had passed"
                },
            ...
            Translation = "When many days had passed, the Jews plotted together to kill him,"
        },
        // Verse 24
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἐγνώσθη", Transliteration = "egnōsthē", Gloss = "became known", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Σαύλῳ", Transliteration = "Saulō", Gloss = "Saul", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "to Saul"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐπιβουλὴ", Transliteration = "epiboulē", Gloss = "plot", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
            ...
            Translation = "but their plot became known to Saul."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "παρετηροῦντο", Transliteration = "paretērounto", Gloss = "they were watching closely", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "also", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τὰς", Transliteration = "tas", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "P" }, PartOfSpeech = "art" },
                        new Word { Greek = "πύλας", Transliteration = "pylas", Gloss = "gates", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                    },
                ...
                new Phrase
                {
                    ...
                    Translation = "both day and night"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PURPOSE_CLAUSE" },
                    ...
                    Translation = "in order to kill him."
                }
            },
            Translation = "They were also watching the gates day and night in order to kill him."
        }
    };
}
...
- Acts 9:17, 9:20, 9:21, 9:22, 9:24: Relative clauses (ὁ ὀφθείς, ᾗ ἤρχου, ὅτι οὗτός ἐστιν, etc.)
- Acts 9:17, 9:21, 9:24: Purpose clauses (ὅπως ἀναβλέψῃς, ἵνα ἀγάγῃ, ὅπως ἀνέλωσιν)
- Acts 9:18, 9:19, 9:22: Participial phrases (ἀναστὰς, λαβὼν τροφὴν, συμβιβάζων)
- Acts 9:23: Temporal clause (Ὡς δὲ ἐπληροῦντο...)
*/

private static List<object> GetChapter9()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "one from the crowd"
                }
            },
            Translation = "And one of the crowd answered him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἤνεγκα", Transliteration = "ēnegka", Gloss = "I brought", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἄλαλον", Transliteration = "alalon", Gloss = "mute", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "a mute spirit"
                        }
                    },
                    Translation = "having a mute spirit"
                }
            },
            Translation = "Teacher, I brought my son to you, having a mute spirit."
        },
        // Verse 18
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καταλάβῃ", Transliteration = "katalabē", Gloss = "it seizes", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "wherever it seizes him"
                },
                new Word { Greek = "ῥήσσει", Transliteration = "rhēssei", Gloss = "it throws down", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἀφρίζει", Transliteration = "aphrizei", Gloss = "he foams", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "τρίζει", Transliteration = "trizei", Gloss = "he gnashes", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ὀδόντας", Transliteration = "odontas", Gloss = "teeth", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "the teeth"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ξηραίνεται", Transliteration = "xērainetai", Gloss = "he withers away", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and wherever it seizes him, it throws him down, and he foams and gnashes his teeth and becomes rigid."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "εἶπα", Transliteration = "eipa", Gloss = "I spoke", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Word { Greek = "ἴσχυσαν", Transliteration = "ischysan", Gloss = "they were strong enough", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "And I spoke to your disciples that they might cast it out, and they were not able."
        },
        // Verse 19
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But he answering them"
                },
                new Word { Greek = "λέγει", Transliteration = "legei", Gloss = "says", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὦ", Transliteration = "ō", Gloss = "O", GrammarCodes = new List<string> { "INTERJ" }, PartOfSpeech = "interj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "VOC" },
                    Content = new List<object>
                    {
                        new Word { Greek = "γενεὰ", Transliteration = "genea", Gloss = "generation", GrammarCodes = new List<string> { "N", "VOC", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "ἄπιστος", Transliteration = "apistos", Gloss = "unbelieving", GrammarCodes = new List<string> { "ADJ", "VOC", "F", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "unbelieving generation"
                }
            },
            Translation = "But he answering them says, 'O unbelieving generation,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔσομαι", Transliteration = "esomai", Gloss = "shall I be", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "how long shall I be with you?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀνέξομαι", Transliteration = "anexomai", Gloss = "shall I bear with", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὑμῶν", Transliteration = "hymōn", Gloss = "you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "P" }, PartOfSpeech = "prep" }
            },
            Translation = "how long shall I bear with you?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "φέρετε", Transliteration = "pherete", Gloss = "bring", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἤνεγκαν", Transliteration = "ēnegkan", Gloss = "they brought", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "And they brought him to him."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "συνεσπάραξεν", Transliteration = "synesparaxen", Gloss = "it convulsed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" }
            },
            Translation = "And when the spirit saw him, immediately it convulsed him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "falling on the ground"
                },
                new Word { Greek = "ἐκυλίετο", Transliteration = "ekylieto", Gloss = "he rolled around", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἀφρίζων", Transliteration = "aphrizōn", Gloss = "foaming", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
            },
            Translation = "and falling on the ground, he rolled around foaming."
        },
        // Verse 21
        new Phrase
        {
            ...
            Translation = "And he asked his father,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πόσος", Transliteration = "posos", Gloss = "how long a", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "q" },
                        new Word { Greek = "χρόνος", Transliteration = "chronos", Gloss = "time", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "how long a time"
                },
                new Word { Greek = "ἐστὶν", Transliteration = "estin", Gloss = "is it", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ὡς", Transliteration = "hōs", Gloss = "since", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                    ...
                    Translation = "since this has happened to him"
                }
            },
            Translation = "'How long a time is it since this has happened to him?'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "παιδιόθεν", Transliteration = "paidiothen", Gloss = "childhood", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
                    },
                    Translation = "From childhood."
                }
            },
            Translation = "And he said, 'From childhood.'"
        },
        // Verse 22
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "into fire"
                },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἔβαλεν", Transliteration = "ebalen", Gloss = "it has thrown", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ἵνα", Transliteration = "hina", Gloss = "in order that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἀπολέσῃ", Transliteration = "apolese", Gloss = "it might destroy", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "that it might destroy him"
                }
            },
            Translation = "And it has often thrown him both into fire and into waters, that it might destroy him."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δύνῃ", Transliteration = "dynē", Gloss = "you are able", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "2P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "if you can do anything"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "σπλαγχνισθεὶς", Transliteration = "splagchnistheis", Gloss = "having compassion", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "having compassion on us"
                }
            },
            Translation = "But if you can do anything, help us, having compassion on us."
        },
        // Verse 23
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "δυνατὰ", Transliteration = "dynata", Gloss = "are possible", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "P" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "IND_OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "πιστεύοντι", Transliteration = "pisteuonti", Gloss = "believing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "to the one who believes."
                }
            },
            Translation = "All things are possible to the one who believes.'"
        },
        // Verse 24
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "κράξας", Transliteration = "kraxas", Gloss = "crying out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "πιστεύω", Transliteration = "pisteuō", Gloss = "I believe", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" }
            },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "my unbelief"
                }
            },
            Translation = "help my unbelief!'"
        }
    };
}
// Identified Constructions:
// Mark 9:17 - Substantive participle (ἔχοντα)
// Mark 9:18 - Temporal clause with ἐὰν + subjunctive (ὅπου ἐὰν ... καταλάβῃ)
// Mark 9:18 - Purpose clause (ἵνα ... ἐκβάλωσιν)
// Mark 9:19 - Attributive participle (ἀποκριθεὶς)
// Mark 9:20 - Temporal participle (ἰδὼν, πεσὼν)
// Mark 9:22 - Purpose clause (ἵνα ἀπολέσῃ)
// Mark 9:22 - Condition clause (εἴ τι δύνῃ)
// Mark 9:22 - Attributive participle (σπλαγχνισθεὶς)
// Mark 9:23 - Articular condition/quotation (τὸ εἰ δύνῃ)
// Mark 9:23 - Articular substantive participle (τῷ πιστεύοντι)
// Mark 9:24 - Attributive participle (κράξας)

        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "a great fear"
                }
            },
            Translation = "And they feared a great fear,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "and they were saying to one another,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the wind and the sea"
                        },
                        new Word { Greek = "ὑπακούει", Transliteration = "hypakouei", Gloss = "obey", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "that even the wind and the sea obey him?"
                }
            },
            Translation = "Who then is this, that even the wind and the sea obey him?"
        }
    };
}
...
- Cognate Accusative: ἐφοβήθησαν φόβον μέγαν (41)
*/

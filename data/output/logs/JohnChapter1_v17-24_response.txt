private static List<object> GetChapter1()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Translation = "For the law was given through Moses; grace and truth came through Jesus Christ."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἑώρακεν", Transliteration = "heōraken", Gloss = "has seen", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "πώποτε", Transliteration = "pōpote", Gloss = "ever", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" }
            },
            Translation = "No one has seen God at any time;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "μονογενὴς", Transliteration = "monogenēs", Gloss = "only-begotten", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "κόλπον", Transliteration = "kolpon", Gloss = "bosom", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                                        new Phrase
                                        {
                                    ...
                                    Translation = "in the bosom of the Father"
                                }
                            },
                            Translation = "who is in the bosom of the Father"
                        }
                    },
                    Translation = "the only-begotten God, who is in the bosom of the Father"
                },
                new Word { Greek = "ἐκεῖνος", Transliteration = "ekeinos", Gloss = "he", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "pron" },
                new Word { Greek = "ἐξηγήσατο", Transliteration = "exēgēsato", Gloss = "has revealed", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "the only-begotten God, who is in the bosom of the Father, he has revealed him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the testimony of John"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "Λευίτας", Transliteration = "Leuitas", Gloss = "Levites", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "priests and Levites"
                        }
                    },
                    Translation = "when the Jews sent priests and Levites from Jerusalem to him"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐρωτήσωσιν", Transliteration = "erōtēsōsin", Gloss = "they might ask", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" },
                    ...
                    Translation = "so that they might ask him, 'Who are you?'"
                }
            },
            Translation = "And this is the testimony of John, when the Jews sent priests and Levites from Jerusalem to him to ask him, 'Who are you?'"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ὡμολόγησεν", Transliteration = "hōmologēsen", Gloss = "confessed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
            ...
            Translation = "And he confessed and did not deny, and he confessed, 'I am not the Christ.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "Are you Elijah?"
                }
            },
            Translation = "And they asked him, 'What then? Are you Elijah?'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "And he says, 'I am not.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "Are you the prophet?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "And he answered, 'No.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ἵνα", Transliteration = "hina", Gloss = "so that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἀπόκρισιν", Transliteration = "apokrisin", Gloss = "answer", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "δῶμεν", Transliteration = "dōmen", Gloss = "we may give", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "πέμψασιν", Transliteration = "pempsasin", Gloss = "ones having sent", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "DAT", "M", "P" }, PartOfSpeech = "v" },
                                new Word { Greek = "ἡμᾶς", Transliteration = "hēmas", Gloss = "us", GrammarCodes = new List<string> { "PRON", "ACC", "1P", "P" }, PartOfSpeech = "pron" }
                            },
                            Translation = "to those who sent us"
                        }
                    },
                    Translation = "so that we may give an answer to those who sent us"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "λέγεις", Transliteration = "legeis", Gloss = "do you say", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "σεαυτοῦ", Transliteration = "seautou", Gloss = "yourself", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "pron" }
                            },
                            Translation = "about yourself"
                        }
                    },
                    Translation = "What do you say about yourself?"
                }
            },
            Translation = "They said therefore to him, 'Who are you, so that we may give an answer to those who sent us? What do you say about yourself?'"
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "a voice of one crying in the wilderness"
                        }
                    },
                    Translation = "'I am the voice of one crying in the wilderness:'"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "DEP_CLAUSE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "εὐθύνατε", Transliteration = "euthynate", Gloss = "make straight", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "'Make straight the way of the Lord,'"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "TEMP_CLAUSE" },
                    ...
                    Translation = "as Isaiah the prophet said."
                }
            },
            Translation = "He said, 'I am the voice of one crying in the wilderness: Make straight the way of the Lord, as Isaiah the prophet said.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "from the Pharisees"
                }
            },
            Translation = "And they had been sent from the Pharisees."
        }
    };
}
...
- PTCP: 1:18 (ὁ ὢν), 1:22 (τοῖς πέμψασιν), 1:23 (βοῶντος)
- GEN_SUBJ: 1:19 (τοῦ Ἰωάννου)
- GEN_DESC: 1:18 (τοῦ πατρὸς), 1:23 (κυρίου)
- PERIPH: 1:24 (ἀπεσταλμένοι ἦσαν)
- APPOS: 1:23 (ὁ προφήτης)
*/

        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "on the other side of the sea"
                },
                new Word { Greek = "εἶπον", Transliteration = "eipon", Gloss = "they said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ῥαββί", Transliteration = "rhabbi", Gloss = "Rabbi", GrammarCodes = new List<string> { "N", "VOC", "M", "S" }, PartOfSpeech = "h" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "γέγονας", Transliteration = "gegonas", Gloss = "you have come to be", GrammarCodes = new List<string> { "V", "PERF", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "when did you come here?"
                }
            },
            Translation = "And when they found him on the other side of the sea, they said to him, 'Rabbi, when did you come here?'"
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ζητεῖτέ", Transliteration = "zēteite", Gloss = "you seek", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἴδετε", Transliteration = "eidete", Gloss = "you saw", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "σημεῖα", Transliteration = "sēmeia", Gloss = "signs", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "because you saw signs"
                },
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "because", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἐφάγετε", Transliteration = "ephagete", Gloss = "you ate", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "of the loaves"
                        },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἐχορτάσθητε", Transliteration = "echortasthēte", Gloss = "were filled", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "2P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "because you ate of the loaves and were filled"
                }
            },
            Translation = "Jesus answered them and said, 'Truly, truly, I say to you, you seek me, not because you saw signs, but because you ate of the loaves and were filled.'"
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἐργάζεσθε", Transliteration = "ergazesthe", Gloss = "work", GrammarCodes = new List<string> { "V", "PRES", "MID", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "βρῶσιν", Transliteration = "brōsin", Gloss = "food", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PTCP" },
                            Content = new List<object>
                            {
                                new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "ἀπολλυμένην", Transliteration = "apollymenēn", Gloss = "perishing", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "ACC", "F", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "which perishes"
                        }
                    },
                    Translation = "the food that perishes"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὴν", Transliteration = "tēn", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "μένουσαν", Transliteration = "menousan", Gloss = "enduring", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "F", "S" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "which endures unto eternal life"
                        }
                    },
                    Translation = "the food that endures unto eternal life"
                },
                new Phrase
                {
                    ...
                    Translation = "which the Son of Man will give to you"
                },
                ...
                new Word { Greek = "ἐσφράγισεν", Transliteration = "esphragisen", Gloss = "has sealed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "Do not work for the food that perishes, but for the food that endures unto eternal life, which the Son of Man will give to you; for on him God the Father has set his seal."
        },
        // Verse 28
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ποιῶμεν", Transliteration = "poiōmen", Gloss = "must we do", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἐργαζώμεθα", Transliteration = "ergazōmetha", Gloss = "we may work", GrammarCodes = new List<string> { "V", "PRES", "MID", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                                    Content = new List<object>
                            ...
                            Translation = "so that we may work the works of God"
                        }
                    },
                    Translation = "what must we do, so that we may work the works of God?"
                }
            },
            Translation = "Then they said to him, 'What must we do, so that we may work the works of God?'"
        },
        // Verse 29
        new Phrase
        {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Translation = "him whom he sent"
                                        }
                                    },
                                    Translation = "in him whom he sent"
                                }
                            },
                            Translation = "that you believe in him whom he sent"
                        }
                    },
                    Translation = "This is the work of God, that you believe in him whom he sent."
                }
            },
            Translation = "Jesus answered and said to them, 'This is the work of God, that you believe in him whom he sent.'"
        },
        // Verse 30
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ποιεῖς", Transliteration = "poieis", Gloss = "do you do", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "ἵνα", Transliteration = "hina", Gloss = "so that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "ἴδωμεν", Transliteration = "idōmen", Gloss = "we may see", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "πιστεύσωμέν", Transliteration = "pisteusōmen", Gloss = "believe", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                                new Word { Greek = "σοι", Transliteration = "soi", Gloss = "you", GrammarCodes = new List<string> { "PRON", "DAT", "2P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "so that we may see and believe you"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                            ...
                            {
                                new Word { Greek = "τί", Transliteration = "ti", Gloss = "what", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "interj" },
                                new Word { Greek = "ἐργάζῃ", Transliteration = "ergazē", Gloss = "do you work", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "2P", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "what do you perform?"
                        }
                    },
                    Translation = "what sign then do you do, so that we may see and believe you? what do you perform?"
                }
            },
            Translation = "Then they said to him, 'What sign then do you do, so that we may see and believe you? What do you perform?'"
        },
        // Verse 31
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            Translation = "bread out of heaven"
                        },
                    ...
                    Translation = "He gave them bread out of heaven to eat"
                }
            },
            Translation = "Our fathers ate the manna in the wilderness; as it is written, 'He gave them bread out of heaven to eat.'"
        },
        // Verse 32
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the bread out of heaven"
                        }
                    },
                    Translation = "not Moses has given you the bread out of heaven"
                },
                new Word { Greek = "ἀλλ᾽", Transliteration = "all'", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Translation = "the true bread out of heaven"
                }
            },
            Translation = "Then Jesus said to them, 'Truly, truly, I say to you, it was not Moses who gave you the bread out of heaven, but my Father gives you the true bread out of heaven.'"
        }
    };
}
...
- John 6:31, 32: PREP_PHRASE with GEN (ἐκ τοῦ οὐρανοῦ) - descriptive genitive.
- John 6:27, 32: PTCP/ADJ used attributively (τὴν ἀπολλυμένην, τὸν ἀληθινόν).
- John 6:25: PTCP used adverbially (εὑρόντες).
*/

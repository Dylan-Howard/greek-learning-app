private static List<object> GetChapter1()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ῥῆμα", Transliteration = "rēma", Gloss = "word", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
            ...
            Translation = "But the word of the Lord remains forever."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "N", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "εὐαγγελισθὲν", Transliteration = "euangelisthen", Gloss = "preached", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "N", "S" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "that was preached to you"
                        }
                    },
                    Translation = "the word that was preached to you"
                }
            },
            Translation = "And this is the word that was preached to you."
        }
    };
}

// Constructions:
// 1:25 - GEN_DESC (κυρίου), PTCP (τὸ εὐαγγελισθὲν εἰς ὑμᾶς)

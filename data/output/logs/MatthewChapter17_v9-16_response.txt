    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "καταβαινόντων", Transliteration = "katabainontōn", Gloss = "to go down", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἴπητε", Transliteration = "eipēte", Gloss = "tell", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "Tell the vision to no one"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐγερθῇ", Transliteration = "egerthē", Gloss = "is raised", GrammarCodes = new List<string> { "V", "AOR", "PASS", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "until the Son of Man is raised from the dead"
                }
            },
            Translation = "And as they were coming down from the mountain, Jesus commanded them, saying, 'Tell the vision to no one, until the Son of Man is raised from the dead.'"
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that Elijah must come first"
                        }
                    },
                    Translation = "Why then do the scribes say that Elijah must come first?"
                }
            },
            Translation = "And the disciples asked him, saying, 'Why then do the scribes say that Elijah must come first?'"
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἀποκαταστήσει", Transliteration = "apokatastēsei", Gloss = "will restore", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "πάντα", Transliteration = "panta", Gloss = "all things", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" }
                    },
                    Translation = "Elijah indeed comes and will restore all things"
                }
            },
            Translation = "He answered and said, 'Elijah indeed comes and will restore all things.'"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "that Elijah already came"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἠθέλησαν", Transliteration = "ēthelēsan", Gloss = "they wished", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "whatever they wished"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὑπ᾽", Transliteration = "hyp'", Gloss = "at the hands of", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                                new Word { Greek = "αὐτῶν", Transliteration = "autōn", Gloss = "them", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "prep" }
                            },
                            Translation = "at their hands"
                        }
                    },
                    Translation = "to suffer at their hands"
                }
            },
            Translation = "But I say to you that Elijah already came, and they did not recognize him, but did to him whatever they wished. So also the Son of Man is about to suffer at their hands."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "συνῆκαν", Transliteration = "synēkan", Gloss = "understood", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "about John the Baptist"
                        },
                    ...
                    Translation = "that he spoke to them about John the Baptist"
                }
            },
            Translation = "Then the disciples understood that he spoke to them about John the Baptist."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "when they had come to the crowd"
                },
                new Word { Greek = "προσῆλθεν", Transliteration = "prosēlthen", Gloss = "came to", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "γονυπετῶν", Transliteration = "gonypetōn", Gloss = "kneeling before", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "kneeling before him"
                }
            },
            Translation = "And when they had come to the crowd, a man came to him, kneeling before him,"
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σεληνιάζεται", Transliteration = "selēniazetai", Gloss = "he has seizures", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "κακῶς", Transliteration = "kakōs", Gloss = "terribly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                    ...
                    Translation = "for he has seizures and suffers terribly"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "πολλάκις", Transliteration = "pollakis", Gloss = "for often", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                    ...
                    Translation = "for he often falls into the fire and often into the water"
                }
            },
            Translation = "and saying, 'Lord, have mercy on my son, for he has seizures and suffers terribly; for he often falls into the fire and often into the water.'"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "προσήνεγκα", Transliteration = "prosēnenka", Gloss = "I brought", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἠδυνήθησαν", Transliteration = "ēdynēthēsan", Gloss = "they were able", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" },
            ...
            Translation = "And I brought him to your disciples, and they were not able to heal him."
        }
    };
}

// Constructions identified:
// GEN_ABS: Verse 9 (καταβαινόντων αὐτῶν), Verse 14 (ἐλθόντων πρὸς τὸν ὄχλον)
// INF_PHRASE: Verse 12 (πάσχειν ὑπ᾽ αὐτῶν), Verse 16 (θεραπεῦσαι)

private static List<object> GetChapter10()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Translation = "Immediately therefore I sent to you,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐποίησας", Transliteration = "epoiēsas", Gloss = "you have done", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Translation = "by coming"
                }
            },
            Translation = "and you have done well in coming."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "πάρεσμεν", Transliteration = "paresmen", Gloss = "are present", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "προστεταγμένα", Transliteration = "prostetagmena", Gloss = "having been commanded", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "ACC", "N", "P" }, PartOfSpeech = "v" }
                                    },
                                    Translation = "commanded"
                                }
                            },
                            Translation = "all things commanded"
                        },
                    ...
                    Translation = "to hear all things commanded you by the Lord"
                }
            },
            Translation = "Now therefore we are all here in the presence of God to hear all that you have been commanded by the Lord."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "Ἀνοίξας", Transliteration = "Anoixas", Gloss = "having opened", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "having opened his mouth"
                },
            ...
            Translation = "So Peter opened his mouth and said:"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "καταλαμβάνομαι", Transliteration = "katalambanomai", Gloss = "I perceive", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "Truly I understand"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "προσωπολήμπτης", Transliteration = "prosōpolēmptēs", Gloss = "respecter of persons", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "that God is no respecter of persons,"
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἐργαζόμενος", Transliteration = "ergazomenos", Gloss = "working", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                            ...
                            Translation = "working righteousness"
                        }
                    },
                    Translation = "the one who fears him and does what is right"
                },
                new Word { Greek = "δεκτὸς", Transliteration = "dektos", Gloss = "acceptable", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to him", GrammarCodes = new List<string> { "PRON", "DAT", "3P", "M", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἐστιν", Transliteration = "estin", Gloss = "is", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "but in every nation anyone who fears him and does what is right is acceptable to him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "which he sent to the sons of Israel"
                }
            },
            Translation = "As for the word that he sent to Israel,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "PTCP" },
            Content = new List<object>
            {
                new Word { Greek = "εὐαγγελιζόμενος", Transliteration = "euangelizomenos", Gloss = "preaching good news of", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "preaching good news of peace through Jesus Christ"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "γενόμενον", Transliteration = "genomenon", Gloss = "having happened", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "ACC", "N", "S" }, PartOfSpeech = "v" }
                            },
                    ...
                    Translation = "the word that happened"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "you yourselves know what happened throughout all Judea,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "PTCP" },
            ...
            Translation = "beginning from Galilee"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "PREP_PHRASE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐκήρυξεν", Transliteration = "ekēryxen", Gloss = "preached", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "Ἰωάννης", Transliteration = "Iōannēs", Gloss = "John", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "which John preached"
                }
            },
            Translation = "after the baptism that John proclaimed:"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ἀπὸ", Transliteration = "apo", Gloss = "from", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "Ναζαρέθ", Transliteration = "Nazareth", Gloss = "Nazareth", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                    },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔχρισεν", Transliteration = "echrisen", Gloss = "anointed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πνεύματι", Transliteration = "pneumati", Gloss = "with Spirit", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" },
                    ...
                    Translation = "with the Holy Spirit and with power"
                }
            },
            Translation = "how God anointed him with the Holy Spirit and with power."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "REL_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "διῆλθεν", Transliteration = "diēlthen", Gloss = "went about", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "εὐεργετῶν", Transliteration = "euergetōn", Gloss = "doing good", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἰώμενος", Transliteration = "iōmenos", Gloss = "healing", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "καταδυναστευομένους", Transliteration = "katadynasteuomenous", Gloss = "being oppressed", GrammarCodes = new List<string> { "V", "PRES", "PASS", "PTCP", "ACC", "M", "P" }, PartOfSpeech = "v" }
                                    },
                                    Translation = "oppressed"
                                }
                            },
                            Translation = "all who were oppressed"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "healing all who were oppressed by the devil"
                }
            },
            Translation = "He went about doing good and healing all who were oppressed by the devil,"
        },
        new Phrase
        {
            ...
            Translation = "for God was with him."
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἡμεῖς", Transliteration = "hēmeis", Gloss = "we [are]", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "P" }, PartOfSpeech = "prep" },
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                ...
                                                new Word { Greek = "χώρᾳ", Transliteration = "chōra", Gloss = "country", GrammarCodes = new List<string> { "N", "DAT", "F", "S"

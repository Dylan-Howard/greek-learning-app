private static List<object> GetChapter12()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀναστῶσιν", Transliteration = "anastōsin", Gloss = "they rise", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "P" }, PartOfSpeech = "v" },
                    },
                    Translation = "For when they rise from the dead"
                },
                new Word { Greek = "οὔτε", Transliteration = "oute", Gloss = "neither", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "γαμοῦσιν", Transliteration = "gamousin", Gloss = "do they marry", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "For when they rise from the dead, they neither marry nor are given in marriage, but are like angels in heaven."
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But concerning the dead"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐγείρονται", Transliteration = "egeirontai", Gloss = "they are raised", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "that they are raised"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the book of Moses"
                        }
                    },
                    Translation = "in the book of Moses"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐπὶ", Transliteration = "epi", Gloss = "in the passage of", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "βάτου", Transliteration = "batou", Gloss = "bush", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "the bush"
                        }
                    },
                    Translation = "in the passage about the bush"
                },
                new Phrase
                {
                    ...
                    Translation = "how God spoke to him in the bush, saying, 'I am the God of Abraham, and the God of Isaac, and the God of Jacob'?"
                }
            },
            Translation = "And as for the dead being raised, have you not read in the book of Moses, in the passage about the bush, how God spoke to him, saying, ‘I am the God of Abraham, and the God of Isaac, and the God of Jacob’?"
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "πολὺ", Transliteration = "polu", Gloss = "greatly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
            ...
            Translation = "He is not the God of the dead, but of the living. You are quite wrong."
        },
        // Verse 28
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "one of the scribes"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "συζητούντων", Transliteration = "suzētountōn", Gloss = "disputing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "them disputing"
                        }
                    },
                    Translation = "having heard them disputing"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that he answered them well"
                        }
                    },
                    Translation = "seeing that he answered them well"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ποία", Transliteration = "poia", Gloss = "which", GrammarCodes = new List<string> { "PRON", "NOM", "F", "S" }, PartOfSpeech = "interj" },
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the first commandment of all"
                        }
                    },
                    Translation = "Which commandment is the first of all?"
                }
            },
            Translation = "And one of the scribes came up and heard them disputing with one another, and seeing that he answered them well, asked him, 'Which commandment is the most important of all?'"
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "πρώτη", Transliteration = "prōtē", Gloss = "the first", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "S" }, PartOfSpeech = "adj" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἄκουε", Transliteration = "akoue", Gloss = "Hear", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "Ἰσραήλ", Transliteration = "Israēl", Gloss = "Israel", GrammarCodes = new List<string> { "N", "VOC", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
            ...
            Translation = "Jesus answered, 'The most important is, \"Hear, O Israel: The Lord our God, the Lord is one.\""
        },
        // Verse 30
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "κύριον", Transliteration = "kurion", Gloss = "Lord", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὅλης", Transliteration = "holēs", Gloss = "all", GrammarCodes = new List<string> { "ADJ", "GEN", "F", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "ψυχῆς", Transliteration = "psuchēs", Gloss = "soul", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "σου", Transliteration = "sou", Gloss = "of you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "all your soul"
                        }
                    },
                    Translation = "and with all your soul"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὅλης", Transliteration = "holēs", Gloss = "all", GrammarCodes = new List<string> { "ADJ", "GEN", "F", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "διανοίας", Transliteration = "dianoias", Gloss = "mind", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "σου", Transliteration = "sou", Gloss = "of you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "all your mind"
                        }
                    },
                    Translation = "and with all your mind"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὅλης", Transliteration = "holēs", Gloss = "all", GrammarCodes = new List<string> { "ADJ", "GEN", "F", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "ἰσχύος", Transliteration = "ischuos", Gloss = "strength", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                new Word { Greek = "σου", Transliteration = "sou", Gloss = "of you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "all your strength"
                        }
                    },
                    Translation = "and with all your strength"
                }
            },
            Translation = "And you shall love the Lord your God with all your heart and with all your soul and with all your mind and with all your strength."
        },
        // Verse 31
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "δευτέρα", Transliteration = "deutera", Gloss = "the second", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "αὕτη", Transliteration = "hautē", Gloss = "is this", GrammarCodes = new List<string> { "PRON", "NOM", "F", "S" }, PartOfSpeech = "adv" },
                new Word { Greek = "ἀγαπήσεις", Transliteration = "agapēseis", Gloss = "you shall love", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                ...
                new Word { Greek = "τούτων", Transliteration = "toutōn", Gloss = "than these", GrammarCodes = new List<string> { "PRON", "GEN", "F", "P" }, PartOfSpeech = "adv" },
            ...
            Translation = "The second is this: ‘You shall love your neighbor as yourself.’ There is no other commandment greater than these."
        },
        // Verse 32
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "εἶπες", Transliteration = "eipes", Gloss = "you have said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὅτι", Transliteration = "hoti", Gloss = "that", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "εἷς", Transliteration = "heis", Gloss = "one", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
            ...
            Translation = "And the scribe said to him, 'You are right, Teacher. You have truly said that he is one, and there is no other besides him.'"
        }
    };
}
...
- GEN_ABS: Verse 28 (αὐτῶν συζητούντων)
- DAT_MANNER: Verse 30 (ἐξ ὅλης τῆς καρδίας σου, etc.)
*/

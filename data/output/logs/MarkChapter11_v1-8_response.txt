private static List<object> GetChapter11()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐγγίζουσιν", Transliteration = "engizousin", Gloss = "they come near", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "at the Mount of Olives"
                        }
                    },
                    Translation = "when they drew near to Jerusalem, to Bethphage and Bethany, at the Mount of Olives"
                },
                new Word { Greek = "ἀποστέλλει", Transliteration = "apostellei", Gloss = "he sends", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "And when they drew near to Jerusalem, to Bethphage and Bethany, at the Mount of Olives, he sent two of his disciples"
        },
        // Verse 2
        new Phrase
        {
            ...
            Content = new List<object>
            {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                ...
                                                new Word { Greek = "κατέναντι", Transliteration = "katenanti", Gloss = "opposite", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                                                new Word { Greek = "ὑμῶν", Transliteration = "hymōn", Gloss = "you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "P" }, PartOfSpeech = "pron" }
                                            },
                                            Translation = "the one opposite you"
                                        }
                                    },
                                    Translation = "the village opposite you"
                                }
                            },
                            Translation = "into the village opposite you"
                        }
                    },
                    Translation = "Go into the village opposite you"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                ...
                new Phrase
                {
                    ...
                    Translation = "on which no one has ever yet sat"
                },
                new Word { Greek = "λύσατε", Transliteration = "lysate", Gloss = "untie", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "φέρετε", Transliteration = "pherete", Gloss = "bring [it]", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "and he says to them, 'Go into the village opposite you, and immediately as you enter it you will find a colt tied, on which no one has ever yet sat; untie it and bring it.'"
        },
        // Verse 3
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "and if anyone says to you, 'Why are you doing this?'"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "the Lord has need of it"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "εὐθὺς", Transliteration = "euthys", Gloss = "immediately", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" },
            ...
            Translation = "And if anyone says to you, 'Why are you doing this?' say, 'The Lord has need of it,' and immediately he will send it back here."
        },
        // Verse 4
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "εὗρον", Transliteration = "heuron", Gloss = "found", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "πῶλον", Transliteration = "pōlon", Gloss = "a colt", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "δεδεμένον", Transliteration = "dedemenon", Gloss = "tied", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "a colt tied"
                },
                new Phrase
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀμφόδου", Transliteration = "amphodou", Gloss = "street", GrammarCodes = new List<string> { "N", "GEN", "N", "S" }, PartOfSpeech = "n" }
                            },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "λύουσιν", Transliteration = "lyousin", Gloss = "they untie", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "it", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" }
            },
            Translation = "And they went away and found a colt tied at a door outside on the street, and they untied it."
        },
        // Verse 5
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "some of those standing there"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ποιεῖτε", Transliteration = "poieite", Gloss = "are you doing", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "λύοντες", Transliteration = "lyontes", Gloss = "untying", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "What are you doing untying the colt?"
                }
            },
            Translation = "And some of those standing there were saying to them, 'What are you doing untying the colt?'"
        },
        // Verse 6
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "had said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                    ...
                    Translation = "just as Jesus had said"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἀφῆκαν", Transliteration = "aphēkan", Gloss = "they let go", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτούς", Transliteration = "autous", Gloss = "them", GrammarCodes = new List<string> { "PRON", "ACC", "M", "P" }, PartOfSpeech = "pron" }
            },
            Translation = "And they said to them just as Jesus had said, and they let them go."
        },
        // Verse 7
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐπιβάλλουσιν", Transliteration = "epiballousin", Gloss = "they lay", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "on it", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "pron" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐκάθισεν", Transliteration = "ekathisen", Gloss = "he sat", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "And they brought the colt to Jesus and threw their garments on it, and he sat on it."
        },
        // Verse 8
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "στιβάδας", Transliteration = "stibadas", Gloss = "leafy branches", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "leafy branches"
                        },
                        new Word { Greek = "κόψαντες", Transliteration = "kopsantes", Gloss = "having cut", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "ἀγρῶν", Transliteration = "agrōn", Gloss = "fields", GrammarCodes = new List<string> { "N", "GEN", "M", "P" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "the fields"
                                }
                            },
                            Translation = "from the fields"
                        }
                    },
                    Translation = "and others leafy branches, having cut [them] from the fields"
                }
            },
            Translation = "And many spread their garments on the road, and others leafy branches, having cut them from the fields."
        }
    };
}
...
- GEN_DESC: Verse 1 ("of Olives", "of his disciples"), Verse 2 ("of men"), Verse 5 ("of those standing there")
- PTCP (Adverbial/Temporal): Verse 2 ("entering"), Verse 5 ("untying"), Verse 8 ("having cut")
- REL_CLAUSE: Verse 2 ("on which no one has ever yet sat")
- COND_CLAUSE: Verse 3 ("if anyone says to you")
- TEMP_CLAUSE: Verse 1 ("when they drew near...")
- CAUSAL_CLAUSE: Verse 6 ("just as Jesus had said")
*/

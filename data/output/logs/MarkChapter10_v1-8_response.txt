private static List<object> GetChapter10()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "to the regions of Judea"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
            ...
            Translation = "And rising up from there, he comes to the regions of Judea and beyond the Jordan."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "συμπορεύονται", Transliteration = "symporeuontai", Gloss = "gather with", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "And crowds gather again to him."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἰώθει", Transliteration = "eiōthei", Gloss = "he was accustomed", GrammarCodes = new List<string> { "V", "PLPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "as he was accustomed"
                },
                new Word { Greek = "πάλιν", Transliteration = "palin", Gloss = "again", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
            ...
            Translation = "And as he was accustomed, he was teaching them again."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "προσελθόντες", Transliteration = "proselthontes", Gloss = "coming up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                    },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "to divorce a wife"
                        }
                    },
                    Translation = "if it is lawful for a man to divorce a wife"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
            ...
            Translation = "And Pharisees, coming up, were asking him if it is lawful for a man to divorce a wife, testing him."
        },
        ...
        new Phrase
        {
            ...
            Translation = "But he, answering, said to them,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "What did Moses command you?"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἐπέτρεψεν", Transliteration = "epetrepsen", Gloss = "permitted", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "to write a certificate of divorce"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
            ...
            Translation = "Moses permitted to write a certificate of divorce and to release [her]."
        },
        ...
        new Phrase
        {
            ...
            Translation = "Because of your hardness of heart he wrote this command for you."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But from the beginning of creation"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "θῆλυ", Transliteration = "thēly", Gloss = "female", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "male and female"
                },
            ...
            Translation = "But from the beginning of creation, He made them male and female."
        },
        ...
        new Phrase
        {
            ...
            Translation = "For this reason a man shall leave his father and his mother and shall be joined to his wife,"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἔσονται", Transliteration = "esontai", Gloss = "they shall be", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "and the two shall be one flesh."
        },
        new Phrase
        {
            ...
            Translation = "so that they are no longer two but one flesh."
        }
    };
}
...
- PTCP: ἀναστὰς (10:1), προσελθόντες (10:2), πειράζοντες (10:2), ἀποκριθεὶς (10:3)
- GEN_DESC: τῆς Ἰουδαίας (10:1), τοῦ Ἰορδάνου (10:1), ἀποστασίου (10:4), κτίσεως (10:6)
- RESULT_CLAUSE: ὥστε... (10:8)
- INF_PHRASE: γυναῖκα ἀπολῦσαι (10:2), βιβλίον ἀποστασίου γράψαι (10:4), ἀπολῦσαι (10:4)
*/

            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἴσην", Transliteration = "isēn", Gloss = "equal", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "δωρεὰν", Transliteration = "dōrean", Gloss = "gift", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the same gift"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πιστεύσασιν", Transliteration = "pisteusasin", Gloss = "having believed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "DAT", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            ...
                            Translation = "on the Lord Jesus Christ"
                        }
                    },
                    Translation = "having believed on the Lord Jesus Christ"
                }
            },
            Translation = "If then God gave the same gift to them as also to us who believed on the Lord Jesus Christ,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "κωλῦσαι", Transliteration = "kōlysai", Gloss = "to hinder", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "to hinder God"
                }
            },
            Translation = "who was I, that I could hinder God?"
        },
        // Verse 18
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "When they heard these things"
                },
                new Word { Greek = "ἡσύχασαν", Transliteration = "hēsychasan", Gloss = "they were silent", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
            ...
            Translation = "When they heard these things they fell silent, and they glorified God,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "PTCP" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "unto life"
                        },
                        new Word { Greek = "ἔδωκεν", Transliteration = "edōken", Gloss = "has given", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "Then to the Gentiles also God has granted repentance unto life."
                }
            },
            Translation = "saying, 'Then to the Gentiles also God has granted repentance unto life.'"
        },
        // Verse 19
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "μὲν", Transliteration = "men", Gloss = "now", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "οὖν", Transliteration = "oun", Gloss = "therefore", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PTCP" },
                            Content = new List<object>
                            {
                                new Word { Greek = "διασπαρέντες", Transliteration = "diasparentes", Gloss = "having been scattered", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Content = new List<object>
                                            {
                                                ...
                                                new Word { Greek = "θλίψεως", Transliteration = "thlipseōs", Gloss = "persecution", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                                            },
                                            Translation = "the persecution"
                                        }
                                    },
                                    Translation = "from the persecution"
                                },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "PTCP" },
                                    ...
                                    {
                                        new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                        new Word { Greek = "γενομένης", Transliteration = "genomenēs", Gloss = "having arisen", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "GEN", "F", "S" }, PartOfSpeech = "v" },
                                        new Phrase
                                        {
                                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                            Content = new List<object>
                                            {
                                                ...
                                                new Word { Greek = "Στεφάνῳ", Transliteration = "Stephanō", Gloss = "Stephen", GrammarCodes = new List<string> { "N", "DAT", "M", "S" }, PartOfSpeech = "n" }
                                            },
                                            Translation = "over Stephen"
                                        }
                                    },
                                    Translation = "that arose over Stephen"
                                }
                            },
                            Translation = "who were scattered because of the persecution that arose over Stephen"
                        }
                    },
                    Translation = "Now those who were scattered because of the persecution that arose over Stephen"
                },
                new Word { Greek = "διῆλθον", Transliteration = "diēlthon", Gloss = "traveled", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Φοινίκης", Transliteration = "Phoinikēs", Gloss = "Phoenicia", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "Κύπρου", Transliteration = "Kyprou", Gloss = "Cyprus", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "Ἀντιοχείας", Transliteration = "Antiocheias", Gloss = "Antioch", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "as far as Phoenicia and Cyprus and Antioch"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "except to Jews only"
                        }
                    },
                    Translation = "speaking the word to no one except to Jews only"
                }
            },
            Translation = "Now those who were scattered because of the persecution that arose over Stephen traveled as far as Phoenicia and Cyprus and Antioch, speaking the word to no one except to Jews only."
        },
        // Verse 20
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "Ἦσαν", Transliteration = "Hēsan", Gloss = "were", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "Κύπριοι", Transliteration = "Kyprioi", Gloss = "Cypriots", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "n" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "Κυρηναῖοι", Transliteration = "Kyrēnaioi", Gloss = "Cyrenians", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "n" }
            },
            Translation = "But there were some of them, men of Cyprus and Cyrene,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "who, when they came to Antioch"
                },
                new Word { Greek = "ἐλάλουν", Transliteration = "elaloun", Gloss = "were speaking", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "also", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "Ἑλληνιστὰς", Transliteration = "Hellēnistas", Gloss = "Hellenists", GrammarCodes = new List<string> { "N", "ACC", "M", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "the Hellenists"
                        }
                    },
                    Translation = "to the Hellenists"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "εὐαγγελιζόμενοι", Transliteration = "euangelizomenoi", Gloss = "preaching", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "preaching the Lord Jesus"
                }
            },
            Translation = "who, when they came to Antioch, began speaking to the Hellenists also, preaching the Lord Jesus."
        },
        // Verse 21
        new Phrase
        {
            ...
            Translation = "And the hand of the Lord was with them,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πολύς", Transliteration = "polys", Gloss = "a large", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "that", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "πιστεύσας", Transliteration = "pisteusas", Gloss = "believed", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "that believed"
                        }
                    },
                    Translation = "and a large number that believed"
                },
                new Word { Greek = "ἐπέστρεψεν", Transliteration = "epestrepsen", Gloss = "turned", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "and a large number that believed turned to the Lord."
        },
        // Verse 22
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "λόγος", Transliteration = "logos", Gloss = "report", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "which was in Jerusalem"
                                }
                            },
                            Translation = "of the church which was in Jerusalem"
                        }
                    },
                    Translation = "into the ears of the church which was in Jerusalem"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
            ...
            Translation = "The report about them was heard in the ears of the church in Jerusalem,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐξαπέστειλαν", Transliteration = "exapesteilan", Gloss = "they sent out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "as far as Antioch"
                        }
                    },
                    Translation = "to go as far as Antioch"
                }
            },
            Translation = "and they sent out Barnabas to go as far as Antioch."
        },
        // Verse 23
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "when he came and had seen the grace of God"
                },
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "παρεκάλει", Transliteration = "parekalei", Gloss = "was exhorting", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "προθέσει", Transliteration = "prothesei", Gloss = "purpose", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                    ...
                    Translation = "with purpose of heart"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INF_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "προσμένειν", Transliteration = "prosmenein", Gloss = "to remain true", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                    ...
                    Translation = "to remain true to the Lord"
                }
            },
            Translation = "who, when he came and had seen the grace of God, was glad, and he was exhorting them all that with purpose of heart they should remain true to the Lord;"
        },
        // Verse 24
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "full of the Holy Spirit and of faith"
                }
            },
            Translation = "for he was a good man, and full of the Holy Spirit and of faith."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἱκανὸς", Transliteration = "hikanos", Gloss = "considerable", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "a considerable crowd"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "IND_OBJ" },
            ...
            Translation = "And a considerable crowd was added to the Lord."
        }
    };
}
/*
Constructions Identified:
- Acts 11:17: Comparative construction (ὡς καὶ ἡμῖν)
- Acts 11:18: PTCP construction (Ἀκούσαντες δὲ ταῦτα)
- Acts 11:23: DAT_MANNER (τῇ προθέσει τῆς καρδίας)
- Acts 11:24: Adjective phrase governing genitives (πλήρης πνεύματος ἁγίου καὶ πίστεως)
*/

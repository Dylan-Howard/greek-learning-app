                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "this authority of yours"
                        },
                        new Word { Greek = "πρόσκομμα", Transliteration = "proskomma", Gloss = "a stumbling block", GrammarCodes = new List<string> { "N", "NOM", "N", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "γένηται", Transliteration = "genētai", Gloss = "might become", GrammarCodes = new List<string> { "V", "AOR", "MID", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "lest somehow this authority of yours becomes a stumbling block to the weak"
                }
            },
            Translation = "But see to it that somehow this authority of yours does not become a stumbling block to the weak."
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἴδῃ", Transliteration = "idē", Gloss = "should see", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "the one having knowledge"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "εἰδωλείῳ", Transliteration = "eidōleiō", Gloss = "an idol's temple", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "in an idol's temple"
                },
                new Word { Greek = "κατακείμενον", Transliteration = "katakeimenon", Gloss = "dining", GrammarCodes = new List<string> { "V", "PRES", "MP", "PTCP", "ACC", "M", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "οὐχὶ", Transliteration = "ouchi", Gloss = "will not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀσθενοῦς", Transliteration = "asthenous", Gloss = "being weak", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "S" }, PartOfSpeech = "adj" },
                            ...
                            Translation = "he being weak"
                        }
                    },
                    Translation = "the conscience of him who is weak"
                },
                new Word { Greek = "οἰκοδομηθήσεται", Transliteration = "oikodomēthēsetai", Gloss = "be emboldened", GrammarCodes = new List<string> { "V", "FUT", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "things sacrificed to idols"
                        },
                        new Word { Greek = "ἐσθίειν", Transliteration = "esthiein", Gloss = "eat", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" }
                    },
                    Translation = "to eat things sacrificed to idols"
                }
            },
            Translation = "For if someone sees you, who have knowledge, dining in an idol's temple, will not the conscience of him who is weak be emboldened to eat things sacrificed to idols?"
        },
        // Verse 11
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "ἀπόλλυται", Transliteration = "apollytai", Gloss = "is destroyed", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀσθενῶν", Transliteration = "asthenōn", Gloss = "weak", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "the weak one"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σῇ", Transliteration = "sē", Gloss = "your", GrammarCodes = new List<string> { "ADJ", "DAT", "F", "S" }, PartOfSpeech = "s" },
                        new Word { Greek = "γνώσει", Transliteration = "gnōsei", Gloss = "knowledge", GrammarCodes = new List<string> { "N", "DAT", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "by your knowledge"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "APPOS" },
            ...
            Translation = "For the weak person is destroyed by your knowledge, the brother for whom Christ died."
        },
        // Verse 12
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "sinning against the brothers"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "τύπτοντες", Transliteration = "typtontes", Gloss = "wounding", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἀσθενοῦσαν", Transliteration = "asthenousan", Gloss = "being weak", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "ACC", "F", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "their weak conscience"
                        }
                    },
                    Translation = "wounding their weak conscience"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                ...
                new Word { Greek = "ἁμαρτάνετε", Transliteration = "hamartanete", Gloss = "you sin", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "Thus, sinning against the brothers and wounding their weak conscience, you sin against Christ."
        },
        // Verse 13
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σκανδαλίζει", Transliteration = "skandalizei", Gloss = "makes to stumble", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                            Content = new List<object>
                    ...
                    Translation = "if food makes my brother stumble"
                },
                new Word { Greek = "οὐ", Transliteration = "ou", Gloss = "never", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "φάγω", Transliteration = "phagō", Gloss = "will I eat", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σκανδαλίσω", Transliteration = "skandalisō", Gloss = "I make to stumble", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "so that I might not make my brother stumble"
                }
            },
            Translation = "Therefore, if food makes my brother stumble, I will never eat meat again, so that I might not make my brother stumble."
        }
    };
}
...
- GEN_ABS: Verse 10 (αὐτοῦ ἀσθενοῦς ὄντος)
*/

    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐξήρχοντο", Transliteration = "exērchonto", Gloss = "were going out", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀρξάμενοι", Transliteration = "arxamenoi", Gloss = "having begun", GrammarCodes = new List<string> { "V", "AOR", "MID", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Word { Greek = "πρεσβυτέρων", Transliteration = "presbyterōn", Gloss = "older ones", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "P" }, PartOfSpeech = "adj" }
                                    },
                                    Translation = "the older ones"
                                }
                            },
                            Translation = "from the older ones"
                        }
                    },
                    Translation = "having begun from the older ones"
                }
            },
            Translation = "But having heard, they were going out one by one, having begun from the older ones."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "κατελείφθη", Transliteration = "kateleiphthē", Gloss = "he was left", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "being in the middle"
                }
            },
            Translation = "And he was left alone, and the woman being in the middle."
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀνακύψας", Transliteration = "anakypsas", Gloss = "having straightened up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "having straightened up"
                },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "but", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                ...
                new Word { Greek = "εἰσιν", Transliteration = "eisin", Gloss = "are they", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Word { Greek = "κατέκρινεν", Transliteration = "katek rinen", Gloss = "condemned", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "Straightening up, Jesus said to her, 'Woman, where are they? Has no one condemned you?'"
        },
        // Verse 11
        new Phrase
        {
            ...
            Translation = "She said, 'No one, Lord.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "σε", Transliteration = "se", Gloss = "you", GrammarCodes = new List<string> { "PRON", "ACC", "2P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "κατακρίνω", Transliteration = "katakrinō", Gloss = "condemn", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "And Jesus said, 'Neither do I condemn you;'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἁμάρτανε", Transliteration = "hamartane", Gloss = "sin", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "go, and from now on sin no longer.'"
        },
        // Verse 12
        new Phrase
        {
            ...
            Translation = "Again therefore Jesus spoke to them, saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the light of the world"
                }
            },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ἀκολουθῶν", Transliteration = "akolouthōn", Gloss = "following", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                                new Word { Greek = "ἐμοὶ", Transliteration = "emoi", Gloss = "me", GrammarCodes = new List<string> { "PRON", "DAT", "1P", "S" }, PartOfSpeech = "prep" }
                            },
                            Translation = "following me"
                        }
                    },
                    Translation = "the one following me"
                },
                new Word { Greek = "οὐ", Transliteration = "ou", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "certainly not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "περιπατήσῃ", Transliteration = "peripatēsē", Gloss = "will walk", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Word { Greek = "ἕξει", Transliteration = "hexei", Gloss = "will have", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Translation = "the light of life"
                }
            },
            Translation = "the one following me will certainly not walk in darkness, but will have the light of life.'"
        },
        // Verse 13
        new Phrase
        {
            ...
            Translation = "The Pharisees therefore said to him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "σεαυτοῦ", Transliteration = "seautou", Gloss = "yourself", GrammarCodes = new List<string> { "PRON", "GEN", "M", "S" }, PartOfSpeech = "f" }
                    },
                    Translation = "about yourself"
                },
                new Word { Greek = "μαρτυρεῖς", Transliteration = "martyreis", Gloss = "testify", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "'You testify about yourself;'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀληθής", Transliteration = "alēthēs", Gloss = "true", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "S" }, PartOfSpeech = "adj" }
            },
            Translation = "your testimony is not true.'"
        },
        // Verse 14
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "μαρτυρῶ", Transliteration = "martyrō", Gloss = "testify", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    ...
                    Translation = "about myself"
                }
            },
            Translation = "'Even if I testify about myself,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "my testimony"
                }
            },
            Translation = "my testimony is true,"
        },
        new Phrase
        {
            ...
            Translation = "because I know from where I came and where I go;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "πόθεν", Transliteration = "pothen", Gloss = "from where", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἔρχομαι", Transliteration = "erchomai", Gloss = "I come", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἢ", Transliteration = "ē", Gloss = "or", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ποῦ", Transliteration = "pou", Gloss = "where", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "ὑπάγω", Transliteration = "hypagō", Gloss = "I go", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "but you do not know from where I come or where I go."
        },
        // Verse 15
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κρίνετε", Transliteration = "krinete", Gloss = "judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "You judge according to the flesh;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "ἐγὼ", Transliteration = "egō", Gloss = "I", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "οὐ", Transliteration = "ou", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "κρίνω", Transliteration = "krinō", Gloss = "judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "οὐδένα", Transliteration = "oudena", Gloss = "no one", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" }
            },
            Translation = "I judge no one."
        },
        // Verse 16
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κρίνω", Transliteration = "krinō", Gloss = "judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "1P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "however", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐγώ", Transliteration = "egō", Gloss = "I", GrammarCodes = new List<string> { "PRON", "NOM", "1P", "S" }, PartOfSpeech = "prep" }
            },
            Translation = "And if I judge however,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀληθινή", Transliteration = "alēthinē", Gloss = "true", GrammarCodes = new List<string> { "ADJ", "NOM", "F", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἐστιν", Transliteration = "estin", Gloss = "is", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "my judgment is true,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "CAUSAL_CLAUSE" },
            ...
            Translation = "because I am not alone, but I and the Father who sent me."
        }
    };
}

/* Identified Constructions:
- John 8:9: Adjectival Participle (οἱ ἀκούσαντες) used substantivally.
- John 8:9: Adjectival Participle (ἀρξάμενοι) circumstantial.
- John 8:9: Adjectival Participle (οὖσα) circumstantial.
- John 8:10: Adjectival Participle (ἀνακύψας) circumstantial.
- John 8:12: Substantival Participle (ὁ ἀκολουθῶν).
- John 8:14: Conditional Clause (κἂν ... μαρτυρῶ).
- John 8:14: Causal Clause (ὅτι οἶδα ...).
- John 8:16: Conditional Clause (ἐὰν κρίνω ...).
- John 8:16: Attributive Participle (ὁ πέμψας με πατήρ).
*/

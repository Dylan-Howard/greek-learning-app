        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "πνευματικῶν", Transliteration = "pneumatikōn", Gloss = "spiritual [gifts]", GrammarCodes = new List<string> { "ADJ", "GEN", "N", "P" }, PartOfSpeech = "adj" }
                            },
                            Translation = "the spiritual [gifts]"
                        }
                    },
                    Translation = "Now concerning spiritual [gifts]"
                },
                ...
                new Phrase
                {
                    ...
                    Translation = "to be uninformed"
                }
            },
            Translation = "Now concerning spiritual gifts, brothers, I do not want you to be uninformed."
        },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἔθνη", Transliteration = "ethnē", Gloss = "pagans", GrammarCodes = new List<string> { "N", "NOM", "N", "P" }, PartOfSpeech = "n" },
                                new Word { Greek = "ἦτε", Transliteration = "ēte", Gloss = "you were", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "when you were pagans"
                        },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            {
                                                new Word { Greek = "τὰ", Transliteration = "ta", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "P" }, PartOfSpeech = "art" },
                                                new Word { Greek = "ἄφωνα", Transliteration = "aphōna", Gloss = "mute", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "P" }, PartOfSpeech = "adj" }
                                            },
                                            Translation = "the mute"
                                        }
                                    },
                                    Translation = "the mute idols"
                                }
                            },
                            Translation = "to the mute idols"
                        },
                        new Word { Greek = "ὡς", Transliteration = "hōs", Gloss = "however", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἂν", Transliteration = "an", Gloss = "[potential particle]", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἤγεσθε", Transliteration = "ēgesthe", Gloss = "you were led", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "2P", "P" }, PartOfSpeech = "v" },
                        new Word { Greek = "ἀπαγόμενοι", Transliteration = "apagomenoi", Gloss = "being led away", GrammarCodes = new List<string> { "V", "PRES", "PASS", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "that when you were pagans, you were led away to mute idols, however you were led."
                }
            },
            Translation = "You know that when you were pagans you were led astray to mute idols, however you were led."
        },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "Jesus be accursed"
                                }
                            },
                            Translation = "no one speaking by the Spirit of God says 'Jesus be accursed'"
                        },
                        ...
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "οὐδεὶς", Transliteration = "oudeis", Gloss = "no one", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                                new Word { Greek = "δύναται", Transliteration = "dynatai", Gloss = "can", GrammarCodes = new List<string> { "V", "PRES", "MP", "IND", "3P", "S" }, PartOfSpeech = "v" },

private static List<object> GetChapter27()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ῥηθὲν", Transliteration = "rhēthen", Gloss = "having been spoken", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "N", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                    ...
                    Translation = "that which was spoken through Jeremiah the prophet"
                },
            ...
            Translation = "Then was fulfilled what had been spoken through Jeremiah the prophet, saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τιμὴν", Transliteration = "timēn", Gloss = "price", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "τετιμημένου", Transliteration = "tetimēmenou", Gloss = "having been priced", GrammarCodes = new List<string> { "V", "PERF", "PASS", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "of him who had been priced"
                        }
                    },
                    Translation = "the price of him on whom a price had been set"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἐτιμήσαντο", Transliteration = "etimēsanto", Gloss = "they set a price on", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            ...
                            Translation = "from the sons of Israel"
                        }
                    },
                    Translation = "whom they of the sons of Israel did price"
                }
            },
            Translation = "And they took the thirty pieces of silver, the price of him on whom a price had been set by some of the sons of Israel,"
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "for the potter's field"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "καθὰ", Transliteration = "katha", Gloss = "as", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "συνέταξέν", Transliteration = "synetaxen", Gloss = "commanded", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                    ...
                    Translation = "as the Lord directed me."
                }
            },
            Translation = "and they gave them for the potter's field, as the Lord directed me."
        },
        // Verse 11
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "Now Jesus"
                },
                new Word { Greek = "ἐστάθη", Transliteration = "estathē", Gloss = "stood", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    ...
                    Translation = "before the governor"
                }
            },
            Translation = "Now Jesus stood before the governor,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "ἡγεμὼν", Transliteration = "hēgemōn", Gloss = "governor", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the governor"
                },
            ...
            Translation = "and the governor asked him, saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "σὺ", Transliteration = "sy", Gloss = "You", GrammarCodes = new List<string> { "PRON", "NOM", "2P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "λέγεις", Transliteration = "legeis", Gloss = "say [so]", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "“You have said so.”"
                }
            },
            Translation = "And Jesus said, “You have said so.”"
        },
        // Verse 12
        new Phrase
        {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "κατηγορεῖσθαι", Transliteration = "katēgoreisthai", Gloss = "being accused", GrammarCodes = new List<string> { "V", "PRES", "PASS", "INF" }, PartOfSpeech = "v" },
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        ...
                                        new Phrase
                                        {
                                            ...
                                            Translation = "the chief priests and elders"
                                        }
                                    },
                                    Translation = "by the chief priests and elders"
                                }
                            },
                            Translation = "he was being accused by the chief priests and elders"
                        }
                    },
                    Translation = "while he was being accused by the chief priests and elders"
                },
                new Word { Greek = "οὐδὲν", Transliteration = "ouden", Gloss = "nothing", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἀπεκρίνατο", Transliteration = "apekrinato", Gloss = "he answered", GrammarCodes = new List<string> { "V", "AOR", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "But when he was accused by the chief priests and elders, he gave no answer."
        },
        // Verse 13
        new Phrase
        {
            ...
            Translation = "Then Pilate said to him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀκούεις", Transliteration = "akoueis", Gloss = "Do you hear", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "πόσα", Transliteration = "posa", Gloss = "how many things", GrammarCodes = new List<string> { "Q", "ACC", "N", "P" }, PartOfSpeech = "q" },
                        new Word { Greek = "σου", Transliteration = "sou", Gloss = "against you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "καταμαρτυροῦσιν", Transliteration = "katamartyrousin", Gloss = "they testify", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "how many things they testify against you?"
                }
            },
            Translation = "“Do you not hear how many things they testify against you?”"
        },
        // Verse 14
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "And", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "PRT" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἀπεκρίθη", Transliteration = "apekrithē", Gloss = "he answered", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Translation = "to even a single word"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "θαυμάζειν", Transliteration = "thaumazein", Gloss = "wondered", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                            Content = new List<object>
                    ...
                    Translation = "so that the governor wondered greatly."
                }
            },
            Translation = "But he gave him no answer, not even to a single charge, so that the governor was greatly amazed."
        },
        // Verse 15
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "δὲ", Transliteration = "de", Gloss = "Now", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "ἑορτὴν", Transliteration = "heortēn", Gloss = "the feast", GrammarCodes = new List<string> { "N", "ACC", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "Now at the feast"
                },
                new Word { Greek = "εἰώθει", Transliteration = "eiōthei", Gloss = "was accustomed", GrammarCodes = new List<string> { "V", "PLPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀπολύειν", Transliteration = "apolyein", Gloss = "to release", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                        ...
                        new Word { Greek = "δέσμιον", Transliteration = "desmion", Gloss = "prisoner", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "REL_CLAUSE" },
                            Content = new List<object>
                            {
                                new Word { Greek = "ὃν", Transliteration = "hon", Gloss = "whom", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" },
                                new Word { Greek = "ἤθελον", Transliteration = "ēthelon", Gloss = "they wanted", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "whom they wanted"
                        }
                    },
                    Translation = "to release one prisoner to the crowd, whom they wanted"
                }
            },
            Translation = "Now at the feast the governor was accustomed to release for the crowd any one prisoner whom they wanted."
        },
        // Verse 16
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "δέσμιον", Transliteration = "desmion", Gloss = "prisoner", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "ἐπίσημον", Transliteration = "episēmon", Gloss = "notorious", GrammarCodes = new List<string> { "ADJ", "ACC", "M", "S" }, PartOfSpeech = "adj" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "Βαραββᾶν", Transliteration = "Barabbān", Gloss = "Barabbas", GrammarCodes = new List<string> { "N", "ACC", "M", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "called Jesus Barabbas"
                        }
                    },
                    Translation = "a notorious prisoner called Barabbas"
                }
            },
            Translation = "And they had then a notorious prisoner called Barabbas."
        }
    };
}
...
- APPOS: Matthew 27:9 ("the price of him...")
- INF_PHRASE: Matthew 27:12 (en to kategoreisthai), Matthew 27:15 (apolyein)
- RESULT_CLAUSE: Matthew 27:14 (hoste thaumazein)
*/

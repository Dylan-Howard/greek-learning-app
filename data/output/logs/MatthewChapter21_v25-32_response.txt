private static List<object> GetChapter21()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "GEN", "M", "S" }, PartOfSpeech = "art" },
            ...
            Translation = "The baptism of John, from where was it? From heaven or from men?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "διελογίζοντο", Transliteration = "dielogizonto", Gloss = "reasoned", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "And they reasoned among themselves, saying,"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "εἴπωμεν", Transliteration = "eipōmen", Gloss = "we should say", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "διὰ", Transliteration = "dia", Gloss = "why", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                new Word { Greek = "τί", Transliteration = "ti", Gloss = "then", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "interj" },
                new Word { Greek = "οὖν", Transliteration = "oun", Gloss = "therefore", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἐπιστεύσατε", Transliteration = "episteusate", Gloss = "did you believe", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" }
            },
            Translation = "he will say to us, 'Why then did you not believe him?'"
        },
        // Verse 26
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Word { Greek = "φοβούμεθα", Transliteration = "phoboumetha", Gloss = "we fear", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "1P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔχουσιν", Transliteration = "echousin", Gloss = "hold", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "for all hold John as a prophet."
        },
        // Verse 27
        new Phrase
        {
            ...
            Translation = "And answering Jesus they said, 'We do not know.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "λέγω", Transliteration = "legō", Gloss = "tell", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "1P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "He also said to them, 'Neither do I tell you by what authority I do these things.'"
        },
        // Verse 28
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Translation = "A man had two children;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "and coming to the first he said,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐργάζου", Transliteration = "ergazou", Gloss = "work", GrammarCodes = new List<string> { "V", "PRES", "MID", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    ...
                    Translation = "in the vineyard"
                }
            },
            Translation = "'Child, go work today in the vineyard.'"
        },
        // Verse 29
        new Phrase
        {
            ...
            Translation = "But he answering said, 'I will not;'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "μεταμεληθεὶς", Transliteration = "metamelētheis", Gloss = "regretting", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "regretting"
                },
                new Word { Greek = "ἀπῆλθεν", Transliteration = "apēlthen", Gloss = "he went", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "but later regretting it, he went."
        },
        // Verse 30
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τῷ", Transliteration = "tō", Gloss = "the", GrammarCodes = new List<string> { "ART", "DAT", "M", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "ἑτέρῳ", Transliteration = "heterō", Gloss = "other", GrammarCodes = new List<string> { "ADJ", "DAT", "M", "S" }, PartOfSpeech = "adj" }
                    },
                    Translation = "to the other"
                },
                new Word { Greek = "εἶπεν", Transliteration = "eipen", Gloss = "he said", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ὡσαύτως", Transliteration = "hōsautōs", Gloss = "similarly", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
            },
            Translation = "And coming to the other he said similarly."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "But he answering said, 'I [will go], lord;'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "the will of the father"
                }
            },
            Translation = "Which of the two did the will of the father?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "They say, 'The first.'"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "πόρναι", Transliteration = "pornai", Gloss = "prostitutes", GrammarCodes = new List<string> { "N", "NOM", "F", "P" }, PartOfSpeech = "n" }
                            },
                            Translation = "the tax collectors and the prostitutes"
                        },
                        new Word { Greek = "προάγουσιν", Transliteration = "proagousin", Gloss = "go before", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                    ...
                    Translation = "that the tax collectors and the prostitutes go before you into the kingdom of God."
                }
            },
            Translation = "Truly I say to you that the tax collectors and the prostitutes go before you into the kingdom of God."
        },
        // Verse 32
        new Phrase
        {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "a way of righteousness"
                        }
                    },
                    Translation = "in a way of righteousness"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "οὐκ", Transliteration = "ouk", Gloss = "not", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "prep" },
            ...
            Translation = "For John came to you in the way of righteousness, and you did not believe him;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "but the tax collectors and the prostitutes"
                },
            ...
            Translation = "but the tax collectors and the prostitutes believed him."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "οὐδὲ", Transliteration = "oude", Gloss = "neither", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "μετεμελήθητε", Transliteration = "metamelēthēte", Gloss = "regretted", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "2P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "ὕστερον", Transliteration = "hysteron", Gloss = "later", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Phrase
                {
                    ...
                    Translation = "to believe him"
                }
            },
            Translation = "And you, having seen, did not even regret it later to believe him."
        }
    };
}
...
- NOUN_PHRASE/SUBJ: Matthew 21:25, 26, 28, 29, 30, 31, 32
- NOUN_PHRASE/OBJ: Matthew 21:26, 28, 31
- NOUN_PHRASE/IND_OBJ: Matthew 21:27, 28, 30
- PREP_PHRASE: Matthew 21:25, 26, 27, 28, 31, 32
- COND_CLAUSE: Matthew 21:25, 26
- PTCP (Adverbial/Circumstantial): Matthew 21:25, 27, 28, 29, 30, 32
- CAUSAL_CLAUSE: Matthew 21:26, 31
- INF_PHRASE (Articular Infinitive): Matthew 21:32
*/

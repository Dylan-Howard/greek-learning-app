    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "δόξητε", Transliteration = "doxēte", Gloss = "think", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "2P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "And do not think to say within yourselves,"
        },
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "that God is able from these stones to raise up children for Abraham"
                }
            },
            Translation = "for I say to you that God is able from these stones to raise up children for Abraham."
        },
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἀξίνη", Transliteration = "axinē", Gloss = "axe", GrammarCodes = new List<string> { "N", "NOM", "F", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the axe"
                },
                new Phrase
                {
                    ...
                    Translation = "at the root of the trees"
                },
                new Word { Greek = "κεῖται", Transliteration = "keitai", Gloss = "laid", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "Even now the axe is laid at the root of the trees."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "that does not bear good fruit"
                        }
                    },
            ...
            Translation = "Therefore every tree that does not bear good fruit is cut down and thrown into the fire."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "for repentance"
                }
            },
            Translation = "I indeed baptize you with water for repentance,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἰσχυρότερός", Transliteration = "ischyroteros", Gloss = "mightier", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
                new Word { Greek = "μού", Transliteration = "mou", Gloss = "than I", GrammarCodes = new List<string> { "PRON", "GEN", "1P", "S" }, PartOfSpeech = "prep" },
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Phrase
                                {
                                    ...
                                    Translation = "the sandals"
                                },
                                new Word { Greek = "βαστάσαι", Transliteration = "bastasai", Gloss = "to carry", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" }
                            },
                            Translation = "to carry the sandals"
                        }
                    },
                    Translation = "whose sandals I am not worthy to carry"
                }
            },
            Translation = "but He who is coming after me is mightier than I, whose sandals I am not worthy to carry."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ὑμᾶς", Transliteration = "hymas", Gloss = "you", GrammarCodes = new List<string> { "PRON", "ACC", "2P", "P" }, PartOfSpeech = "prep" },
                new Word { Greek = "βαπτίσει", Transliteration = "baptisei", Gloss = "will baptize", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE", "DAT_INSTR" },
                    Content = new List<object>
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "His winnowing fork"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    ...
                    Translation = "is in His hand"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "διακαθαριεῖ", Transliteration = "diakathariei", Gloss = "He will thoroughly clear", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "συνάξει", Transliteration = "synaxei", Gloss = "He will gather", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the barn"
                        }
                    },
                    Translation = "into the barn"
                }
            },
            Translation = "His winnowing fork is in His hand, and He will thoroughly clear His threshing floor and gather His wheat into the barn,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "παραγίνεται", Transliteration = "paraginetai", Gloss = "came", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
            ...
            Translation = "Then Jesus came from Galilee to the Jordan to John, to be baptized by him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Translation = "But John"
                },
                new Word { Greek = "διεκώλυεν", Transliteration = "diekōlyen", Gloss = "tried to prevent", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
            ...
            Translation = "But John tried to prevent him, saying,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "to be baptized by you"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "σὺ", Transliteration = "sy", Gloss = "you", GrammarCodes = new List<string> { "PRON", "NOM", "2P", "S" }, PartOfSpeech = "prep" },
                new Word { Greek = "ἔρχῃ", Transliteration = "erchē", Gloss = "are coming", GrammarCodes = new List<string> { "V", "PRES", "MID", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "“I have need to be baptized by you, and are you coming to me?”"
        },
        ...
        new Phrase
        {
            ...
            Translation = "But Jesus answered and said to him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "ἄφες", Transliteration = "aphes", Gloss = "permit [it]", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "ἄρτι", Transliteration = "arti", Gloss = "now", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" }
            },
            Translation = "“Permit it now;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "πρέπον", Transliteration = "prepon", Gloss = "proper", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "N", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "all righteousness"
                        }
                    },
                    Translation = "to fulfill all righteousness"
                }
            },
            Translation = "for in this way it is proper for us to fulfill all righteousness.”"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            {
                new Word { Greek = "τότε", Transliteration = "tote", Gloss = "Then", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adj" },
                new Word { Greek = "ἀφίησιν", Transliteration = "aphiēsin", Gloss = "he permitted", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "prep" }
            },
            Translation = "Then he permitted him."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "βαπτισθεὶς", Transliteration = "baptistheis", Gloss = "having been baptized", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "Having been baptized"
                },
                new Word { Greek = "δὲ", Transliteration = "de", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Translation = "from the water"
                }
            },
            Translation = "And Jesus, having been baptized, went up immediately from the water;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "οὐρανοί", Transliteration = "ouranoi", Gloss = "heavens", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "the heavens"
                }
            },
            Translation = "and behold, the heavens were opened to him,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "like a dove"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐρχόμενον", Transliteration = "erchomenon", Gloss = "coming", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "ACC", "N", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "and he saw the Spirit of God descending like a dove and coming upon him."
        }
    };
}
/*
Constructions identified:
- INF_PHRASE (3:9, 3:11, 3:13, 3:14, 3:15)
- PREP_PHRASE (3:9, 3:10, 3:11, 3:12, 3:13, 3:14, 3:15, 3:16)
- DAT_INSTR: ἐν ὕδατι (3:11), ἐν πνεύματι ἁγίῳ (3:11), πυρὶ ἀσβέστῳ (3:12)
- PURPOSE_CLAUSE: τοῦ βαπτισθῆναι (3:13)
- NOUN_PHRASE / GEN_DESC: τῆς ῥίζαν τῶν δένδρων (3:10), τὸ πνεῦμα τοῦ θεοῦ (3:16)
*/

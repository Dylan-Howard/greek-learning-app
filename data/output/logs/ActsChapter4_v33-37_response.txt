    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἀπεδίδουν", Transliteration = "apedidoun", Gloss = "were giving", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Translation = "of the resurrection of the Lord Jesus"
                }
            },
            Translation = "And with great power the apostles were giving the testimony of the resurrection of the Lord Jesus;"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "upon them all"
                }
            },
            Translation = "and great grace was upon them all."
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐνδεής", Transliteration = "endeēs", Gloss = "needy", GrammarCodes = new List<string> { "ADJ", "NOM", "M", "S" }, PartOfSpeech = "adj" },
            ...
            Translation = "For there was not a needy person among them,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "κτήτορες", Transliteration = "ktētores", Gloss = "owners", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "χωρίων", Transliteration = "chōriōn", Gloss = "of lands", GrammarCodes = new List<string> { "N", "GEN", "N", "P" }, PartOfSpeech = "n" },
                                        new Word { Greek = "ἢ", Transliteration = "ē", Gloss = "or", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                        new Word { Greek = "οἰκιῶν", Transliteration = "oikiōn", Gloss = "houses", GrammarCodes = new List<string> { "N", "GEN", "F", "P" }, PartOfSpeech = "n" }
                                    },
                                    Translation = "of lands or houses"
                                }
                            },
                            Translation = "owners of lands or houses"
                        },
                        new Word { Greek = "ὑπῆρχον", Transliteration = "hypērchon", Gloss = "were", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "for as many as were owners of lands or houses"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "πωλοῦντες", Transliteration = "pōlountes", Gloss = "selling", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "selling [them]"
                },
                new Word { Greek = "ἔφερον", Transliteration = "epheron", Gloss = "brought", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τιμὰς", Transliteration = "timas", Gloss = "proceeds", GrammarCodes = new List<string> { "N", "ACC", "F", "P" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "πιπρασκομένων", Transliteration = "pipraskomenōn", Gloss = "being sold", GrammarCodes = new List<string> { "V", "PRES", "PASS", "PTCP", "GEN", "N", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "of the things being sold"
                        }
                    },
                    Translation = "the proceeds of the things being sold"
                }
            },
            Translation = "for as many as were owners of lands or houses, selling them, brought the proceeds of the things being sold"
        },
        ...
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐτίθουν", Transliteration = "etithoun", Gloss = "laid [them]", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the feet of the apostles"
                        }
                    },
                    Translation = "at the feet of the apostles"
                }
            },
            Translation = "and laid them at the feet of the apostles,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "διεδίδετο", Transliteration = "diedideto", Gloss = "it was distributed", GrammarCodes = new List<string> { "V", "IMPF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "ἄν", Transliteration = "an", Gloss = "ever", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                        new Word { Greek = "τις", Transliteration = "tis", Gloss = "anyone", GrammarCodes = new List<string> { "PRON", "NOM", "M", "S" }, PartOfSpeech = "part" },
                    ...
                    Translation = "according as anyone had need"
                }
            },
            Translation = "and it was distributed to each according as anyone had need."
        },
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἐπικληθεὶς", Transliteration = "epiklētheis", Gloss = "called", GrammarCodes = new List<string> { "V", "AOR", "PASS", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                                ...
                                new Phrase
                                {
                                    ...
                                    Translation = "by the apostles"
                                }
                            },
                            Translation = "who was called Barnabas by the apostles"
                        }
                    },
                    Translation = "Now Joseph, who was called Barnabas by the apostles"
                },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "παρακλήσεως", Transliteration = "paraklēseōs", Gloss = "of encouragement", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "Son of Encouragement"
                        }
                    },
                    Translation = "(which is, translated, Son of Encouragement),"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "APPOS" },
                    Content = new List<object>
                    {
                        new Word { Greek = "Λευίτης", Transliteration = "Leuitēs", Gloss = "a Levite", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "Κύπριος", Transliteration = "Kyprios", Gloss = "a Cypriot", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                    ...
                    Translation = "a Levite, a Cypriot by birth,"
                }
            },
            Translation = "Now Joseph, who was called Barnabas by the apostles (which is, translated, Son of Encouragement), a Levite, a Cypriot by birth,"
        },
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ὑπάρχοντος", Transliteration = "hyparchontos", Gloss = "belonging", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "S" }, PartOfSpeech = "v" },
                        new Word { Greek = "αὐτῷ", Transliteration = "autō", Gloss = "to him", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "prep" },
                        new Word { Greek = "ἀγροῦ", Transliteration = "agrou", Gloss = "a field", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "as a field belonged to him"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PTCP" },
                    Content = new List<object>
                    {
                        new Word { Greek = "πωλήσας", Transliteration = "pōlēsas", Gloss = "having sold [it]", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "having sold it"
                },
                new Word { Greek = "ἤνεγκεν", Transliteration = "ēnegken", Gloss = "brought", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                    {
                        new Word { Greek = "τὸ", Transliteration = "to", Gloss = "the", GrammarCodes = new List<string> { "ART", "ACC", "N", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "χρῆμα", Transliteration = "chrēma", Gloss = "money", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "the money"
                },
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἔθηκεν", Transliteration = "ethēken", Gloss = "laid [it]", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "having a field belonging to him, sold it and brought the money and laid it at the feet of the apostles."
        }
    };
}
...
- DAT_INSTR: "δυνάμει μεγάλῃ" (v33)
- GEN_OBJ: "τῆς ἀναστάσεως..." (v33)
- NOUN_PHRASE + CONJ: "χάρις τε μεγάλη" (v33)
- REL_CLAUSE: "ὅσοι..." (v34)
- GEN_DESC: "τῶν πιπρασκομένων" (v34)
- CAUSAL_CLAUSE: "καθότι..." (v35)
- APPOS: "ὁ ἐπικληθεὶς Βαρναβᾶς" (v36)
- DAT_REF: "τῷ γένει" (v36)
- GEN_ABS: "ὑπάρχοντος αὐτῷ ἀγροῦ" (v37)
*/

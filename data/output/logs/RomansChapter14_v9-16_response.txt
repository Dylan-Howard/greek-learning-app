    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἔζησεν", Transliteration = "ezēsen", Gloss = "lived", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "νεκρῶν", Transliteration = "nekrōn", Gloss = "of dead", GrammarCodes = new List<string> { "ADJ", "GEN", "M", "P" }, PartOfSpeech = "adj" },
                                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                                new Word { Greek = "ζώντων", Transliteration = "zōntōn", Gloss = "of living", GrammarCodes = new List<string> { "V", "PRES", "ACT", "PTCP", "GEN", "M", "P" }, PartOfSpeech = "v" }
                            },
                            Translation = "of both the dead and the living"
                        },
                        new Word { Greek = "κυριεύσῃ", Transliteration = "kyrieusē", Gloss = "he might lord over", GrammarCodes = new List<string> { "V", "AOR", "ACT", "SUBJ", "3P", "S" }, PartOfSpeech = "v" }
                    },
                    Translation = "in order that he might be Lord both of the dead and of the living"
                }
            },
            Translation = "For to this end Christ died and lived again, that he might be Lord both of the dead and of the living."
        },
        // Verse 10
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κρίνεις", Transliteration = "krineis", Gloss = "do judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "τί", Transliteration = "ti", Gloss = "why", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "interj" },
                new Word { Greek = "ἐξουθενεῖς", Transliteration = "exoutheneis", Gloss = "do despise", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "OBJ" },
                    Content = new List<object>
            ...
            Translation = "But you, why do you judge your brother? Or you also, why do you despise your brother?"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "γὰρ", Transliteration = "gar", Gloss = "for", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "παραστησόμεθα", Transliteration = "parastēsometha", Gloss = "we will stand before", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "1P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "βήματι", Transliteration = "bēmati", Gloss = "judgment seat", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                    ...
                    Translation = "the judgment seat of God"
                }
            },
            Translation = "For we will all stand before the judgment seat of God."
        },
        // Verse 11
        new Phrase
        {
        ...
        new Phrase
        {
            ...
            Translation = "'As I live,' says the Lord,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "κάμψει", Transliteration = "kampsei", Gloss = "will bend", GrammarCodes = new List<string> { "V", "FUT", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "ἐξομολογήσεται", Transliteration = "exomologēsetai", Gloss = "will give praise", GrammarCodes = new List<string> { "V", "FUT", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
            ...
            Translation = "'every knee shall bow to me, and every tongue shall confess to God.'"
        },
        // Verse 12
        new Phrase
        {
            ...
            Translation = "So then each of us will give an account of himself to God."
        },
        // Verse 13
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κρίνωμεν", Transliteration = "krinōmen", Gloss = "let us judge", GrammarCodes = new List<string> { "V", "PRES", "ACT", "SUBJ", "1P", "P" }, PartOfSpeech = "v" }
            },
            Translation = "Therefore let us no longer judge one another,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "τιθέναι", Transliteration = "tithenai", Gloss = "to place", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" },
                        new Word { Greek = "πρόσκομμα", Transliteration = "proskomma", Gloss = "stumbling block", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "IND_OBJ" },
                            Content = new List<object>
                            ...
                            Translation = "for a brother"
                        },
                        new Word { Greek = "ἢ", Transliteration = "ē", Gloss = "or", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "σκάνδαλον", Transliteration = "skandalon", Gloss = "hindrance", GrammarCodes = new List<string> { "N", "ACC", "N", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "not to put a stumbling block or hindrance in the way of a brother"
                }
            },
            Translation = "but rather decide this, not to put a stumbling block or hindrance in the way of a brother."
        },
        // Verse 14
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "πέπεισμαι", Transliteration = "pepeismai", Gloss = "am persuaded", GrammarCodes = new List<string> { "V", "PERF", "PASS", "IND", "1P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "κοινὸν", Transliteration = "koinon", Gloss = "unclean", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "ἑαυτοῦ", Transliteration = "heautou", Gloss = "itself", GrammarCodes = new List<string> { "PRON", "GEN", "N", "S" }, PartOfSpeech = "f" }
                            },
                            Translation = "of itself"
                        }
                    },
                    Translation = "that nothing is unclean in itself"
                },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Phrase
                        {
                            ...
                            {
                                new Word { Greek = "τῷ", Transliteration = "tō", Gloss = "the", GrammarCodes = new List<string> { "ART", "DAT", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "λογιζομένῳ", Transliteration = "logizomenō", Gloss = "one considering", GrammarCodes = new List<string> { "V", "PRES", "MID", "PTCP", "DAT", "M", "S" }, PartOfSpeech = "v" }
                            },
                            Translation = "to the one who considers"
                        },
                        new Word { Greek = "τι", Transliteration = "ti", Gloss = "something", GrammarCodes = new List<string> { "PRON", "ACC", "N", "S" }, PartOfSpeech = "part" },
                        new Word { Greek = "κοινὸν", Transliteration = "koinon", Gloss = "unclean", GrammarCodes = new List<string> { "ADJ", "ACC", "N", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "εἶναι", Transliteration = "einai", Gloss = "to be", GrammarCodes = new List<string> { "V", "PRES", "ACT", "INF" }, PartOfSpeech = "v" }
                    },
                    Translation = "to the one who considers anything to be unclean"
                },
                new Word { Greek = "ἐκείνῳ", Transliteration = "ekeinō", Gloss = "to that one", GrammarCodes = new List<string> { "PRON", "DAT", "M", "S" }, PartOfSpeech = "adv" },
                new Word { Greek = "κοινόν", Transliteration = "koinon", Gloss = "unclean", GrammarCodes = new List<string> { "ADJ", "NOM", "N", "S" }, PartOfSpeech = "adj" }
            },
            Translation = "I know and am persuaded in the Lord Jesus that nothing is unclean in itself, but it is unclean for anyone who thinks it unclean."
        },
        // Verse 15
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "on account of food"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                ...
                new Word { Greek = "λυπεῖται", Transliteration = "lypeitai", Gloss = "is grieved", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "For if your brother is grieved by what you eat,"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Translation = "according to love"
                },
                new Word { Greek = "περιπατεῖς", Transliteration = "peripateis", Gloss = "you walk", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IND", "2P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "you are no longer walking in love."
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    {
                        new Word { Greek = "τῷ", Transliteration = "tō", Gloss = "the", GrammarCodes = new List<string> { "ART", "DAT", "N", "S" }, PartOfSpeech = "art" },
                        new Word { Greek = "βρώματί", Transliteration = "brōmati", Gloss = "food", GrammarCodes = new List<string> { "N", "DAT", "N", "S" }, PartOfSpeech = "n" },
                        new Word { Greek = "σου", Transliteration = "sou", Gloss = "of you", GrammarCodes = new List<string> { "PRON", "GEN", "2P", "S" }, PartOfSpeech = "prep" }
                    },
                    Translation = "by your food"
                },
                new Word { Greek = "ἐκεῖνον", Transliteration = "ekeinon", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "adv" },
                new Word { Greek = "ἀπόλλυε", Transliteration = "apollye", Gloss = "destroy", GrammarCodes = new List<string> { "V", "PRES", "ACT", "IMP", "2P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    ...
                    Translation = "for whom Christ died"
                }
            },
            Translation = "By what you eat, do not destroy the one for whom Christ died."
        },
        // Verse 16
        new Phrase
        {
            ...
            {
                new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "prep" },
                new Word { Greek = "βλασφημείσθω", Transliteration = "blasphēmeisthō", Gloss = "let be spoken of as evil", GrammarCodes = new List<string> { "V", "PRES", "PASS", "IMP", "3P", "S" }, PartOfSpeech = "v" },
                new Word { Greek = "οὖν", Transliteration = "oun", Gloss = "therefore", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
            ...
            Translation = "So do not let what you regard as good be spoken of as evil."
        }
    };
}
...
- PURPOSE_CLAUSE (ἵνα + subjunctive): Romans 14:9
- DAT_INSTR (dative of instrument): Romans 14:15
- REL_CLAUSE (relative clause): Romans 14:15
- COND_CLAUSE (condition): Romans 14:15
- INF_PHRASE (articular infinitive as object): Romans 14:13
*/

private static List<object> GetChapter4()
{
    ...
    return new List<object>
    {
        ...
        new Phrase
        {
            ...
            Translation = "But in truth I say to you"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "Ἠλίου", Transliteration = "Ēliou", Gloss = "of Elijah", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" }
                    },
                    Translation = "in the days of Elijah"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "the Israel"
                        }
                    },
                    Translation = "in Israel"
                }
            },
            Translation = "many widows were in the days of Elijah in Israel"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐκλείσθη", Transliteration = "ekleisthē", Gloss = "was shut up", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Phrase
                {
                    ...
                    Translation = "for three years and six months"
                }
            },
            Translation = "when the heaven was shut up for three years and six months"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "TEMP_CLAUSE" },
            Content = new List<object>
            {
                new Word { Greek = "ὡς", Transliteration = "hōs", Gloss = "when", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "λιμὸς", Transliteration = "limos", Gloss = "famine", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
            ...
            Translation = "when a great famine came over all the land"
        },
        // Verse 26
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "οὐδεμίαν", Transliteration = "oudemian", Gloss = "none", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" },
                        new Word { Greek = "αὐτῶν", Transliteration = "autōn", Gloss = "of them", GrammarCodes = new List<string> { "PRON", "GEN", "F", "P" }, PartOfSpeech = "pron" }
                    },
                    Translation = "to none of them"
                },
                new Word { Greek = "ἐπέμφθη", Transliteration = "epemphthē", Gloss = "was sent", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "Σάρεπτα", Transliteration = "Sarepta", Gloss = "Zarephath", GrammarCodes = new List<string> { "N", "ACC", "N", "P" }, PartOfSpeech = "n" },
                                new Word { Greek = "τῆς", Transliteration = "tēs", Gloss = "of the", GrammarCodes = new List<string> { "ART", "GEN", "F", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "Σιδωνίας", Transliteration = "Sidōnias", Gloss = "Sidon", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "Zarephath of Sidon"
                        }
                    },
                    Translation = "except to Zarephath of Sidon"
                },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                ...
                                new Word { Greek = "χήραν", Transliteration = "chēran", Gloss = "a widow", GrammarCodes = new List<string> { "ADJ", "ACC", "F", "S" }, PartOfSpeech = "adj" }
                            },
                            Translation = "a widow woman"
                        }
                    },
                    Translation = "to a woman who was a widow"
                }
            },
            Translation = "But Elijah was sent to none of them, except to Zarephath in the land of Sidon, to a woman who was a widow"
        },
        // Verse 27
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        ...
                        new Word { Greek = "λεπροὶ", Transliteration = "leproi", Gloss = "lepers", GrammarCodes = new List<string> { "N", "NOM", "M", "P" }, PartOfSpeech = "n" }
                    },
                    Translation = "many lepers"
                },
                new Word { Greek = "ἦσαν", Transliteration = "ēsan", Gloss = "were", GrammarCodes = new List<string> { "V", "IMPF", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἐπὶ", Transliteration = "epi", Gloss = "in the time of", GrammarCodes = new List<string> { "PREP" }, PartOfSpeech = "prep" },
                        new Word { Greek = "Ἐλισαίου", Transliteration = "Elisaiou", Gloss = "Elisha", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                    ...
                    Translation = "in the time of Elisha the prophet"
                }
            },
            Translation = "And there were many lepers in Israel in the time of the prophet Elisha"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                ...
                new Word { Greek = "ἐκαθαρίσθη", Transliteration = "ekatharisthē", Gloss = "was cleansed", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                    Content = new List<object>
                    {
                        new Word { Greek = "εἰ", Transliteration = "ei", Gloss = "if", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                        new Word { Greek = "μὴ", Transliteration = "mē", Gloss = "not", GrammarCodes = new List<string> { "PART" }, PartOfSpeech = "part" },
                        new Word { Greek = "Ναιμὰν", Transliteration = "Naiman", Gloss = "Naaman", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE", "APPOS" },
                            Content = new List<object>
                            {
                                new Word { Greek = "ὁ", Transliteration = "ho", Gloss = "the", GrammarCodes = new List<string> { "ART", "NOM", "M", "S" }, PartOfSpeech = "art" },
                                new Word { Greek = "Σύρος", Transliteration = "Syros", Gloss = "Syrian", GrammarCodes = new List<string> { "N", "NOM", "M", "S" }, PartOfSpeech = "n" }
                            },
                            Translation = "the Syrian"
                        }
                    },
                    Translation = "except Naaman the Syrian"
                }
            },
            Translation = "and none of them was cleansed, but only Naaman the Syrian"
        },
        // Verse 28
        new Phrase
        {
            ...
            {
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἐπλήσθησαν", Transliteration = "eplēsthēsan", Gloss = "were filled", GrammarCodes = new List<string> { "V", "AOR", "PASS", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "NOUN_PHRASE", "SUBJ" },
                    Content = new List<object>
                ...
                new Word { Greek = "θυμοῦ", Transliteration = "thymou", Gloss = "with wrath", GrammarCodes = new List<string> { "N", "GEN", "M", "S" }, PartOfSpeech = "n" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
            ...
            Translation = "When they heard these things, all in the synagogue were filled with wrath"
        },
        // Verse 29
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἀναστάντες", Transliteration = "anastantes", Gloss = "rising up", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "P" }, PartOfSpeech = "v" }
                    },
                    Translation = "rising up"
                },
                new Word { Greek = "ἐξέβαλον", Transliteration = "exebalon", Gloss = "they cast out", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "ἔξω", Transliteration = "exō", Gloss = "out of", GrammarCodes = new List<string> { "ADV" }, PartOfSpeech = "adv" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                            Content = new List<object>
            ...
            Translation = "And they rose up and drove him out of the city"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            Content = new List<object>
            {
                // (continues verse 29)
                new Word { Greek = "καὶ", Transliteration = "kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "ἤγαγον", Transliteration = "ēgagon", Gloss = "they led", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "P" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτὸν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Content = new List<object>
                            {
                                new Word { Greek = "ὀφρύος", Transliteration = "ophryos", Gloss = "the brow", GrammarCodes = new List<string> { "N", "GEN", "F", "S" }, PartOfSpeech = "n" },
                                new Phrase
                                {
                                    SyntaxCodes = new List<string> { "NOUN_PHRASE" },
                                    Content = new List<object>
                            ...
                            Translation = "the brow of the hill"
                        }
                    },
                    Translation = "to the brow of the hill"
                }
            },
            Translation = "and led him to the brow of the hill"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "αὐτῶν", Transliteration = "autōn", Gloss = "of them", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "pron" },
                new Word { Greek = "ᾠκοδόμητο", Transliteration = "ōkodomēto", Gloss = "had been built", GrammarCodes = new List<string> { "V", "PLPF", "PASS", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "on which their city was built"
        },
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Word { Greek = "κατακρημνίσαι", Transliteration = "katakrēmnisai", Gloss = "to throw down", GrammarCodes = new List<string> { "V", "AOR", "ACT", "INF" }, PartOfSpeech = "v" },
                new Word { Greek = "αὐτόν", Transliteration = "auton", Gloss = "him", GrammarCodes = new List<string> { "PRON", "ACC", "M", "S" }, PartOfSpeech = "pron" }
            },
            Translation = "so that they might throw him down headlong"
        },
        // Verse 30
        new Phrase
        {
            ...
            Content = new List<object>
            {
                ...
                new Phrase
                {
                    ...
                    Content = new List<object>
                    {
                        new Word { Greek = "διελθὼν", Transliteration = "dielthōn", Gloss = "passing through", GrammarCodes = new List<string> { "V", "AOR", "ACT", "PTCP", "NOM", "M", "S" }, PartOfSpeech = "v" },
                        new Phrase
                        {
                            SyntaxCodes = new List<string> { "PREP_PHRASE" },
                            Content = new List<object>
                            {
                                ...
                                new Phrase
                                {
                                    ...
                                    Content = new List<object>
                                    {
                                        new Word { Greek = "μέσου", Transliteration = "mesou", Gloss = "the midst", GrammarCodes = new List<string> { "ADJ", "GEN", "N", "S" }, PartOfSpeech = "adj" },
                                        new Word { Greek = "αὐτῶν", Transliteration = "autōn", Gloss = "of them", GrammarCodes = new List<string> { "PRON", "GEN", "M", "P" }, PartOfSpeech = "pron" }
                                    },
                                    Translation = "the midst of them"
                                }
                            },
                            Translation = "through the midst of them"
                        }
                    },
                    Translation = "passing through the midst of them"
                },
                new Word { Greek = "ἐπορεύετο", Transliteration = "eporeueto", Gloss = "went his way", GrammarCodes = new List<string> { "V", "IMPF", "MID", "IND", "3P", "S" }, PartOfSpeech = "v" }
            },
            Translation = "But passing through their midst, he went his way"
        },
        // Verse 31
        new Phrase
        {
            ...
            {
                new Word { Greek = "Καὶ", Transliteration = "Kai", Gloss = "and", GrammarCodes = new List<string> { "CONJ" }, PartOfSpeech = "conj" },
                new Word { Greek = "κατῆλθεν", Transliteration = "katēlthen", Gloss = "he went down", GrammarCodes = new List<string> { "V", "AOR", "ACT", "IND", "3P", "S" }, PartOfSpeech = "v" },
                new Phrase
                {
                    SyntaxCodes = new List<string> { "PREP_PHRASE" },
                    Content = new List<object>
                    {
                        ...
                        new Phrase
                        {
                            ...
                            Translation = "a city of Galilee"
                        }
                    },
                    Translation = "to Capernaum, a city of Galilee"
                }
            },
            Translation = "And he went down to Capernaum, a city of Galilee"
        },
        new Phrase
        {
            SyntaxCodes = new List<string> { "INDEP_CLAUSE" },
            ...
            Translation = "and he was teaching them on the Sabbath"
        },
        // Verse 32
        new Phrase
        {
            ...
            Translation = "And they were astonished at his teaching"
        },
        new Phrase
        {
            ...
            Translation = "for his word was with authority"
        }
    };
}
...
- PERIPH (Periphrastic): Luke 4:31 (ἦν διδάσκων)
- APPOS (Appositive): Luke 4:27 (τοῦ προφήτου), Luke 4:27 (ὁ Σύρος), Luke 4:31 (πόλιν τῆς Γαλιλαίας)
- RESULT_CLAUSE: Luke 4:29 (ὥστε κατακρημνίσαι αὐτόν)
*/

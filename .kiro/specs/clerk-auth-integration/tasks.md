...
- [x] 7. Deprecate `POST /api/auth/register` in `AuthController`
...
- [x] 8. Checkpoint — backend plumbing complete
...
- [x] 9. Add `ClerkProvider` to `app/layout.tsx` and validate env vars at build time
  ...
  - [x] 9.1 Write unit tests for `app/layout.tsx`
    - Renders `ClerkProvider` wrapping children
    - Throws when `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` is absent
    - _Requirements: 1.1, 1.2_

- [x] 10. Create `middleware.ts` with `clerkMiddleware` and explicit public-route matcher
  ...
  - [x] 10.1 Write property test for protected-route redirect (Property 1)
  ...
  - [x] 10.2 Write property test for public-route pass-through (Property 2)
  ...
  - [x] 10.3 Write property test for onboarding redirect (Property 3)
  ...
  - [x] 10.4 Write unit tests for `middleware.ts`
...
- [x] 11. Wire `login/page.tsx` to Clerk `useSignIn()` custom flow
...
- [x] 12. Wire `signup/page.tsx` to Clerk `useSignUp()` custom flow
  ...
  - [x] 12.1 Write unit tests for `signup/page.tsx`
...
- [x] 13. Wire `OAuthButtons` to `authenticateWithRedirect` and create `/sso-callback` route
...
- [x] 14. Create `useAuthenticatedClient` hook
  ...
  - [x] 14.1 Write property test for Bearer token injection (Property 4)
  ...
  - [x] 14.2 Write property test for no persistent storage (Property 5)
...
- [x] 15. Migrate `ClientProviders.tsx` from `devSession` / `localStorage` to `useUser()`
  ...
  - [x] 15.1 Write property test for `fetchUser` always called with Clerk ID (Property 7)
  ...
  - [x] 15.2 Write unit tests for `ClientProviders`
...
- [x] 16. Harden `ApolloClientProvider` — null token warning + unauthenticated redirect
  ...
  - [x] 16.1 Write property test for Apollo `getToken` called per request (Property 6)
  ...
  - [x] 16.2 Write unit tests for `ApolloClientProvider`

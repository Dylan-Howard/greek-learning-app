...
DOTNET_ROLL_FORWARD=Major dotnet test backend/tests/Koine.Tests/Koine.Tests.csproj -m:1 \
  ...
  /p:CoverletOutput=backend/tests/Koine.Tests/TestResults/coverage-services \
  /p:CoverletOutputFormat=cobertura \
  /p:Include="[Koine.Application]Koine.Application.Services.BookService*%2c[Koine.Application]Koine.Application.Services.ChapterService*%2c[Koine.Application]Koine.Application.Services.TranslationService*%2c[Koine.Application]Koine.Application.Services.UserService*%2c[Koine.Application]Koine.Application.Services.LessonService*%2c[Koine.Application]Koine.Application.Services.StudyService*%2c[Koine.Application]Koine.Application.Services.VocabularyService*" \
  /p:Threshold=70 \
  /p:ThresholdType=line \
  /p:ThresholdStat=total

echo "Focused backend coverage report: backend/tests/Koine.Tests/TestResults/coverage-services.cobertura.xml"
